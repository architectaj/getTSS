...
Function msrdCollectUEX_AVDSCardLog {
    ...
    " " | Out-File -Append $global:msrdOutputLogFile
    msrdLogMessage $LogLevel.Info ("$(msrdGetLocalizedText "scardmsg")")

    if ($varsSCard[0]) {
        msrdLogMessageAssistMode "Collecting Smart Card related event logs"
        msrdGetSCardEventLogs
    } #get event logs

    msrdCreateLogFolder $global:msrdSysInfoLogFolder
    if ($varsSCard[1]) {
        msrdLogMessageAssistMode "Collecting Smart Card information"
        $Commands = @(
    ...
    if ($varsSCard[2] -and !($global:msrdSource) -and ($global:msrdOSVer -like "*Windows Server*")) {
        msrdLogMessageAssistMode "Collecting KDCProxy and RD Gateway information"
        msrdGetKDCRDGWInfo
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvJlF69UdU8/yb
# qWNDuRp5KAwRVEbpLtlkOVdqxaN/8KCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMLIid99wAHE4/sVFWy122+1
# AM2+XjTOD2IwaYp5ILRNMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAZMTiz6MXrHpqxel4Lw+0unp7XnoUsLvtMud3my5cAU72AtybDLaOPpMf
# H/j5vQwDw2w9Ivl+D8J2+gsgMwTIcqlyhYVaFv3i4FKlKmqU9EvLIAEM8CrGke0z
# satf21/IYmeQ+7WJNidy3TO/z/8qBS6YhJxxFXe5UQfv9vSrD+K7xBPK3PY2ZPb9
# JuaKKUTRo8dWT15TUelKMSk05j6CcFaD2JAJ4CCqadmJER1twa/w8gjAF1qJ7V4v
# ek4FBicnjBSNNXLM19yqTC0gNIP/rbrw0mTlpTcM5//1QD+HzCUZSC5Q+habZjxl
# pm8Vxjc+1H+EkKv5ykV7GNJ7LV2QjaGCFykwghclBgorBgEEAYI3AwMBMYIXFTCC
# FxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDnDJb87bUYuQxzXr5KG1/htLuiHo3ZHozbxPaLIiaP6wIGZbqiEEII
# GBMyMDI0MDIyMDEyMTY1OS4wMTlaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# IgQghrl+3kRci5YcA+F8pjqwT76OA1X8yDgUvwgghKyRjKIwgfoGCyqGSIb3DQEJ
...
# MA0GCSqGSIb3DQEBCwUABIICABvXLbbd3Z0SJhJmbrW6ppW5HJhUSbP+w9pEtQAJ
# 9i3EGEzW8Wvx0p7Gb4q/EPQy2JvATLNxMlSMl9yrl8rToGFS7fOVuN/g3CJTDjJy
# ACglOUi0WgoglbQ7dJf7AysHmYnm86wf5/RAzeCQx1XU6ycPqLbEPuSSgw3UKDkx
# Qndot6kWtNzb9QVz7mKTpTviT9OP39B5llvq3FFRatbZvY7prxWKMViGDO17MKpt
# 98yZwunpgcvXOXNdm+9m47gQUfOnN/v8dwNQ0jrZIoLFUAzWLNVo3uAYbGrCViMv
# hetdRrxGACqgcYcQZDxWZYYz7l4ywUpeUplKKAoyUJCojrwuMtf8TRovHRlAWLu5
# XqPizp9oiAfMLZ9kEDr3mIrpelV33b7zqPqa0AsGzAtR0C7HVbnUEgiEGLKaThW/
# YSDufFTdn6uDgPzM+j7+OxiattP/VmMRkou3dh5Nf5nVpTdCux9H+zoqxX8pbP/l
# Cx4fUqwYxvMVnVZn6MrWzkrgHLCe0D49RqA0bFMS44S/NFZ/Fb/c3YmPFUYUKFH2
# pWoUXnUnr9U/59VCSzt6RZteTZFBXjaeKNB8Tt8oSDBvfEmNxAjOKCe7XvROnNv5
# T6fjF6fbRV/e//NVVtAWejpE7ASor0zSDZ9fvS5R4mojrQlILmJ8uHzLs/oKAWRQ
# 7nv3
