...
Function msrdGetIMETree {
    ...
    $Commands = @(
        ...
        "tree '$env:windir\System32\IME' /f 2>&1 | Out-File -Append '" + $global:msrdSysInfoLogFolder + $global:msrdLogFilePrefix + "tree_Win-Sys32-IME.txt'"
        "tree '$env:windir\IME' /f 2>&1 | Out-File -Append '" + $global:msrdSysInfoLogFolder + $global:msrdLogFilePrefix + "tree_Win-IME.txt'"
    )
...
Function msrdCollectUEX_AVDIMELog {
    ...
    msrdLogMessage $LogLevel.Info "$(msrdGetLocalizedText "imemsg")"
    msrdLogMessageAssistMode "$(msrdGetLocalizedText "imemsg")"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBxoQ8vSMHDNIAe
# VRVHbIyDsC7HirdHoKuGjXGnb9aBpqCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILG/4QicfXgLBGPJsDfx01lL
# UZ1sP5H7G2QK4/K/PpOPMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAR5WXNAacqWl4Ij2tEwE9i9zImhHNdeK/5OSyoU+odrZBS25nxiqzgwrF
# CyyMJttQtN5h/deJT6KVOFgMXT705jOxlHRq2Zxl3ePP3aXJqA9kMKbDUxgj9/jt
# i09udVxD8NtdYj3w11kC9CF+T1M8BvaU39//LLjx3EVZrIh7ivgnnkQbTRtUMs+Z
# CDTb1+leBCSURTf00ahSx+dedBHUffBfNVJoSAPr0UO1hq4C5p+YeyXqWP+dBxjE
# ZeUi8CrAnIoNBZwi635srM+FI2jCIXQ8RY+q8g9u7ZB6d8JtNu2xbcqY9CaJvOIg
# 7h8gE6xr90DJg6yu5RsEZDxkJ5CHz6GCFykwghclBgorBgEEAYI3AwMBMYIXFTCC
# FxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCC3O8jkEN8cLULiHA+bwf3K9LLTZExTQ/BptgQzrfdtUwIGZbql3kZu
# GBMyMDI0MDIyMDEyMTY1OC41MThaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# IgQgGhE29S07b1GV9M4mcRoAudObtkNXdPNisnX05LpeJj0wgfoGCyqGSIb3DQEJ
...
# MA0GCSqGSIb3DQEBCwUABIICALL0vVPLkLjNcz7sgVFjw4ZOqpODTnXmfkBpHGwN
# CMbZTrcfPCD/qxeyTdv6XwydqexjoaCBeKErpiQchn/nsYltZOHnKdCstrLKxpZj
# VfUFPj/IDQ3PijZRcdZZiZJueyujkgaMk7f/fEGuHDC76gU52bAeUqAmC5V0gM3y
# 1FHpyMqPPIF31y0KvR3QPN+MFPKLbOYQqo1/4AVp3J6opfUYSXo5PuEitUqv/Bi6
# 7DZQWUnvzRq829UnV6ej8/NcTs4XYT3qBfZwVaxWBUSWEfctE869zUnj2ipM0AL3
# zGYJpCs3shl5wb+Bj691RHBPW/PSWT58W6AG2CKfKLg150yxIrv1ZhQShKm7odtN
# Bk9SP4Edc4UAao8cnVpWsMU8ijUISq+93xoGeOKCFU5QBjeMD9YO+E8COXO0vM9x
# j4NgdwlWFOS6jTeX5xwN9c7QzXTfuaJ3sjVP1R8+eFRGpK6VuqizxB+LvJ0XKOEA
# FTMaJ3GHgvarUXcro0aG4xG+efNSOK+H30Z22rbFRTItcANYxST4uUjcTSnIYZnw
# 6sIpL0aySK8m90iHlVYA+LeOZpEYUcVvd3Mtv+MCxc4PrUoc7QBh1g3sm7YbB/3T
# dHCQXHNHikNvswzfPyx3d6zWkNARP/p1gy2Xi7Ey6UaSuxjZkm0SKOETVF1fzXaB
# 3ZvP
