...
Function msrdCollectUEX_AVDActivationLog {
    ...
    msrdLogMessage $LogLevel.Info "$(msrdGetLocalizedText "activationmsg")"
    ...
    if ($varsActivation[0] -and ($global:msrdOSVer -notlike "*Server*2008*")) {
        $licdiagfile = Join-Path $global:msrdSysInfoLogFolder ($global:msrdLogFilePrefix + "licensingdiag.cab")
        $Commands = @(
    ...
    if ($varsActivation[1]) {
        $slmgrFile = Join-Path $global:msrdSysInfoLogFolder ($global:msrdLogFilePrefix + "slmgr-dlv.txt")
        $Commands = @(
    ...
    if ($varsActivation[2]) {
        try {
            ...
            $dom = $vmdomain.Name
            $kmsf = Join-Path $global:msrdSysInfoLogFolder ($global:msrdLogFilePrefix + "KMS-Servers.txt")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCmU4Eh/sf5wc4x
# +Kv3HzlA9Vpi5Knz7BjFkfmqsWL5LKCCDYUwggYDMIID66ADAgECAhMzAAADri01
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJhx
# SNDXBcny13dozWcSWYPWBfAaD7kjKvGfAee/qiTKMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAOfNkCkOwOc7mFNMppGf1EhB1Y905ntcJ/Adn
# nAOYDxDZFdhjcnDGot3D1+NN3CG2wmlm0tM/cAS5NrMHqfz3y8OPFZXpsEkmihRZ
# NH2ZoRx+c7BudC1u+Uw1nmDzJ+ITNY66zuHGzypuqGeq7KfFLN4ye83TZxXWCzRa
# MoNnxtKsSqCu0eCBHm3LLkB3WXzGfrbiS6IlmMYde0jNWtNhWlh3cVtsKwV3s0UU
# h/jwHS3G03ihtx2kxo3keyB6DjjYMGxdw/uyfOqlhunNML1TaPo/hPOwEzz+2MhH
# KnLf4/ucGGksFnIlrdgUl2JiAX180bE6N/CeahyF8GXh0hjCm6GCF5QwgheQBgor
# BgEEAYI3AwMBMYIXgDCCF3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFSBgsqhkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCATQqdEe8vJCJn2qDgmEDpBlfCbYFB5vzlV
# i9kcBBH6VwIGZc4N3Fu9GBMyMDI0MDIyMDEyMTcwMi42MDNaMASAAgH0oIHRpIHO
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAc8A+uWIb7TSD8hgNWX5B0ZCca
# NqkQIBU89SfZUax3CzCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIBi82TSL
...
# 16ZwriIZOrvbgfEm00ghxOshBRhjp4rQxEMwDQYJKoZIhvcNAQELBQAEggIAdOdZ
# vk7T5AS8A7gSBdBB4IISPqHpSxN5xJfdpR9IztrFyUukV29NBOSikmBhHn7gkBRm
# XuBunU4PYYR8kzQXd9ER2qETZeNn+D7klJtA2SqDWRVQOJKstIL+TDpTerCOMuO8
# FPn5V5OWT6QY6of5PSa2qlBfOfgdT+/yFduAFZvj/+R5tH6G0RVB9L1hkb+zVnpH
# lgPNihbS0s8Zfa+soTuzXmb+lu4ltInQACzaPPr+ALTm+CkYxid9G8yk2imi7zH/
# swuYY2VTN+1Ik8Ks81Pf6FhOqhip72Edf38DUxCCO1M6Qvt8fex9rvbbkn+6aBFY
# NnNAA64FDzfYgeTdZmYNjGrbl1iK0sFJDYF8MpVWcR0gMtDXPbpw+KVs/0s+vPWf
# xdtK/0xMCBUTcrR3ZN0+zxSwzURj3+ScgDwPWCqBTR4dk4f1sN1icc/A9UGqmijx
# oJoz6XTH5sbPvOMJdNdoIg9QaqopSEKv8tNIFF8Qf3PAtpKfMPzScON6E2gDA5MF
# 4EFssVXPq8jjeJwplmz5DfD763yFk41TzcZvX7G+kV/lN6xZnKLEo8BKHPtQBK6R
# DzvZNCsKq4nNwv2N1edqtAf0G2VYULATMpB5jSZOBGs+ZkB5WmUwAqa0sqB4Nwm8
# ANXob9ikQFBLuBQ3J9jJnP7LkViIzGA79C6xvZY=
