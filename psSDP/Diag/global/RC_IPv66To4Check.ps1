#************************************************
# TS_IPv66To4Check.ps1
# Version 1.0
# Date: 5-1-2012
# Author: davidcop
# Description: Checks for IPv6 6To4 interfaces on a domain joined server and it's IP starts with 2002
#************************************************

$var = Get-CimInstance win32_computersystem
$var2 = Get-CimInstance win32_operatingsystem

if ($OSVersion.Major -ge 6 -and $var.PartOfDomain -eq $true -and $var2.ProductType -ne 1)
{

  Import-LocalizedData -BindingVariable ScriptVariable
  Write-DiagProgress -Activity $ScriptVariable.ID_CTSIPv66To4Check -Status $ScriptVariable.ID_CTSIPv66To4CheckDescription
  $RootCauseName = "RC_IPv66To4Check"
  $RootCauseDetected=$false

  $var3 = $null
  $var4 = $null
  $count = 1
  $var3 = invoke-expression "ipconfig /all"

  while ($count -lt $var3.count)
  {
    if ($null -ne $var3[$count])
    {
      if ($var3[$count].tostring().contains("6TO4"))
      {
        do
        {
          $count += 1
          if ($var3[$count].tostring().startswith("   IPv6"))
          {
            $var4 = $var3[$count].tostring().split(":")
            if ($var4[1] -eq " 2002")
            {
        ...
        until ($var3[$count].tostring().startswith("NetBIOS") -or ($count -gt ($var3.count-2)))
      }
    }
    $count += 1
  }
  ...
  if ($RootCauseDetected)
  {
    ...
    Write-GenericMessage -RootCauseId $RootCauseName -PublicContentURL "http://support.microsoft.com/kb/929852" -Verbosity "Warning" -Visibility 4 -SupportTopicsID 8041 -Component "Networking"  	
  }
  else
  {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDsggmBM1yoD1lV
# v7R4srjmzSA2B28m5Vgq0EBU48bV9KCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIL8G+/daa79dAoDuJ6kCh+EJ
# 89QigCcBWfGoTCYI6xI1MEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQAhK/Cb1apDW99RdPi3CFdL+NTQpoSuSK26hhLSb/JG1lYN11+TJWXE
# LS3qre6ABmr50qkgmuPa2uXMjqJSMZnssrTIuzLH/tJnicx3RIxLmQoRpucs2ABv
# vkCoscFSbX+izBjukcNsLmgzD61gpqFjrMHccxzmeNFSoL13rScjxzK92kdU0ZTT
# vvnw5n9tS8jfV4/2fm7081Ko2uOhSDrktB3Rt9znb9Iv++hH0EzfAVgY+n5J3ssZ
# 9ylCgeVRFBwZEN4dvvgu0zVtLRzuCMOA0Cj/eKCI7lssP2Mffq4TI/MqOx7SS456
# U3sNag1xmtFaUe4qOYbgK2GnMj/MZZpcoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIKR9kNtn83bJPEFISGWqECMBnSZbQ1XwOx1xwvxnjXHGAgZi3ohP
# 7j4YEzIwMjIwODAxMDc1NTE4LjI5N1owBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIBES+w86VtqVVcoDqGX8
# /IJyeczetCvpIE2RbdQSbNGxMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgCB6NYH8cBLrSxrvn7fmk/p3nIkh1D7VtkBGjomU44QX2wYe98cKj1iXnb1+65W
# SO0+ciXOAQI27huXynFez5dXuktVopq1mKSJlpgUOjlkpCHjtKv7mfL8Fb82Wd9w
# V5n774kS+JrFBFdxlu5jnUd9CgqG9UaaKNaoPjbICYL+L/VKyJ62ugwseQcADSlU
# IRkzJMN6yXmJA17TQbSUCjXI3xAtbk7+f9bc/ymcVw6QNsslRQ7LrMjkyGhMBjha
# Xp8romxPow1LpRQ/u5TTjACjKIHCPQfUpto6bUNj5tffnrkG01dFpg73d9tlStDc
# ZPiK09Ttnf3w/S6gLi+8/sxxGEMtcr/mbVbpHXdjJKfFFuJTB5SkMsTnYHbyz6QV
# 5R5OPH1nXZwqOf5X3RgqBXek/MnLeU/13750jydEzyqNan66P8ZpCnkvzGUpFx5N
# wP8HedupUTUjm5e5IXOGnBooDmNus4qPoj+tkReSjXr0ya8QXko8zhoDP/1vaUk4
# J8/WYDGEl9hU35sI92HWdvE0IbAQ8UBqubVSqoZHnHb5ueZBJAmOT6oei9qvOG/D
# EA760/73+4n+wVVNaRbJrzkp5OjH+0/OaNFRLAMwukbisfinjWxaDQGQCXvuwRMv
# JXlmspjiQRHjqNq0K39XHO65cNEHHL8Go10zcbScZNVLRQ==
