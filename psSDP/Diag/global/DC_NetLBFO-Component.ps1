...
$sectionDescription = "Network LBFO"
	

if ($bn -gt 9000)
{
	$outputFile = $Computername + "_NetworkLBFO_info.TXT"
	"===================================================="	| Out-File -FilePath $OutputFile -append
	"Network LBFO (NIC Teaming) Powershell Cmdlets"			| Out-File -FilePath $OutputFile -append
	"===================================================="	| Out-File -FilePath $OutputFile -append
	"Overview"												| Out-File -FilePath $OutputFile -append
	"----------------------------------------------------"	| Out-File -FilePath $OutputFile -append
	"   1. Get-NetLbfoTeam"									| Out-File -FilePath $OutputFile -append
	"   2. Get-NetLbfoTeamMember"							| Out-File -FilePath $OutputFile -append
	"   3. Get-NetLbfoTeamNic"								| Out-File -FilePath $OutputFile -append
	"===================================================="	| Out-File -FilePath $OutputFile -append
	"`n"													| Out-File -FilePath $OutputFile -append
	"`n"													| Out-File -FilePath $OutputFile -append
	"`n"													| Out-File -FilePath $OutputFile -append
	"`n"													| Out-File -FilePath $OutputFile -append
	"`n"													| Out-File -FilePath $OutputFile -append
	runPS "Get-NetLbfoTeam"				# W8/WS2012, W8.1/WS2012R2	# format unknown
	runPS "Get-NetLbfoTeamMember"		# W8/WS2012, W8.1/WS2012R2	# format unknown
	runPS "Get-NetLbfoTeamNic"			# W8/WS2012, W8.1/WS2012R2	# format unknown

	CollectFiles -filesToCollect $outputFile -fileDescription "Network LBFO Information" -SectionDescription $sectionDescription
}

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCqwwbWlwL+72Og
# M4fmVaOxdFaq5oAuD0R3kYYFBZyYPqCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg40G3/Zu2
# p7PO7PsBSQ67Zb0+LA8hT7Vyd+BGHh8+jfkwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAJID22fglK+uvkh103D6M5L96HMGudIlEbNny0oTVtBLLDPBRCm+wFej
# 3kEG7Y0RtdkZ5fT8Ac0reUkuu1kpa57YF9jzAnlMKMNuBE/Lczvp65QAWnYEJg47
# Sjox7Ck6Rqd77qOBh5N12P0Vlk3E2xenYvtUsa1D1wlzKV7Yvzu9SZMhBaoD8K/b
# kWak7kNBjJ79xj9C8igs4oj5GoADnBB5bPbyIrmyOoIwojAZ7SQO31D5/l8mgOCr
# nehCcKM7VfWG5CgGyjAg6jIt5ikDH/CwreTkHj0hHH1T0n1oFqx27ZU5T6OZvpBK
# GdYdG+v/p0DEQmuYLNElRARVAfA0yZGhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgtiRCMQaBVq4+w46sdwg1mZXKOi8LyhfqgT0CUdpuPAACBmGB56/O
# kxgTMjAyMTExMTExNjUzMzUuMTc1WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDtSd0C
# b7Clv0f4d1CSAJnsqWxgSOSH6Ck/JfKkq+hjcTCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAVnEvk6Og8UQOyB8IAxy8wIdOPhuQenEoAmif5WwNUcSxM+Im
# DYn8aXQ1BdrkjK2OS3QyIeXTEHJSbu39wtkkc7r6j+dL5Mjk6l9G+L23d7jOi2TW
# vckjtSxp1U1r2E3vnukKg+g2gkSPDyUlHnFxhblnglm8AG4m/FICQKxq/Fdpahy6
# /UTz9nJ9Yt5aZNV5q1BMn96iYXIDfTogAb2a5DNJZynNo6tLfxv5Hhz38vyXRBuV
# 3lWAIE/iASdkL+L8WlKcgCS9lUi6OhyWcpMWqnW5IvqycOOcEu7gYP2no9nwD52i
# 5i0YfA7VFbFlQ28qHCIDvSX0ufkBZRC4qY0arg==
