#************************************************
# TS_PrintSetTMPSystem32Check.ps1
# Version 1.0.1
# Date: 6/8/2012
# Author: v-blchen
# Description:  [Idea ID 3462] [Windows] Printing issue - multiple SETxnnn.tmp files
# Rule number:  3462
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=3462
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 3462

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_PrintSetTMPSystem32Check"
$PublicContent = ""
$InternalContent = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=B;en-US;2670246 "
$Verbosity = "Error"
$Visibility = "3"
$SupportTopicsID = "8066"
$Title = $ScriptStrings.ID_PrintSetTMPSystem32Check_ST
...
# check whether the temp file is exsist in System32Folder
Function CheckPresenceTmpOfSystem32Folder
{
	$Path = $Env:windir + "\system32"
	$TemFiles = (Get-Item $Path).GetFiles('*.tmp1')
	if(($null -ne $TemFiles) -and ($TemFiles.Count -gt 0))
	{
		$Script:TempFileCount = $TemFiles.Count
	}
	if($Script:TempFileCount -gt 0)
	{
		return $true
	}
	else
...
if (AppliesToSystem)
{
	...
	if ($true)
	{
		$RootCauseDetected = CheckPresenceTmpOfSystem32Folder	
	}
}	
...
if ($RuleApplicable)
{
	...
	{
		add-member -inputobject $InformationCollected -membertype noteproperty -name "Current number of TMP files" -value $Script:TempFileCount
		# Red/ Yellow Light
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCKxECF+z8avn20
# doAexAs3XzK4AqZnWL+aOHVBg6v/z6CCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII2/rNEt/b0Mvl+jJN/JD7pq
# 1QnO/a+tc1JMG4CJ94osMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQBBSTW++JsF1lPjdBAAEF5oJYPopZCNLVFi0lxffJZ2qxxQ2C9Xltbe
# WCCD0f7fxQKYHuJRcbct/6HtYCgIUpA/R+ejOs9AION60rwh2EbkaGYy/qFAImgH
# g68vHtI5uN8uOBNVXuv5LJzXEyp8s410nkqq/oiUuGtJqRuKUWUwArMQlr+tvI0m
# AMPBsFGqe0C7rXxIhVuyI/fRnGoJBa6Q5vAjaqwLOoYebUmlRw1wrSh/MecL3CmY
# SA68YAh8CpdHzv795RKHOPA+HRWgk4YwXsn35E6EgXrDqwRiE+czMyZnR8bcAKWb
# lT5MZPa3S+uCvRGqSv0tyUSRCBto+4fBoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEICe1Mxc7ekZU7qnteFsLltsdYxd80mMR/9KYPD2Gb5/sAgZi3mrX
# 5v4YEzIwMjIwODAxMDc0MzA0LjE2N1owBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIKCu79Brv1deWM3NFGn4
# 4ZNhjk6vsSHA7sYhyUy6UUjnMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgCuT3U//WYMSVL47D8ocuFKWqtiytxUfnOPYR2gQST2c9glbR/lssJhnlARsIXF
# 8yjayKsMwQIT5CXFJyHXI6+NPe5tRfEE2jVySGouxj6tYG4cTcRRW2mtqna4F32G
# /9BZ4T9VW2jHrBbShSKwo4hTgOiVEg5+GMLgkVEH8SXGNLKjnJbMXlOBUCO8cJRD
# 2m5yqVt+adPtp+nHtvr0dHrcwpiHhD2WlgJWFvz4FYgdCSXIZYlggtoViyxXckhx
# +EvfvQrIRnxJNuSkW2sgV/qiKK3RqHTxeqhv6Awp/YuNVBrXyerhMzOU42C/2G0M
# h4RD7inB76ZcjDyNtpCtzaQ44uPNmJzI6402BLO0oYDaHg979aHmlBF3FoaD9CCW
# 8SubYb6xxZ22DjzhEkePwotiCyKwIpIOuvkyizIXQ7qjnQ7DL5hVDlQao0Zckrtr
# pmeDUxHLMuWK17Tvl0BJQY6KwH3yysH5PNE51sdi3YEcII5UNLTirD7Z82jo7q6g
# txlyKuD4+ryzbRCn7dPC7Zy77Re+V9xSE1W0sTrvAFqZBbLF3fajL2KhxFJPIcsM
# h1h/MVNlt5ujuvapMU0JeJkvqpAu6C/87GejSUUifCBwRoHNu2dEdl2bH4Zz2xax
# /wgjUasrEigKA0Gnnwd5HA1ZODPhmhg8LE90moehktRWmA==
