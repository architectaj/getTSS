...
# Rule number:  2446
# Rule URL:  //sharepoint/sites/rules/Rule%20Submissions/Forms/DispForm.aspx?ID=2446
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 2446

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_2K3PoolUsageMaximum"
$PublicContent = "http://support.microsoft.com/kb/312362"
$InternalContent = ""
$Verbosity = "Warning"
$Visibility = "4"
...
# Detection Logic
# **************
	function RegSetToNullOr80() 
	{
	  if(Test-Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management')
        {
         $DataCollected = (Get-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management').PoolUsageMaximun
          if(($null -ne $DataCollected) -and ($DataCollected -ne '80')) 
		    { 
		        Add-Member -inputobject $InformationCollected -MemberType NoteProperty -Name "Registry PoolUsageMaximum's current value" -Value ($DataCollected+"%") 
			    return $true  
			}
		}  
		return $false
...
if(($OSVersion.Major -eq 5) -and ($OSVersion.Minor -eq 2))    # windows server 2003
{
	$RuleApplicable = $true
...
if ($RuleApplicable)
{
	if ($RootCauseDetected)
	{
		...
		Write-GenericMessage -RootCauseId $RootCauseName -PublicContentURL $PublicContent -InformationCollected $InformationCollected -Verbosity $Verbosity -Visibility $Visibility -SupportTopicsID $SupportTopicsID -SolutionTitle $ScriptStrings.ID_2K3PoolUsageMaximum_SD
	}
	else
	{
		# Green Light
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+dXPAT3/eLRF1
# ZaIw1gLYfL3J7IVEn1lptZFBQ5u9NaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIH7rQGWcLXbZCsV7nwisZ3tu
# MRenvKOZoSaAeGk5ps4wMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQBtia2C29/k5BSTphX/zFQZcQ9fEIS6/Z7gCese9Nx57W/3BoxSD333
# TLQh7B3VOZqcmjoL1OWLj5FMTTa/XDS5SbnQLjq7hbVdA8gc5GoPz3dbE6dO+EBG
# Vjda94dQJwcfFmf/yzAAOzZEf6XQdOxWyNvamPqjIqYbDVyVT+iJF+oRnZMjG3Fg
# f9QrqY4cF/raHniFktIo+DLprN8DxTVv6mdNKREvUmSdJPCqYRRxQarO/cL8Zzep
# lKcihkgHCgvilw9ExueqILr+0qYKOApYIidK4ch3jEiv4X7Q5r5EKx+bbCrHClyq
# SDzfBvEwiJax/bXD/IlkaZePCMt5Ou5UoYIXCDCCFwQGCisGAQQBgjcDAwExghb0
...
# AWUDBAIBBQAEIGRIuroKrYQh4eSYTBNSz8mSP8g4BBeAvu+BYq3qTlY7AgZi2xAP
# WDQYEjIwMjIwODAxMDc1NTQxLjMzWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCDmi9PFIae52PC9rFJS1iRESwREnf9vuqNa7YlX
# dXT9uDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIA4cr/qwhWARVJUPcCu+
...
# NCT52pDLViSa+w83M6SkvSIwDQYJKoZIhvcNAQELBQAEggIAa+XHfuz5rG/3E2Qf
# E/cd3m8mN1pvUFg4CpyFh/rg6pOLZtz9p18iBBsBzJLN7KQMWz3v4OjqbGXRGxTp
# ZQnJgDZLiHV1phgrI5UlWe8osHhY/XGhdeXAf4QBo2j4Rh+tSsoaeJBcljKsIqkW
# efb1DRkXY4W04nxMiCUS9+lRwCXHJljdk7tUP+xIbiUKm8x5BY7Yr4W+TcOlDHoH
# EkVvQ7fVVB8/6xfgDsqYxvWfRpMFViMoKMRFbvZBSyHOAq8g7BjdLHwel1U0/qcV
# EVzbgoR/jv2RDUHc1J6ovDR2S0WugysrQEBfkJLpNvr9NlnIQSjzFudoHZ9RcfRL
# 4WMcoOvRHSmmy0UjT57rWZSmGr2vPyNIXEafn8yBgg9pvqRcF5Oc/SsYRELcRJ51
# 5+rZXGs9xA3iggC4KErSxScIb+Fni+jYsokPqAvhwrAptmEqNUj1RsSv79P0GEnB
# Zcc4sfjySmfDdgVx55kbfxHGBzbKDF95wCR046vkwgfK547IGpDSyO9xZiS4q865
# vxEA6IyOpcrxkXXaHa5JXzXZC5zbctIxk9Jh0tIKo21Hjtcc6PBxIQY8EMMYh2G3
# qO3a3BMi7tsG9TLCSOjlDxxWYHlIB9dQFsewh9OOj9Q9BDTtxycJuRQGy1ZF45nw
# x/kHQmjV/+al2hfB/fWsnhGKYJA=
