...
$sectionDescription = "BITS Server"
...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSBITSServer -Status $ScriptVariable.ID_CTSBITSServerDescription

#----------Check if Bits-CompactServer is installed, and then run the script
$SvcKey = "HKLM:\System\CurrentControlSet\Services\BITSCompactServer"
if (Test-Path $SvcKey) 
{
	#----------Registry
	$OutputFile= $Computername + "_BitsServer_reg_.TXT"
	$CurrentVersionKeys =	"HKLM\System\CurrentControlSet\Services\BITSCompactServer"
	$sectionDescription = "BITS Server"
	RegQuery -RegistryKeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "BITS Server Registry Keys" -SectionDescription $sectionDescription

	#Windows Server 2008+
	if ($bn -gt 6000)
	{
		#----------Bits-Server EventLog
		$sectionDescription = "BITS Server EventLog"
		#Bits-CompactServer
		$EventLogNames = "Microsoft-Windows-Bits-CompactServer/Operational"
		$Prefix = ""
		$Suffix = "_evt_"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAVPLRtqIV4UwFq
# xv/R5uTEo1jAcUVT20RxtJqY3NlgtqCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgPByx2e7e
# Is8lbyLJfzqIiRLiF8D1Q2X2CFkyUN/b+ckwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAAa1MrbzuWh1T0uDNtcwtrWwyQ6xyq51rSvYnCcujhTZjxmA167zKjOX
# PTJVuml4nef6ipe9jrYUVYi4NXDySaqfxNHb2QPz/AiCSypNH5QaXloUIbXcwBzn
# pJVIj11z3xd0cHcYjBg57yVmcwUXBD45AQNICK21NNcGVInvj0BC8p4tDFwoaCOU
# Pn7CxhtWxU8b1GFdsYucn9dClttqWOWoa4tMpMZZVBNOC0x0AA+K6iEx+dHCoJiT
# UL7f6y9NwwlBXFFzAKaCLbftFQkAnOKxWVXwnoNCjVeGdrB5SZWGX3xxSCkb+jD4
# U6RDGo4VOd1zq4d7kLL1CcZP7IVDHVuhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQg2dN7C2HGEXVBtTQBn7sFaJu2lOpp3AlxHFxrorkb8bkCBmGB++Yl
# XhgTMjAyMTExMTExNjUzMzUuOTI4WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAdSJg4
# OEf1R2qIzyEM/8Lv6KUxUzAYKYaJAxEyy8Kh4jCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEACPPlomW4wK1oWVFC7mSlJXaLyb1a7u+oZzehV5973EPKhHA9
# Rsql0At5N7gUXKSXACzMAoRFYsJV+PnE8M/GA8ZWWK6AJ4tUQndPo8OnEOK488ha
# ywU600IY4Gg3dp+926cZSbJAOC/zmrvHF7/NZELJIv63mlE1uGrEQAxD6H/Gwvrx
# Wm3BGSJuMfmq+W0gd78u+DXtkZhXCNPor0A61hkKWzzftrXQ4W5IAt+o3v8D3Qe8
# xLN794Uq168AU1L8etoObFtxdgmL77kr5fI5AWwWPv1W0oLMsvVqtBCgokFdCsT3
# I1gTR5xUUkrqcTRQ3DRqkuMsnU15vLES8W5x7g==
