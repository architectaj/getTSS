...
"   2. Get-NfsClientgroup"								| Out-File -FilePath $OutputFile -append
"   3. Get-NfsMappingStore"								| Out-File -FilePath $OutputFile -append
"   4. Get-NfsMountedClient"							| Out-File -FilePath $OutputFile -append
"   5. Get-NfsNetgroupStore"							| Out-File -FilePath $OutputFile -append
"   6. Get-NfsOpenFile"									| Out-File -FilePath $OutputFile -append
"   7. Get-NfsSession"									| Out-File -FilePath $OutputFile -append
"   8. Get-NfsShare"									| Out-File -FilePath $OutputFile -append
"   9. Get-NfsStatistics"								| Out-File -FilePath $OutputFile -append
"===================================================="	| Out-File -FilePath $OutputFile -append
"`n"	| Out-File -FilePath $OutputFile -append
"`n"	| Out-File -FilePath $OutputFile -append
"`n"	| Out-File -FilePath $OutputFile -append
...
if (Test-Path $SvcKey) 
{
	...
	runPS "Get-NfsShare" 				# unknown
	runPS "Get-NfsStatistics" 			# ft
	# Get-NfsMappedIdentity 	# server(?), takes argument
	# Get-NfsNetgroup 			# server, takes argument [exception]
	# Get-NfsSharePermission 	# server, takes argument [exception]
}
else
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBlzm1RQSzGv6M5
# ETaUh16Ycs6QMY9faEBuz8O+mr89wKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgGRrDqBuF
# QiV6Xvmi0tzY3qhHoQySnpS8yNjT6Uj0RJcwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAK1bA4s2PEIjhqP8tCWbvlRSANZOBrKGz+RKNqG1OFBdTZtYpGUD2ASL
# BffN6qYdqRyGSoiNCkOLy5V3E0B+lb7rjvxPW6gxbiL+1ewN9GD79nQudqgpFOB4
# xYdUl0Um9fv4GpOiXRW6PqlBRhV+Kx2R90hDRIwu6JDjPcUmyLTQ+jUKhpTvy3AN
# 4wYZmgMydyHzP2Ji0lG5y5H9J3OKttsRcArcj24DGScVkA9nnVICsZ3U5WVrSL9V
# xWoMu3YgylHVGzvAAVo+7fXYWvni+Re5KV9mFLN0E8LQ0p/XBg7yFuHeI1EiTqWu
# 3nzfeVt0PRbFyuHDenSd/22gscCxQGShghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQg9W6Zjudu6t3gQFKqU/HD3favxlxH+UDOsFvoqzl8bRkCBmGB81FC
# ohgTMjAyMTExMTExNjUzMzYuOTc1WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCArVUrA
# 2wAswhslFdkB8oQWhUDkfcwkMTqX1MP5qtwROjCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAb53s6PyAWxJg7yaP2bg6V+9cZoap7EjOgMQ9h0hIbgmnr0gn
# l/o88pxPdcVrLdFEBso5UMEEaCeG/EnlB4YsrWKfMK0oRZL6uSvwdZvomiDfzMIN
# 4veqZu02s9w6fykp2loCqxtqNJCDPiSZY1CeRrfidVmarA9n3f0VPSLF6FR2CJZF
# Hu7FECiUTlrOqG+wJki214gfV6Yy9G+3J3/Axp5HiaHsMHceoI8AbSeCMIlaxsPU
# kqjtfzuJ4P4jAtL9gfHfh7vtRUiCye7YGc+xpMucRbvCv/xruMozBvYLbe6BZyTF
# 38ilsJGcWoGfEnDsqpo+npny5h0Pz2w4UVjmlw==
