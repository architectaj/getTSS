#************************************************
# TS_ModernAppsFailureForAuditOptionCheck.ps1
# Version 1.0.1
# Date: 3/13/2013
# Author: V-maam
# Description:  [Idea ID 7524] [Windows] WinStore -Modern applications fail to start if "Audit the access of global system object" is enabled
# Rule number:  7524
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=7524
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 7524

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_ModernAppsFailureForAuditOptionCheck"
...
{
	$RuleApplicable = $true
	$FileTOCheck = Join-Path $PWD.Path ($ComputerName + "_SecEdit.txt")
	$CommandLineToExecute = "cmd.exe /c %windir%\system32\secedit.exe /export /cfg $FileTOCheck /areas SecurityPolicy /quiet"
	RunCmD -commandToRun $CommandLineToExecute  -CollectFiles $false

	if(Test-Path $FileTOCheck)
	{
		$MatchedKey = Select-String $FileTOCheck -Pattern "MACHINE\\System\\CurrentControlSet\\Control\\Lsa\\AuditBaseObjects"
		if($null -ne $MatchedKey)
		{
			$AuditBaseObjectsKeyValue = $MatchedKey.ToString().TrimEnd().Substring($MatchedKey.ToString().TrimEnd().Length-1,1)
			if($AuditBaseObjectsKeyValue -eq "1")
			{
				$RootCauseDetected = $true
				$InformationCollected | add-member -membertype noteproperty -name "Audit the access of global system object group policy enabled" -value $true
			}
		}
	}
}	
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAqtI9GJOJwBeRp
# s5mBdDxrXkf6zf8pVLBiSm+xzWcKWqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOKNaBUvn48qgno8uW/FaHMR
# 6QGVbu7mzsohFdfTX6tDMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQB9uv969X4QWthyk9yc4x2CQ3nrKEiZZYfFL1XkWsSkJL1pOY8ffXCA
# 0cIP7gWYBpuKcqglQWJEGp5mEkTI92HhGbaf4ZgAylvAj5+B2UMHBPTfLVJFepEP
# zrhyt8H+IU6pJ0NM3ilpRJ0cn+OOh79TXuVh7iB/Ygvku0nDHJ9bhMjyjOYORO1e
# Qp2hphCL3BdbW3KldjedCqDlcUS+YfpogF24MwYaXG7CKRYSjbqcJ4Cj51HAzZC7
# Znl498R3zZSwY8rCx10dqoK6jvXVFwyxQY6RExvMGgy6iBfStmTPf0qzk52K5h+T
# BSBwDmX7uX6NJyjIDKPuaNRNeArcvoAooYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIJ+bPjReoDuL4wxtUOFGXOPmy4PMIHXzf8logEUOBmYgAgZi3n80
# 5fwYEzIwMjIwODAxMDc0MjE3LjIwNlowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIDJ16L6H4MxD5sgYHlOy
# AXSGeduL8u31sRHi0ksBCtLxMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgAsML5iQnKFNlNBPY3ireVMi8rcmkrzFgjHLddzc/yoDNuneFk6QmmAeJGG5Otm
# keQRK5wRgWeeGbJc4zoI5pr/GIm+JlE1LzgqLPeYLnpyt3FC+mDiWbcBReSoueat
# 4LTGVBJKlxfXaNDlcik5mo0cXjCe2OF5mmiYGA24KnHGY6kQWepaPjOWxMn4odjy
# YpaaX5/lXazRMraJRsKgzWkxHg8AsVD4XtLv/wBsVADLPnEraC9RfdcTCmwroWX+
# Fit2fNjU6ubsrelK3ZrKoEiJlsAoRR5+aTfm+Xfy/f/ZiKImuc6EF0O4XvtVaXoz
# 8S8M6h1GfXiuRfIQbGmi2rqriP93CSsQwZryf/Wg0hZMqLgdWTM8BR8wgHszX/Zv
# UXBqeYM6f5bGqP0cT8ZmBt2yCttOxUX2xoTCuljTdv+ShXl/odC8RePXpJIHOQER
# AHmCMYRJc7LuDylpZI5L+QozwViCFAwEgbbZfm8hIzXp0qSk1lbiu38mtgpdQSGg
# i9898PgwTGIfvZoKzno2FGDAOlr726euNacmaommnFE6YooBIC8/KgnXrJDyTmQt
# fKBGNrJvHmAdpJce5c7gCiimhRUtPtvBebCIB0cvMme40hVY85EkC1wvVyZslk2s
# vvSATeSmRomX3PJM2WTrsAH9puyY+c78BUAPPTMiQXzIcA==
