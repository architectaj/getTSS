...
Write-DiagProgress -Activity $ScriptStrings.ID_Check_ZenographicsUITitle `
-Status $ScriptStrings.ID_Check_ZenographicsUIDesc

$RootCauseDetected = $false
$RootCauseName = "RC_Check_ZenographicsUI"
$PublicContent = ""
$InternalContent = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=KB;EN-US;2213917"
$Verbosity = "Error"
$Visibility = "3"
...
if ($spoolerService.Status -eq "Running") {$SpoolerRunning = $true}
...
#SDDMUI.dll version 6.1.524.0 is loaded in spooler 

if ($RuleApplicable) 
{
	if (CheckForLoadedModule -ProcessName "SpoolSv" -ModuleFileName "SDDMUI.dll" -ModuleProductVersion "6.1.524.0")
	{
...
if ($RuleApplicable) 
{
	if ($RootCauseDetected)
	{
		...
		Write-GenericMessage -RootCauseId $RootCauseName -InternalContentURL $InternalContent -Verbosity $Verbosity -Visibility $Visibility -SupportTopicsID $SupportTopicsID -SolutionTitle $ScriptStrings.ID_Check_ZenographicsUISD
	}
	else
	{
		# Green Light
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC18wt7Pr/RJ54j
# M88TDAVyny6LP0Qi4Hw486aqHz8aUKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgtxEzt2mb
# JAoEO+nonPyHnGjz2X5hkMZOHO3blo6oByswOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBACb6zJrndoUnm52y7aNILb2G7RwOj7vXlUKSBHunHibVh4MBg12tAykw
# zeajRrcBD5Oeis2KZIr5JvmX5P+IPnOGcMmytH4Hw8QFLEiz9luF/BK1w2UexuW7
# aaNf4yJEJyRojxpLdGdvsrXExQLrwHk6Ox2IurkbMFNt3VCpFjeGpKPTHISugGyX
# viWtIYsSEFQG4fot/tHeU63Y9r03By9oODap1d8fR/zynlcD/zLVrGnMmlXvn1lI
# +pXXC6EEhUFJxJ5SwAfzsYx+BAe7HCLV6Af2CE9EMoRxoxNhhBhE/kN3JIrQy4YU
# pGRGiSUUQBi1BOlsEAFYOr18zGnzPBOhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgWmjYKF4CINdTJM80MXCUuxa7iVZjdGZM7uffuUiEVw0CBmGB8A0Q
# NRgTMjAyMTExMTExNjUzMzQuODg5WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAoNFBS
# gzXnf94BKYFsxEthniGeducE5H24n3cSmSW2qjCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAh/ERBU5n479ZDwNLld1U9m8DVOfVOqF94lFy/ceM7De4sXnP
# l3nyHJCuqzGYFsXCDu5rR7cWYGQUkUZx7f+IoUeXYS+PtA/GFyKff3rRaVZj55kH
# 9auiXbkHol43PNsnAav6Y7+c5QTHOOsU50ZsY2/cu8BXaYS3S1a2Y5PjJmBjBWx9
# UmEW0El/4ne/+P4WprL108Uj1foKEG+x5ggTBVLWz2m512DPVuD4MKiJlXlAM5b+
# t2IVMqQokIPPCtf5mbJpK2EdmLiIKWnCNdp0MhOY+QIqFOHi5cYau1D+k6/vyrLF
# umq226MA39egaW6DevtKuNYdb+ZHaAW4lO9ogw==
