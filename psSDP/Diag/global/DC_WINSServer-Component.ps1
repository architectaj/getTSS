#************************************************
# DC_WINSServer-Component.ps1
# Version 1.0
# Date: 2009-2014
# Author: Boyd Benson (bbenson@microsoft.com)
# Description: Collects information about WINS Server.
...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSWINSServer -Status $ScriptVariable.ID_CTSWINSServerDescription

function RunNetSH ([string]$NetSHCommandToExecute="")
{
	
	Write-DiagProgress -Activity $ScriptVariable.ID_CTSWINSServer -Status "netsh $NetSHCommandToExecute"
...
$sectionDescription = "WINS Server"
$OutputFile = $ComputerName + "_WinsServer_netsh_output.TXT"
"===================================================="	| Out-File -FilePath $OutputFile -append
"WINS Server Netsh Output"								| Out-File -FilePath $OutputFile -append
"===================================================="	| Out-File -FilePath $OutputFile -append
"Overview" 												| Out-File -FilePath $OutputFile -append
"----------------------------------------------------"	| Out-File -FilePath $OutputFile -append
"   1. netsh wins server show info"						| Out-File -FilePath $OutputFile -append
"   2. netsh wins server show partner"					| Out-File -FilePath $OutputFile -append
"   3. netsh wins server show statistics"				| Out-File -FilePath $OutputFile -append
"   4. netsh wins server show version"					| Out-File -FilePath $OutputFile -append
"   5. netsh wins server show versionmap"				| Out-File -FilePath $OutputFile -append
"===================================================="	| Out-File -FilePath $OutputFile -append
"`n`n`n`n`n" | Out-File -FilePath $OutputFile -append

#----------Check if WINS Server is installed, and then run the script
$SvcKey = "HKLM:\SYSTEM\CurrentControlSet\services\WINS"
if (Test-Path $SvcKey) 
{
	#----------Netsh
	RunNetSH "wins server show info"
	RunNetSH "wins server show partner"
	RunNetSH "wins server show statistics"
	RunNetSH "wins server show version"
	RunNetSH "wins server show versionmap"
}
else
{
	"The WINS Server service is does not exist. " | Out-File -FilePath $OutputFile -append
}

CollectFiles -filesToCollect $OutputFile -fileDescription "WINS Server netsh output" -SectionDescription $sectionDescription

#----------Registry
$OutputFile= $Computername + "_WinsServer_reg_output.TXT"
$CurrentVersionKeys = "HKLM\SYSTEM\CurrentControlSet\services\WINS"
RegQuery -RegistryKeys $CurrentVersionKeys -Recursive $true  -OutputFile $OutputFile -fileDescription "WINS Server registry output" -SectionDescription $sectionDescription

# SIG # Begin signature block
# MIInpAYJKoZIhvcNAQcCoIInlTCCJ5ECAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDD5D43SmfA5TS6
# OkqQ3Yo0oXCl66b+BbxsQxbm0CB/0aCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGd7RsKVUdrdJ84uxclegR0g
# G9Z6zrP2jiZY1y7F9nNXMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA