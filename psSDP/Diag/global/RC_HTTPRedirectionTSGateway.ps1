...
#************************************************
  ...
  function CheckforHTTPRedir
  {
    ...
    if ($null -ne $HTTPRedirectSectionSite)
    {
...
if ((($OSVersion.major -eq 6) -and (($OSVersion.minor -ge 0) -and ($OSVersion.minor -le 2))) -or ($OSVersion.major -eq 10))  # Win 7/R2 .. Win10
{
  ...
  $TSGateway = Get-CimInstance -query "select * from win32_service where name = 'tsgateway' and started = 'True'"
  if ($null -ne $TSGateway)
  {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA3EGC+mTR+d5N3
# L9HX+3nvCiFcDaTLOEAkyblsFE6NkaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKDnvDoxhDaqi485O7qWDTjU
# byqaWmZyaKaU1LJTQ5lVMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCjgGvy53NrVJljHxxJdamWK/FLUCCKJGFcFg07tynbzg6WTUsVox75
# XP4sp4lItjvm/pZ41qifI6az6bJp3X0RtTEyzzyw1RtTb09ybXxUM0j5cL4KUH0t
# E3yp/8oJuVRMAbKbSilicbKXSoLtlDUVPHlE/5PDlsyF0XZASuW9gVQcpvGLNdlp
# n8j93PcultMFvjB+7Fb8dmMYQ98Vn7l6lLzRVJ5IJldq8n4uCSW1fO5pi+1pLd9w
# vpOkAqVgvRf+csYsJxM3ZGR74GQLe/e2dVRQ0MCOAmMXqn76PkvnafkkT4Hx33BT
# Xn3fpj645Uw6KVLHgNMnPqSSDaOnGK3aoYIW/TCCFvkGCisGAQQBgjcDAwExghbp
# MIIW5QYJKoZIhvcNAQcCoIIW1jCCFtICAQMxDzANBglghkgBZQMEAgEFADCCAVEG
# CyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIIkbx+mU7gj8VmP2fgKhoDaU/Vt5U55661mdlyVUztJcAgZi1+uY
# UxMYEzIwMjIwODAxMDc1NTE3LjU5NlowBIACAfSggdCkgc0wgcoxCzAJBgNVBAYT
...
# 9w0BCQQxIgQg8FnPQwsOE+MwvjZISGX9+vSJe2v1H5NYM5yFOFupcF0wgfoGCyqG
...
# R46ykrvfMA0GCSqGSIb3DQEBCwUABIICAM5aLIKuCQiN6Bwdel30fTjdWmKAortw
# qRmxB2tex2UMsbnuPwhumir4szW+ozGPKGJZtAVpkD77+NZEWgc7tLKXn4Gw4Mxd
# yi2o4k8QFSE4ThqqNeRtGgiY34K4minBOHErqZbWqXAJlkoFiMJuiD1VmbToU2b7
# PaJ0VXEEfMMi2wikSvN21bQ+7Pk56I0LUdzA2syXRLcyrVii/REXYnKtv6XSJpDB
# LdWoOQdkiT0odSR0lLc2RQN31HpMmmcjC9HPH3tMCr/UEXL3FEjAZjppL7pUo5aD
# y14IwiXr0IKKMnTNbxM2/ZYepB0DCwMN1bAFISVmU2e3wOSmGj+yfmSq4jxmRnQo
# GLVIuotjW+6VkJu60qO+ApP6pt5mFQevMFcTpPTbbn2BeR1FAKjDrp0NryutmrqA
# d9vQ/7r1kWvGD4F6nCil7hNQA/C+cdGN27tBeifrSiA8ZO9CUO7kf2Rb7FpM7StY
# APEVnfAQD8kNCexiEyOIuBpcBob2os8x8ycibqP5+o+460r2hHaUeok1Ttr7QfLm
# qTkywTtx/Qv0NnZTwsyPgYtUDPc7I+F9aIqffBdGWbjPRq4iFK133ya2IrUp77bk
# ABZmLavuYOlH4P19pnRgm2HWRe/66fZAwknskEbVVmbmiWT0hnsiMFQp8fbdtecb
# BzexhlXg/ynt
