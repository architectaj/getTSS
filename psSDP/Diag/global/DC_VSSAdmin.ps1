...
Function RunVSSAdmin ($VSSAdminCommand, [switch]$CollectFile) {

	$StatusMSG = $VSSAdminStrings.ID_VSSAdminCollecting + " ($VSSAdminCommand) "
	Write-DiagProgress -Activity $VSSAdminStrings.ID_VSSInfo -Status $StatusMSG

	$OutputFile = $ComputerName + "_VSSAdmin.TXT"
	$CommandLineToExecute = "cmd.exe /c vssadmin.exe $VSSAdminCommand >> $OutputFile"
	
	#header
	$date=Get-Date
	"-" * ($VSSAdminCommand.Length + 35) + "`r`n[$date] VSSAdmin.exe $VSSAdminCommand`r`n" + "-" * ($VSSAdminCommand.Length + 35) | Out-File -FilePath $OutputFile -Append

	if($debug -eq $true){[void]$shell.popup("Command line: $CommandLineToExecute. collectFiles: " + $CollectFile.IsPresent)}

	RunCmD -commandToRun $CommandLineToExecute -sectionDescription $VSSAdminStrings.ID_VSSInfoSection -filesToCollect $OutputFile -fileDescription $VSSAdminStrings.ID_VSSAdminOutput -collectFiles $CollectFile.IsPresent
}
	
if($debug -eq $true){[void]$shell.popup("Run DC_VSSAdmin.ps1")}

Import-LocalizedData -BindingVariable VSSAdminStrings -FileName DC_VSSAdmin -UICulture en-us

$VSSAdminCommandToExecute = "list volumes"
RunVSSAdmin -VSSAdminCommand $VSSAdminCommandToExecute

$VSSAdminCommandToExecute = "list writers"
RunVSSAdmin -VSSAdminCommand $VSSAdminCommandToExecute

$VSSAdminCommandToExecute = "list providers"
RunVSSAdmin -VSSAdminCommand $VSSAdminCommandToExecute

$VSSAdminCommandToExecute = "list shadows"
RunVSSAdmin -VSSAdminCommand $VSSAdminCommandToExecute

$VSSAdminCommandToExecute = "list shadowstorage"
RunVSSAdmin -VSSAdminCommand $VSSAdminCommandToExecute -CollectFile

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDQZ/t5WXAg3Wn+
# tbDRYg5QmsHqpKFTZ1hbN1mepjfyTKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgulm89r9H
# tzrhYgTH/F0Ccclf2BRbKRJKsPVhbYk+bJYwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAJAsngYfQhYW3J482foDkHnOonsKizvCds9usqexTPNoSGRahyqeSF25
# RlOgUGwJvLHbjuydU+TVFdaZkozlGE2zGQuOY1FgOg/ZhQBIRQ/mB/0b6r3I3Qgr
# W6e1GLbaFBfsmXUrV5gpcvpxR+nfjhkAyUQxEh0FqEd7kX05kKVGuMiFdJUSrgCq
# AD8gAGeM0NxB8ytQy4heuRtIIu5i45eUWwYvOCx/OrbugxI87jeDIknV8fB7oumv
# H4dvIzD/HOmRS0UN/tzj3HbDaUwh9mkpmRk8nzEqbkV4Pc7gopCSUMCoOHuQc4AH
# vs04dK4smL5bQs1KBAYQSOzCFWoclvOhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgJyBCBZmLHbqD8w8npVC3OklRbeHXEJIyB8VhJlE5DuACBmGBshkU
# nhgTMjAyMTExMTExNjUzMzQuMDM1WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCA0WXux
# E16dgilwbEaUAzvDWB8szCms5DJF13BFNWENBzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAjb8TliXlfJSD6ZQQx1GtUMx/1C1F0clBdje1cKKX1DC0beAd
# wLDdTluR4OIcrNPa88ug6y6ZZpvRmH3V2lmkqwAtUC/F9nJdh3IvgVxyq9lKv5hA
# jQ9dyU1/jKNST0i1FkJYe+PvXZjFk7m6DqZ4/yqKSOluJHhpuCQLniWt09kziw3m
# ktCUofvgsuNKYB7QIhMSgu+jAh7nCMvBHi/aEZc0MT0jXuELZTzIiKe7KPwwzFpf
# nmrEllQcqmC96H+Yg2q1/SCDwSjzDeGzXvskEfuZVlpGZ81+SuQYoaON+yLJCLeK
# mWXKKNkl+NxLoPRvR0ECbY6yTZ2NSmAHpGJFpw==
