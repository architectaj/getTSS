...
# Description: Used to discover the existance of packages on both the installation
#			   paths and in the installer cache. Once invalid Installer path found
#			   add known good search path and Force searchlist For that product code.
#
# NOTE: 
#
#************************************************
...
if($debug -eq $true){[void]$shell.popup("FindSQLInstalls.ps1")}

Import-LocalizedData -BindingVariable FindSQLInstalls -FileName FindSQLInstalls -UICulture en-us

## FindSQLInstalls.vbs
Write-DiagProgress -Activity $FindSQLInstalls.ID_SQL_Setup_FindSQLInstalls -Status $FindSQLInstalls.ID_SQL_Setup_FindSQLInstalls_Status

$sectionDescription = $FindSQLInstalls.ID_SQL_Setup_FindSQLInstalls

$OutputFile = $ComputerName + "_FindSQLInstalls.txt"

$CommandToExecute = "$Env:windir\system32\cmd.exe /c cscript.exe FindSQLInstalls.vbs //NOLOGO > $OutputFile"
$fileDescription = $FindSQLInstalls.ID_SQL_Setup_FindSQLInstalls
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAMsHJzekFdAkNe
# wFj2GLCswQ1eIma4EMLQOcH1ueTdHKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgwT1SnLbq
# 9jn7Fx4ndiR0/X5AMNvee1v/+hkLFWxYBr8wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBADYUxliEaLEWKaQwR8bnZjYHboO9Da4/KK0fAOFDZB7isP2gtxk9Rjg/
# BzZq5K81fyle+TA+KadWtDrd8yHymFeqnC/Hom2AZiFHt0gHiDtdrVU3+cLiTgQu
# OqjU41eGtHtdeqUyxoQghBsjz5LrTlEEjzS2T683ijaGagFwhGE0cxOx1m9ACuTG
# DaoQGFx2kihwsj3qMJFkZPqZGPaJFqIaGJ8DakJLCBJXxR5L8AsUQOT1pcB4v+ew
# MKgXflC3H0HOT1tdBPWBxjo0DETfQm5LfiyRcGcjWIXma5NSysPHeJfY4T4mH/Ho
# Ma4KbTd5naui9bFxiiv/7w1o6dclJomhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgOiAMT1cjk58HysH+r7RXzVwVS1yBivkSTtVnGuOpApICBmGB8A0Q
# PRgTMjAyMTExMTExNjUzMzUuMjg2WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDXwG77
# rKmoaQ33Q1XI1y2UvSjmLkJHf8/+aLMS3QMm9zCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAOGhDW+xoswccL+9nMDYhDmHduCW40ff3ddXJ79ZuvjGN6lDl
# QsWf6g3sX+l3t4dnQkF+9CuYYW1YkBAD6aEaMhzC9rR80Wr+0ndiubAUiMNw4ERe
# 4nqkOXDCemW7JX5N1iUdJvZvw/rC0B+Qfb07GhLXv5JSggnNHwe12/ez8AwcUU9J
# MTWYgXu1eXIZl8Uun5iPBbAptf73Rps1IeoVGRpeEuQKEJwTOhD+e8YSg38vD53y
# oRXlrKLT5u1kkQXVl1qCPwBP8kSb6kOE46EINshOiJB/0b9jViqEqTovH0e/PIxS
# kSk/2G69rhsou9KWsQHs1NrTcyAqQ548gfeuig==
