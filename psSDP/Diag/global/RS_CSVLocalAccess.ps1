...
$SharedVolumesLocalAccess_Summary = new-object PSObject

$CSVMsgs += "<br/> Please open the file " + $ComputerName + "_CSVInfo.HTM for more information."

foreach ($CSVMsgs in $CSVMsgs) {
	$msg = "Local CSV Access"
	add-member -inputobject $SharedVolumesLocalAccess_Summary -membertype noteproperty -name $msg -value $CSVMsgs
}

$SharedVolumesLocalAccess_Summary | ConvertTo-Xml2 | update-diagreport -ID 00_CSVLocalAccess -name "CSV Local Access" -verbosity "Warning"
# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCChlgJpBhXWq4D4
# ojOCFgg45CQ2LrEXbrLxFojHSG3HPaCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgGgt9JTeA
# oGzilYcGeIIpiFlkx37v8da4DE9APOyfNuswOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAEG1iPEFTyk3jym10hdbduyRxaaq3E1eN4Bg34HARWYzLZ6I+5qQaRKO
# 8Tv/BDjL8Jp/wFHtx4LbAxpuHCc9dlffwryjg7mVFSCx9gGOL4ryL+S3UIUhjgWt
# dsugKhSUIeEe/yaJa8J9oN3I94z6swSOHgcrrt8pOM1u3N1HwZyjOxlOzt2NjrSR
# kI8ZxrgR0J2hjqHt+3GagawGxQQpQ2TWlMIXCecgDT0z1//jvlb0YlrJ5M1zAZAz
# tVxA6kPKkaWQAuuX9MViBjJ+gEnC8/a1+b+dVlJbIdWYP/MjJtWKb+io6kkgQm7v
# ofNQBHNMWfLm5QlZbGpIU1B3q9056D2hghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgY2hehu7xqx/3i+4otTelSMsKZApLoYRIZt2GpJ9UgEcCBmGCCja6
# gxgTMjAyMTExMTExNjUzMzQuMjAyWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAA60YN
# 0QFvjxbljTUCNETkfCNQ9W2iBhje1HEscL2gdTCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAXI4zeosItWqSAmZ0ahwpmLj2oPVqce61NIAG8PRsYBlCIQpy
# qRMGizRsTUyndPSBlEtx2VNsLFixAVrjS6CCFzCLbmVod4krMxvNBb8d/Lwl3uUq
# 3eCAkRKD0Vg3vw6Ggm1vUIRCzl4cQ+iQJZZklt8NXqkFEwqpkBjJsDfazWonA/E7
# vTGN3l2VwjoIA6Zc3INoAoaedwydkCm++6D82OjCcSWVqZkSQZPFYPpLwrIU4pbe
# rYhggZ9f8Jenr5AOGyiFu0SEweQOcWrOlkYq9jEAtusKlrt2VzBO+XXvmrK1+DqD
# e+xZaEdZRtQho2P8jm/SZDrYodN39JCpC8baXA==
