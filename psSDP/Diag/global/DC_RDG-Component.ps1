...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSRDG -Status $ScriptVariable.ID_CTSRDGDescription


#----------Check if RDG is installed, and then run the script
$SvcKey = "HKLM:\SYSTEM\CurrentControlSet\services\TSGateway"
if (Test-Path $SvcKey) 
{
	#Windows Server 2008+
	...
	{
		#----------Registry
		$OutputFile= $Computername + "_RDG_reg_.TXT"
		$CurrentVersionKeys =	"HKCU\Software\Policies\Microsoft\Windows NT\Terminal Services",
								"HKLM\SYSTEM\CurrentControlSet\services\TSGateway"
		$sectionDescription = "Remote Desktop Gateway Component"
		RegQuery -RegistryKeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "RDG registry output" -SectionDescription $sectionDescription

		#----------RDG EventLogs
		#Microsoft-TerminalServices-Gateway
		#$EventLogNames = "Microsoft-TerminalServices-Gateway/Admin"
		#$Prefix = ""
		#$Suffix = "_evt_"
		#.\TS_GetEvents.ps1 -EventLogNames $EventLogNames -SectionDescription $sectionDescription -Prefix $Prefix -Suffix $Suffix

		#RemoteApp and Desktop Connection Management/Admin
		#$EventLogNames = "Microsoft-Windows-RemoteApp and Desktop Connection Management/Admin"
		#$Prefix = ""
		#$Suffix = "_evt_"
		#.\TS_GetEvents.ps1 -EventLogNames $EventLogNames -SectionDescription $sectionDescription -Prefix $Prefix -Suffix $Suffix
	}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxWuSGRh680he4
# +Pw8yxr0WEuIsDyuLaKfFcCGmCVaOaCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgmbcaGvaW
# 2FnNEm0Xxb4jOpJTsBGVg5psNXmZ/rPwXHIwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBABuxK5ingdfclnYNKA5edhnIeWmZXaPY2Jban9MzRvxenEaCfDO97ptc
# yHb5AYUy7yG+kiK7fXiMY7AAMGoToP0DLjE+4omLnU3XuMUzga0iYPYh03iDeU7g
# vo72L2bDtL78A0hIlxRYPeE/LB1VhAlt1Y4zZQmH3McgEgB0QyAGOt5IMpPrRIPC
# dRzJ5RyJSr7lNYWFq6Vre++rmJRxN1GXO4WoTa5vOSxL3SFPHxTPdW13/4HNS2Ak
# v5f8eWxXYM2gY08nCwBTQKBXLuJD32bExuXLBiNZjG4YN0lMDpWbL3XHkzyTByHF
# z9XP05bZKB5WSdR5RAbnOBi62VGPiwmhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgG+fw4eHzNldPE1WTRpGVQT36SrpeOmpzyBR5me7smOICBmGB8A0Q
# RRgTMjAyMTExMTExNjUzMzYuMTg0WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBLFr3w
# WA3+ZAejOyStWJ+CacYaXGYXw7tqpiEC/6O8gzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAUhPgSpnUIN6uH/ALu4jSa3PWqHJab5FkJiC5TiFfVrG8/c+D
# pDx9OPhGefU4WKWWBG+RwMzLVyV20VATQTaXDoHhydcLb9HmYKj8Q8UlIm5nQuys
# 0gis+v8t4gm3WYccfrw8ZBCeVuBJYLIzfz9ov8+yRkhcFZDix2zYZ5cF09rLWbqT
# zmH56jGaPZh6pcajjIZ4PUkya+RoHywey3O9r0H3SF9PYYpgjIgN/A8jUtvMaXe5
# n/GXWrceKpma614a9JDF1URmRVzUu1IzHUa1U8Q9GDO0U9ypTjYv+mcsbXT2hjhE
# QyVwWNpqTp1D7mYwKBUq9kcntjsBsE3KEGkl+Q==
