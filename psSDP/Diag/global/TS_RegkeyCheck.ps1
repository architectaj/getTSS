...
Write-DiagProgress -Activity $RegKeyCheck.ID_TemplateRegKeyCheck -Status $RegKeyCheck.ID_TemplateRegKeyCheckDesc
...
$RootCauseName = "RC_RegkeyCheck"
$RegKeyName = "HKLM:\SOFTWARE\Microsoft\Test"

if (Test-Path($RegKeyName))
{
	# Check if registry key exists:
	$RegKeyValue = (Get-ItemProperty ($RegKeyName)).DetectRootCause
	if ($null -ne $RegKeyValue)
	{
	
		$InformationCollected = @{"Registry Key Name" = "$RegKeyName\DetectRootCause"}
		$InformationCollected += @{"Registry Key Value" = $RegKeyValue}
...
if ($RootCauseDetected)
{
	...
	Write-GenericMessage -RootCauseId $RootCauseName -PublicContentURL "http://support.microsoft.com/kb/111111" -Verbosity "Error" -InformationCollected $InformationCollected
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCATZymH5g8ENhAe
# 5Q6XzSzo3tCuZKBeXVlIDkbqRXQom6CCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFcq/C1x4VhedU5DFvNq1gWb
# is+dHFsFD2+mVSm8i+BkMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCw6xYFlDULjt6ueRSm4kFVSRDVziNGNZes4bC2ovRebnON7j4Pb3W4
# N6LlSwEjp4zHzur6+wene1otEmk2hHbqzhSAC2hQcOu8Ui1/OTHGKE0pFb8RDmh/
# YGBMJ8Hri53QM3Xv9OwsOqWoCQI5+imMUafSrC4k5xW6qxJcvDzKnUEFKXa3yrer
# SSpl78UpnfzlsBAPb1KjbpHBqNq8RGYg4eTUG5zbb2J+byBr9bDT7/vBHKwtkP6K
# N91XUcwKodQywHh/Rrr/a788bCcxjxbMM/WLqECzjT8ueSejLLL74HVC7tZ51iIz
# 4h64xn3auHR9vhn9T9GUr0i4af3DnyfeoYIXDDCCFwgGCisGAQQBgjcDAwExghb4
...
# AWUDBAIBBQAEILzoo2gWskhnPAobhjJtEkhzviKWUd2FWCE2e4NJVbo4AgZi2wZs
# jvMYEzIwMjIwODAxMDgwNTM2LjQ1NVowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgPmSkpwB/Meh2JwrWanIAbh6RKIBhlLZ5
# UtTdFGyTPJMwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCDNBgtDd8uf9KTj
...
# lOK94kvWvU2F8vPBc3hLhZ9yD3zCMA0GCSqGSIb3DQEBCwUABIICAEruNniKaoeS
# Ea8iEbsqw3TAs43K3LZ5qaNt+Fdy3HuW8aaB+AZHVUNpfdz7y4BCyKvMvRVV1QH2
# ZNmjzJ85nKPpKaXoPXhgk/SzKDv655/8OeSCO8s9qnlgTJGCMfitM+WM9Sac5jtQ
# bStt2Ou1yBGtPStqy3ZhSYBXFRzEe/VmwLGkFmHZUk3n5jA8ScEErRe1ncFMgRum
# IJRTmZJSY9h49mt+qzTNd5XPEQ8ToNxrH66UPuRendbwGbPurblkunlVpd9dvsmc
# qrA3t17oRReQRTPM01IO0W/AwSYLhUlk/qMqIGRTAv4KMZGcCfYnjU70MfwKOjvG
# tKPfKW3R1MbJRfE65n2OIgZHvAdh/39IZC1c4j+j8tyhf60fHiLEh+/SkN+Rbl6f
# phkRtf5FMNTsK1ghnMcWbpms5yo+qtCEkK76CcStiXZXs+95WRDxKov2j8xH42Sm
# tlDwoNREpFogpZAU2PTOiWxe1wP3HGEbK/SGNX5OYoa5Eww+KzqBaTcdfDQ4tJGR
# h8o3bm69L7Lck6Y0Tb8eh1b8t+jMtSCH7/ewXtGP8nEAXY95fTsUelJAntny8JGu
# 1hZuwgHLLoX4qckjXz31b2AtrXfVXr+f/dyJ15w2zd8JlQaJgsqCG4aT29SAHGv4
# m2KiZtlkDrpsiAHTpj2YhpTAuTSW9U/d
