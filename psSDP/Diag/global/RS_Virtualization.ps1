...
Import-LocalizedData -BindingVariable RS_VirtualizationStrings

Write-DiagProgress -Activity $RS_VirtualizationStrings.ID_Virtualization -Status $RS_VirtualizationStrings.ID_VirtualizationObtaining

if($debug -eq $true){[void]$shell.popup("Run RS_Virtualization.ps1")}

$VirtualizationAlertXMLFileName = $Computername + "_VirtualizationAlerts.XML"

if (Test-Path $VirtualizationAlertXMLFileName) {

	[xml] $XMLResults = Get-Content -Path $VirtualizationAlertXMLFileName

	$XMLResults.SelectNodes("//Alert") | Sort-Object -Property  @{expression={$_.Priority};Descending=$true} | ForEach-Object -Process { 
	$_.InnerXML | Update-DiagReport -id 00_Virtual -Name $_.Category -verbosity $_.Type
	}
}


if($debug -eq $true){[void]$shell.popup("RS_Virtualization finished")}
# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvL7sIU9l6eFtQ
# mKoH0JTZV9HZaQnnRUEAn+y3pyfS7aCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgCxX7wCCZ
# bOw07DZH2rOM8H9KkmnmDXnjxOOZPGfwU28wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAJdNciEGgz2bb5HFYbRLlvHRiGNGHp2JuwwmGxa/kwablrdqhz06WkZJ
# ycC4SEQcbtvb4dubcenIQCLeYXapDEqAo/bIS5MXXLw4xq/PA+FuY9YhrCmc83kI
# NS6kxfp/vM5wcEWzp/qrVsxFOY1duQguxc76O7vlYHUHTcL1wvN9r+2VML8O3YHr
# VxCMH7nbOWlVD3hP9OPyuftpu2a63pNPYM6oj6MuVA734v/PRkwWyYIcSIJzecgd
# S7XHLTcKST1bkMVQ027RGP2Jae/p3buvzvG39NIr7HJPBhqq6s/f1rHEFbKjnx/J
# n6wY92rtNMoIAOzud2hT3/minTZBSZmhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgtE1uY7lxqSh9Tfnj+CmHhGd3+3eDIznec/IQGLbYc9MCBmGBshkU
# ihgTMjAyMTExMTExNjUzMzIuNjE0WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAWGsdf
# /7ocAnaspnJ9afn6HzTxifibjtsmxDG0OYYlzTCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAm2Z+SLwVb0q8uu9/7dZtDHo2ajroOnNPWF4Ts4cp8m31wcNk
# LglIWbvEonaQ0Rzhzj3wlxRLocjlwTpLDrwzpXhZWKejJnJwoYwsoEKKlR+xoOvK
# NLWeCBNF+jTTar9MpSC8McoyqwkZaRuSri1awh8foVlpDJ/JKXn2iG7tZF3/UW1Q
# OwkWrVK3Oze7b68tff1Sb0PLVuH/zRkEm10zVmAgVO0fSx7v//Prg65sV+i8q7o5
# 2+zj5XTekeJOo5gaC5FyZdHYOWZYqtoxC0xQz/sYuwFdq9peygnk+nV7aknjpbT4
# xBstGifErvCUZWZH1Sb3P5GqJ6k1I9epBnMC0A==
