#************************************************
# TS_HpCISSs2DriverIssueCheck.ps1
# Version 1.0.1
# Date: 6/25/2013
# Author: v-maam
# Description:  [KSE Rule] [ Windows V3] HpCISSs2 version 62.26.0.64 causes 0xD1 or 0x9E
# Rule number:  16157b68-0515-40d5-babd-30d8410a54fb
# Rule URL:  https://kse.microsoft.com/Contribute/Idea/37e5fba2-375d-40b6-86be-23926af99417
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 16157b68-0515-40d5-babd-30d8410a54fb

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_HpCISSs2DriverIssueCheck"
$InformationCollected = new-object PSObject
$HpCISSs2DriverPath = "$Env:windir\system32\drivers\HPCISSS2.SYS"
...
Function AppliesToSystem
{
	...
	if((($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 2)) -and  #Windows server 2012
	   (Test-Path $HpCISSs2DriverPath)) #install HPCISSS2.SYS
	{
		return $true
	}
	else
...
if (AppliesToSystem)
{
	...
	$CurrentHpCISSs2Version = Get-FileVersionString $HpCISSs2DriverPath
	if ($CurrentHpCISSs2Version.StartsWith('62.26.0.64'))
	{
		$RootCauseDetected = $true	
		#Add information to InformationCollected
		$InformationCollected | add-member -membertype noteproperty -name "Current HpCISSs2.sys version" -value $CurrentHpCISSs2Version
		$InformationCollected | add-member -membertype noteproperty -name "Required downgraded HpCISSs2.sys version" -value "62.24.2.64"
	}
	else
	{
		"HPCISSS2.SYS current version: $CurrentHpCISSs2Version" | WriteTo-StdOut -ShortFormat
	}
}	
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCADFXWyFkku6b9g
# N+ygOxloE23ksWxfw1grrNk8ZQQb8qCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgflxudpMB
# GYDjcnYmq/kI+beHFauWF4tREo5RL8W8lZ8wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAFIWj4wlIcLN0ZA18XlwCYAZSjJ9J4EW677yDv9j7LJuJm7VKuyZm0ST
# w9vPkgjqUBOPXpX/CyxJN+/+njGaPqj6EfYruHZKc707uClCsOlefDm+DWA7NPmt
# /g7qlvovLUdRKy8HBxSvpvC1avHYnpcQXVYH5l91Wqhlu9ZoDr6fVe2oxcztIMob
# g56dM37fkz+KaTXB4zB+x898ktVt5MJduTt0LeaddYhxn1oDZiKjX+VKu8E69vjg
# xGerPzos1A/VN0DmRf+KmSdsDxtzX5VvYKn6jnKTfWPsWSd1dbZGt+YgOyS0CsRB
# i1YyWFtrfkc/lJeh7r8jLSuZxlZa/MKhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQggspK0ODTllPC5H7u/ZQrEOcNbJod3VAoZdXDHKpxzvUCBmGBshkU
# nBgTMjAyMTExMTExNjUzMzQuMDIxWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCeyY2a
# FD9G13XT4ZLvDM4vUYxjZJSzgU7c+Xjq8rfZjzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAtHz9rxXInGG6RZqDHotV1e4+GBjnr0VzrDMc7REewsSLErLW
# aM4eORkyLb9Mn1Tiux3IhI69UR+ABb9nQTvSs/qJQjJAkcPsjv6zQyySmXaR0z5x
# fynzJ19A4s2iLSVX+1ovSDkpoAE2fqn9P+m9ZbVe6Q8OcBSc2poPeD9DFaxLfFUw
# 1r91qinmKwevGi3WqB5V8iEI6N+mkHYWRaWGWU41Lt30LvnkpLN611CppfdhH0av
# f5fY/qTXYgjlHmnzmpOCssSY/60gmbzQOS5kgchttvMKhkvwlnR6vKUOShRSMXiQ
# 6QRyr40VuT40t2CcFK1b+c8/TPDPryu9wEF6BQ==
