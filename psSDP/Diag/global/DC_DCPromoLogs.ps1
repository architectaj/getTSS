...
if($debug -eq $true){[void]$shell.popup("Run DC_DCPromoLogs.ps1")}
Import-LocalizedData -BindingVariable DCPromoLogsStrings -FileName DC_DFSRLogs -UICulture en-us
	
Write-DiagProgress -Activity $DCPromoLogsStrings.ID_DCPromoLogs -Status $DCPromoLogsStrings.ID_DCPromoLogsObtaining

$sectionDescription = "DCPromo Logs"

$filesToCollect = $Env:windir + "\debug\DCPromo.log"
CollectFiles -filesToCollect $filesToCollect -fileDescription "DCPromo" -sectionDescription $sectionDescription -renameOutput $true

$filesToCollect = $Env:windir + "\debug\DCPromoUI.log"
CollectFiles -filesToCollect $filesToCollect -fileDescription "DCPromoUI" -sectionDescription $sectionDescription -renameOutput $true
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCjf5gekrvDMcOB
# ES6PjRq+oqKJgDATj8aa6zGvyLvzfKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg1WVhnAbP
# MOgv9HcMCDlHAk5OCNvZT8h0j8Cf10B2zUwwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAG/jG2AWz5JtiU9Fz3Snkx+lbxCi9z+F6raH0qLY19U155fsZjQpmXnQ
# SM0uSb5eDgnrvfDMytEZI4PFgEcV2qpgB9c6hnliAHqg144mrTK3QTBq5GcC4oaL
# jC52uJHzWcGMymNLM9nY0T8c2TuQ4fDKI0LQbDadxr0M0TSMy8bH1Vyddn1q/5vF
# K4syT0Uio0m7HMPoRLQpYdag6ES9n3jKQZj15VLKeW9zYKrNAwRuXm7SA0ZxS8vC
# t7R7QGqCQyPFvAZs6p1YQsmn+qrRdCgbA1xZOSjX+jUN7rGA49dZMMUmdktT6+I8
# T1TLshJ6ePh4gQOi3PN9p7Q3x9DXxd6hghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgwzN8hLYsrYLXHQVul6Efnu6pRZGLZCE1JXZvTklp5iMCBmGCCja6
# kxgTMjAyMTExMTExNjUzMzUuNzQ3WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBDnzKC
# Tje0n999ztivpBekPcav6lvfgxjsqG8uvHzVcDCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEArPY1fovb+Dnne2jimmOGTEZNZ3J38XwLYEZNVxsHAfTjBQLi
# PMztxT3wA9snlIpoXDSkfsuUdaJKvcE7Z5qAUoXz3ZIKbxUoLxA85iWfOTDeL0Kz
# MabiVkBNlq6L8BBtCtDZwA4fkA0wWohlXsNqBVlseuT/tkAXvN27trPlmTiVsK81
# UQad76R1ce5XsGhoeGQ/f6YT17TLtXDUqWE4fIJSYhT+9Jnnj6RCW/hZhELfkfOD
# rszO8gDZx+x+rAlrhqfjkdXbXvzFtJfKm0XIt3DR+IUz3W1ZxDB827l1F9Dmnz5H
# Pq9174FGgNvj5u2BSKsF1qwP/lIctpk2CbZMfw==
