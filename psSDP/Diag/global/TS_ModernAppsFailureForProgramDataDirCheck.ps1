#************************************************
# TS_ModernAppsFailureForProgramDataDirCheck.ps1
# Version 1.0.1
# Date: 3/13/2013
# Author: v-kaw
# Description:  [Idea ID 7547] [Windows] WinStore - Modern Apps Fail to Start if the ProgramData directory is Moved from default
# Rule number:  7547
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=7547
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 7547

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_ModernAppsFailureForProgramDataDirCheck"
...
if (AppliesToSystem)
{
	...
	if ($Env:ProgramData -ne "C:\ProgramData")
	{
		...
		Add-Member -InputObject $InformationCollected -MemberType NoteProperty -Name "Current ProgramData folder" -Value $Env:ProgramData	
	}
}	
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAoI7ynWJIdWstU
# rIllfoTYgTjhtCAZgmrLjRXTgpHlUaCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgsl3FTsu9
# 6Tj9GUZQw2ewNYcxuZTLrVQ18omu3DMnBr0wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBALX1DBz3KU8fVf75hln8ciYRJqbSKHHI+dang/1QrSOArwrRfxJE+4EZ
# h8zQsriieLbhLzynyl7xS0iw1wBw8doMPqYW8yf8hromEYs/pgO6WJF4weTO4Hnz
# cxlQ62/14aSFfKqofegGGYcTi0uhzSLXzRaJhVT+HggKU5w0ua2b67HRDs0wXM7p
# y00gyB6kJ7zdb+Mr48RexOkynEeHhF9swKlWLoxQizZx9BLGNugIzqWYoi1iuT9/
# EzNvJsjTIjtnEYE4H7w04RjspPycsJTEYITnpnfdBLsJ429ywslf7dGctEj9lN1S
# NwC7HZytCrVS4G3dCT0SyRLeZcepAN6hghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgin1RamY8/dnom+Jz6S6F3D/lSOp4/lF7KsqqjM3XYlECBmGBshkU
# jBgTMjAyMTExMTExNjUzMzIuODkyWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDVvbS3
# WULo4ZqG4rEOJlJfBjFBkuaMmMSw6VVBFjT7+zCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEACIB7Ezq2Hb2CoxPfaBoMxyByvFOgSBXTp0EvfqaRF81gSfi/
# 041672qdk2Jb06QB/nIEebAlEdvNgqDMtITmLpiBnFtWTIX4qjRJNHQYve39Bd6w
# LIJ0cksZhyQk6ObN+j46l9h43YLqyMxKqXfUD+2jdE+uZi3DhCIFDRt0ZbEOBXtz
# /3IyW8LVFpSNjmED3TixQKlylEkCErX0xP3763MrdkJvyPxsnGjG6YKDHo9C3FgB
# gc9AMPuLIRXKjtatUxpGjDB0PGgkXi2tUbum2O4s4+yhDjbBeZtSzbA7qO/epC+8
# q/uxsthdWJPwhb/Gso37BvBzTyVi36qNnU/R4g==
