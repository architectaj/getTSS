...
if($debug -eq $true){[void]$shell.popup("Run SQL_Get_All_Services.ps1")}
Import-LocalizedData -BindingVariable AllServicesString -FileName SQL_Get_All_Services -UICulture en-us
	
Write-DiagProgress -Activity $AllServicesString.ID_SQL_Setup_Services -Status $AllServicesString.ID_SQL_Setup_Services_Description

$OutputFile = $ComputerName + "_SC_Services_Output.txt"
$CommandLineToExecute = "cmd.exe /c SC.exe queryex type= all state= all > $OutputFile"
$fileDescription = "Microsoft Windows Running Services Output"
$sectionDescription = "Microsoft Windows Running Services"

RunCmD -commandToRun $CommandLineToExecute -sectionDescription $fileDescription -filesToCollect $OutputFile -fileDescription $sectionDescription
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDbgw496MTj3Qqk
# PBNV60Pi0BHu7Id/dXqHNQH1/koEiaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJMzNPx3WhIgxJGll+Q5+Kwg
# dG59i9RXdsk+cgJBqy/yMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCUZ5uXd6pI9QZ/8VynzUlDTfpL21NeaQXq9AsXU7+b3Rc4P1cZFKi8
# 6tGt94FC1xi1fM1+nYiU7inGeTUUpR6ADxr/549vEzYaj829FOmXx/wwOlG7ZF1B
# CpWDPIOraJP525/D3BKDTzDIOnzUqBGi3xDLoN5pDHE9+8vEKt1Q+qjZJuzerrUq
# 9rV4mJD5nNcOcSHFoweL58KEchIwj6FvYpAlXIm9WbwnY6IcSjlPcavz8CntiHK0
# Zp1AtgR3ifDjfkC7e0wmC4YmVcUhSAxB9St4fCf9iQzFS98VaBcZDoHo06fv0eGE
# yKTaoEpMhWiLrsr8Ar9lseSsgI9OoGK+oYIXCTCCFwUGCisGAQQBgjcDAwExghb1
...
# AWUDBAIBBQAEIPdqSuykARiq9yAFBezrpFDrenD/H5JdVogiAxL61+9xAgZi2xAP
# WA4YEzIwMjIwODAxMDc1NTM2Ljc0OVowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYT
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgNwqcI+oHxL6WSlVjbKXpg9if0OuQCUzyGjxX
# AnAELKMwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAOHK/6sIVgEVSVD3Ar
...
# /DQk+dqQy1YkmvsPNzOkpL0iMA0GCSqGSIb3DQEBCwUABIICAK/zMM0KlRWygpIU
# 6zBfQdpTd6R2kuzsEC1nSG5wRiFClWS1NUW3QgNprc3sy+zD2cKOiq04OOh06v7O
# /BUOVXPAjuH2aOOQcdHjMrh8p9uRzURKCvPyafhLLUSsURq+5qcixy7Twj1UH6vf
# SzT/jyMGaPO1DbPwHH4dpHJ4KestItwxc0H01evvRgpaXX+XXYCmY7wSVDG6IfiS
# AFXeANT8M8UThYpsQD3ockvHc6ajGeuv0D1C+FLytjEgvCVB9FgIuJ69FBp5+rnU
# FCT7A3uSoLnoJROaixlJL58WKSOolwKHGojFfUrTla49QXi00PxYC9ZbIgeNW4VA
# As9q+9nCDLlc0iLPu83gVeHNjFmajpQzKZu70mw6SPu46AcXjlsinLwr86Ean9ya
# +j/Y1slp6AryBe6vGzfABKGP+wfz/WPET4FczkhBod2+/n+QNkp4QAzX1PIoMtW3
# GgkVEaXSIrQuQbJCmmemXDEYDrEE5UyMdG6Os2FUCph/qoiMBlU0l2UZLU4cJgjg
# wBmxmik9fzdVJkKpgBJn/Qu1uUv/0oRTUsR43VzInsBqCMQ2neOyOTcsIKKvkSrw
# IuMEFmwhiISuWmXAvyafganj1awPwyLpLwEzdWTauUFykxqpykAYybe3TBkXsvMm
# gpCnuCVpdK0PsQukCjnLx/maHP6N
