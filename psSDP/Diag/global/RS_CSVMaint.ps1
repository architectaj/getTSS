...
if (Test-Path $ClusterKey) {
	...
	$SharedVolumesMaintenanceMode_Summary = new-object PSObject
	
	$SharedVolumesMaintenanceMode = Get-ClusterSharedVolume | Where-Object {$_.SharedVolumeInfo[0].MaintenanceMode}
	
	foreach ($SharedVolume in $SharedVolumesMaintenanceMode) {
		$msg = "Maintenance Mode"
		$csv ="Shared Volume <b>" + $SharedVolume.Name + "</b> owned by by node <b>" + $SharedVolume.OwnerNode.Name + "</b> is now in Maintenance Mode"
		add-member -inputobject $SharedVolumesMaintenanceMode_Summary -membertype noteproperty -name $msg -value $csv
	}

	$SharedVolumesMaintenanceMode_Summary | ConvertTo-Xml2 | update-diagreport -ID 00_CSVMaintenance -name "CSV Maintenance Mode" -verbosity "informational"
	$XML = $SharedVolumesMaintenanceMode_Summary | ConvertTo-Xml2
	if($debug -eq $true){[void]$shell.popup("$XML.InnerXML")}
}
# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAoGdvG82uf/uSv
# oBmPa1u1VVgSwly8CG7ta3CAk2pym6CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg2cISikBq
# uql+3S3zJJxkufWpfNKagLiPxcYgeoAkX94wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAFVkc0/kend1Iyxp7kGGK4xrl0R1QgNikwL36jAYLQehVCsQ9hj+wDuj
# YR1jC24yQ4Ta2XTDwpIUKW44D9eJ0cDbvVuaMGKXCG6S8b7H57X1nYN/G3+CFTPp
# o3ZyZ5XnJHN6KBI/Kv4NgynZvkZCZIoEBm41Ry4Xc5dAu4/M1e9/H+U3Ybg/msrZ
# TCeHoGd4VTVRAkNel4z5Y3QBIYhjZya8MQOJx734WCVUFMi638AMhx6GJ2yzy8sJ
# x4k28swjxKXRPWWE72yU++ISggn+5b3DdRfaG2Km0KrdxbC8pE3kA6qiMU6Wmxn9
# /N/glHgNLn3m5ogTo+UthVBa/UuTnDWhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgtlhig6iYaW8ty6MXU6AjibZ3frPOq0rBQ6kVewS9TcgCBmGBshkU
# mxgTMjAyMTExMTExNjUzMzQuMDE5WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBxjyqO
# dhjLUyErqn5gOSu+YECDUtxNIzT983McmU4rfDCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEA0ggB9lm9dokUaVxQmml6LLwvwmPtxENRG1L12Aj5FTgIwAeW
# wxi5unNhuyoxidU+BP7O0Mlso3uOiYESBcsCPFbU3+ES+7phn6NDLvgrAE+26zeR
# oR/NF4plt28kC4PFqA8AJ5rOekCyXUA3OPQa0NzC/9HTsovR+r0y7W2SQ4Vyy0Lb
# pD1TYlhmzVsmRPZ5Y4eyuI9hPP7FMATbBxZBSnOiq1ITMfQK1JXYUUXGJDiAx+9Q
# CLi3ML/KsNCy23ntPWMNVoJGQXp1FeclC2dEmlh5oeGqfX56DcNmSOrTdpg+y/O/
# L8/jN7RW7YNyrP/CT2MVcgnnmnA3JBTVaUWh8w==
