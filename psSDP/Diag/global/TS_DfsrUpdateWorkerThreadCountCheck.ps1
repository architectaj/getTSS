...
# Rule number:  2831
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=2831
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 2831

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_DfsrUpdateWorkerThreadCountCheck"
$PublicContent = "http://blogs.technet.com/b/askds/archive/2010/03/31/tuning-replication-performance-in-dfsr-especially-on-win2008-r2.aspx"
$InternalContent = ""
$Verbosity = "Error"
$Visibility = "4"
$SupportTopicsID = "7982"
$Title = $ScriptStrings.ID_DfsrUpdateWorkerThreadCountCheck_ST
$Script:UpdateWorkerThreadCount = 0
$InformationCollected = new-object PSObject

# ***************************
# Data Gathering
# ***************************
# check if it can apply to current system
Function AppliesToSystem
{
	if(($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 1)) #Server 2008 R2
	{
		$DfsrService = Get-Service | Where-Object {($_.Name -eq "dfsr") -and ($_.Status -eq "Running")}
		if($null -ne $DfsrService)
		{
			return $true
		}
	}
...
# check the registry key CheckUpdateWorkerThreadCount value with 64 ,if more than 64 that indicate red light
Function CheckUpdateWorkerThreadCountValue
{
	$UpdateWorkerThreadCountKey = "HKLM:\SYSTEM\CurrentControlSet\Services\DFSR\Parameters\Settings"
	if(Test-Path $UpdateWorkerThreadCountKey)
	{
		$Script:UpdateWorkerThreadCount = (Get-ItemProperty $UpdateWorkerThreadCountKey).UpdateWorkerThreadCount
		if(($null -ne $Script:UpdateWorkerThreadCount) -and($Script:UpdateWorkerThreadCount -ge 64))
		{
			return $true
		}
	}
...
if (AppliesToSystem)
{
	...
	if ($RuleApplicable)
	{
		$RootCauseDetected = CheckUpdateWorkerThreadCountValue	
	}
}	
...
if ($RuleApplicable)
{
	...
	{
		# Collect UpdateWorkerThreadCount Current Value
		add-member -inputobject $InformationCollected -membertype noteproperty -name "UpdateWorkerThreadCount current value" -value $Script:UpdateWorkerThreadCount
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBcz81uZWS/1rzT
# t4pqW9ARiDY+6ZD6lB9Qgp/raQG6KKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIA1XMcobp125Ra3Sv0TEwfoR
# tyitQ4Y2IkU4PnXjS0e6MEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA