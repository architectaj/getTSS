#************************************************
# TS_MSIPackageInstallationCheck.ps1
# Version 1.0.1
# Date: 3/4/2013
# Author: v-blchen
# Description:  [Idea ID 6711] [Windows] MSI package fails to install with error code HRESULT -2147319780
# Rule number:  6711
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=6711
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 6711

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_MSIPackageInstallationCheck"
...
Function CheckPolicyApplicationCompatibilityEngine
{
	$DisableEngineParentPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppCompat"
	if(Test-Path $DisableEngineParentPath)
	{
		$DisableEngine = (Get-ItemProperty $DisableEngineParentPath).DisableEngine
		if($DisableEngine -eq "1")
		{
			$InformationCollected | add-member -membertype noteproperty -name "Turn Off Application Compatibility Engine" -value "Enabled"
			"Turn Off Application Compatibility Engine Enabled" | WriteTo-StdOut
			return $true
		}
	}
	return $false
...
if (AppliesToSystem)
{
	$RuleApplicable = CheckPolicyApplicationCompatibilityEngine
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC+OeT5o4/uBwvq
# b/FEaAOjBZPSd/C1K0+GujnjDyUWSqCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgj0RfyilR
# UwUxbZmUd0/MHf9ecTYpHYSM3B4lfxsvgmkwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBABFHRA2rIi4cbgpvBSsoSYmuceXKEfySvSlJpSi/uNeW3+ha/LIaS7dG
# +2aGq6npbfhsyViENbHQTMI5nqVN+A8l1ta2A8p25PN1lfh73WJwXFgm9Vo1RYB9
# ZCYS2fkuCLU/MPCUVP8Pi3ZTgW4JzwNU4nU/AdoPK41DB25ofUkjwys7xnj5HTju
# HfhTJs11VW2LYns0TI8AXhdkkHzPWdKzIu/9LBbG9NmnACgHUm6nTL9OjDC2jwWy
# K9u4TGAqCZHWWySPDhQj0UgcfPLysEtUn2ESEhjroaqYtmKA/unpCbF1xWHgOuu4
# kG7LiXvU1r6oSOMZEt9uEX+Bdy9+KJ2hghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQg7qo+CJnScwXVvcb/mME8eNtUGOMbiGIbHmJotZsz7XMCBmGB++Yl
# NhgTMjAyMTExMTExNjUzMzQuNTY2WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBm5dcS
# mW6GaaibkOCoL79LpaWRcIO95Mo8V8rzwwiQCzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAYhFKwMs/PopTHvCeEDhbWINSxPo80ppS4wooXZGsKjBP4/ZH
# ohjSCRqM3R5GiuhTiSTsQahm+RWEd3mVu/7CUe+bgO2P/4wZwDSoxXwSd7+rkjSM
# ws1K/P38SdS8SePXFceW36DwNtM03o/rJBgjEPFCtleK2fs5cJA5k6JIh1KBo/Ir
# DNmJVdHCCeWcgYz8Iud1O46UM5ibcIX8hlUM4U6ER9Ymngn4n5KzFjxQbSu/VVjC
# nX3AK78388O/8luxn3dTWG8bKNwDT7qMvJ3+ntJlDvh9ALFbfWaIsFDgqYfvSiX8
# 0w/57IW8OQpsJXMNpFHzxOEqYDD8hCToajxzFA==
