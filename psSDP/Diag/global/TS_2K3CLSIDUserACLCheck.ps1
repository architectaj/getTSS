...
# Rule number:  4368
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=4368
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 4368

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_2K3CLSIDUserACLCheck"
$PublicContent = ""
$InternalContent = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=KB;EN-US;2176002"
$Verbosity = "Warning"
$Visibility = "3"
$SupportTopicsID = "17266"
$Title = $ScriptStrings.ID_2K3CLSIDUserACLCheck_ST
...
{
  return (CheckReg -Key "HKLM:\SYSTEM\CurrentControlSet\Control\ProductOptions" -Property "ProductType" -Value "LanmanNT")  #Call the function CheckReg.
}

Function AppliesToSystem
{
	return ($OSVersion.Major -eq 5) -and (-not (IsDomainController))  #Windows XP, Windows Server 2003 (non - Domain Controller)
}
...
Function CLSIDUserACLCheck()   #Check if the local Users group (S-1-5-32-545) has read permissions under HKCR\CLSID registry key
{
    $CLSIDPath="Registry::HKEY_CURRENT_USER\CLSID"
    if(Test-Path -Path $CLSIDPath)
	{
	    $SpecificUser = ([System.Security.Principal.SecurityIdentifier]"S-1-5-32-545").Translate([System.Security.Principal.NTAccount]).Value
        foreach($a in (Get-Acl -Path $CLSIDPath ).Access|Where-Object -FilterScript {$_.IdentityReference -eq $SpecificUser})
        {
            if([System.Security.AccessControl.RegistryRights]::QueryValues -band $a.RegistryRights.value__)   
	        {
	            return $false
	        }
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBD8GAVgOE9z6CM
# y7kVweFR+tdqE36ayr30T02uBmHiwaCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg2mi4V8CF
# HarfVd6QypximG1B2eJuKEapafoLo+NOdGwwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAGtnmZK00iaeW7BnJ6zOHazLNAWjk7uRlZpNVhTIYT2ROI6bK6ovx0Fy
# 7FoXiu2JVfuxOjw5YYoYs4pK0xM7+KTST8bCiz8Ocs1lJFCftpz7ylII+tNMFISj
# ghjosYI8kOotuFqdD0GsqumwC7s1pYfLbgg+5SiYxQQVqgctUh8PfvDIJ4gE+xsl
# O8dxPPifUzWUkTKD3eaqMStKu9gg1aXdY6F3nRsoQM5PjwCGWUWPOvPJgiJ0s0Ik
# ESUYt/NNz+mb9xTsdnjGi9f8wHlPJe/U4/ABMQk0HVa7SezejwYh2e/44PI9o/Hz
# Wt5KzyUDF5vhlyaVMeEMasMJLdb3uGShghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQg54bidC+Kdit+gPGdtcea9lKieOr/YUkYkHz6ThNUMToCBmGBv6X/
# TRgTMjAyMTExMTExNjUzMzkuNTc5WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBhAS0k
# DaW8IrLnZ6uPimx8awnN8ULkgiWbNA/hRGPkTDCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAK9k9/eF97vb9o/h/ib7szA6YEnmRA6Q4k2OqK/TpqyM6Qiwr
# U8dH1gFwb0dUqt2xe4v9qsz+exkGD2byNagqXyExZni2KGUVZvHPYUWuLJvZgHKP
# phbDMjeqZE37Vu7NAh03x7sIlkqJwNVg9jMM5NshOjez7Snusp42dwhvmNfqybQz
# EAt+tnQuF27QsGiOk9mKu+PQSniv1R2fAmbZ3qXVTInILrhFzi9ytn1dxwFtLgBv
# jjWV7upIIAQHYCRFTCHyZxKDFoILtC5k0IzD4RLJUAR7MtfRUoU6Atv36cs5YMPc
# bLSXRirXasd5eODeoZiuc6iKIiLGxL4eoQz8XQ==
