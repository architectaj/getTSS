#************************************************
# TS_UsbstorSystemPermissionsSPCheck.ps1
# Version 1.0.1
# Date: 5/17/2012
# Author: v-maam
# Description:  [Idea ID 3002] [Windows] SP1 installation on Windows 7 and Windows Server 2008 R2 fails with the error 0x800F0826
# Rule number:  3002
# Rule URL:  //sharepoint/sites/rules/Rule%20Submissions/Forms/DispForm.aspx?ID=3002
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 3002

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_UsbstorSystemPermissionsSPCheck"
$PublicContent = "http://support.microsoft.com/kb/2575088"
$Verbosity = "Warning"
$Visibility = "4"
...
$UsbStorInfPath = "$env:SystemRoot\Inf\usbstor.inf"
$UsbStorPnfPath = "$env:SystemRoot\Inf\usbstor.pnf"

Function isAffectedOSVersion
{
	if(($OSVersion.Build) -eq 7600)  #Win7/Server 2008 R2, SP0
	{
		return $true
	}
	else
...
Function checkFilePermissionForSystemAccount($File)
{

#		<#
#			.SYNOPSIS
#				Check the System Account's access right for a file is fullcontrol or not.
#			.DESCRIPTION
#				get the file's access right and query the system account's access right and compare it with fullcontrol.
#			.NOTES
#			.LINK
#			.EXAMPLE
#			.OUTPUTS
...
#		#>
	...
	if(Test-Path $File)
	{
		$SystemAccountSID = New-Object System.Security.Principal.SecurityIdentifier("S-1-5-18")
		$SystemAccountIdentityReference = $SystemAccountSID.Translate( [System.Security.Principal.NTAccount])
		
		$FileAccessRight = (Get-Acl $File | ForEach-Object { $_.Access } | Where-Object {$_.IdentityReference -eq $SystemAccountIdentityReference.Value}).FileSystemRights
		if($FileAccessRight -eq "FullControl")
		{
			return $true
		}
		else
...
if (isAffectedOSVersion)
{
	...
	#Detect root cause 
	if (-not(checkFilePermissionForSystemAccount($UsbStorInfPath)) -or -not(checkFilePermissionForSystemAccount($UsbStorPnfPath)))
	{
...
if ($RuleApplicable)
{
	if ($RootCauseDetected)
	{
		...
		Write-GenericMessage -RootCauseId $RootCauseName -PublicContentURL $PublicContent -InformationCollected $InformationCollected -Verbosity $Verbosity -Visibility $Visibility -SupportTopicsID $SupportTopicsID -SolutionTitle $ScriptStrings.ID_UsbstorSystemPermissionsSPCheck_SD
	}
	else
	{
		# Green Light
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBZKOs7Q519r/y/
# G7qxSD/tyvinNdD+iKkKtqLQr/zP+qCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICUQguB7kHXalkxiFmmbz1rT
# 9edLSlJYCebEwbDIgFtXMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA