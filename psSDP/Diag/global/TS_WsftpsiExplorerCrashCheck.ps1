#************************************************
# TS_WsftpsiExplorerCrashCheck.ps1
# Version 1.0.1
# Date: 6/15/2012
# Author: v-kaw
# Description:  [Idea ID 2056] [Windows] Consistent Explorer crash due to wsftpsi.dll
# Rule number:  2056
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=2056
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 2056

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_WsftpsiExplorerCrashCheck"
$PublicContent = ""
$InternalContent = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=B;EN-US;2651106"
$Verbosity = "Error"
$Visibility = "3"
$SupportTopicsID = "8026"
$Title = $ScriptStrings.ID_WsftpsiExplorerCrashCheck_ST
...
Function AppliesToSystem
{
 	if( (($OSVersion.Major -eq 6) -and  ($OSVersion.Minor -eq 0)) -or   #Windows Server 2008 
		(($OSVersion.Major -eq 6) -and  ($OSVersion.Minor -eq 1)) -or   #Windows 7,Windows Server 2008 R2
	    (($OSVersion.Major -eq 6) -and  ($OSVersion.Minor -eq 2)) )     #Windows 8
	{ 
	    $ProcessExplorer = Get-Process | Where-Object -FilterScript { $_.Name -eq 'explorer' }
		if($null -ne $ProcessExplorer)      #if explorer.exe is running.
	   	{
		    $Script:Wsftpsi = $ProcessExplorer.Modules|Where-Object -FilterScript {$_.ModuleName -eq "Wsftpsi.dll"} 
		    if($null -ne $Script:Wsftpsi)    #if explorer.exe has Wsftpsi.dll loaded in the memory
	        {
		   	    return $true
	        }
		}
...
{
    if(CheckWsftpsiVersion)
	{
        add-member -InputObject $InformationCollected -membertype noteproperty -name "Wsftpsi.dll path" -value $Script:Wsftpsi.FileName
	    add-member -InputObject $InformationCollected -membertype noteproperty -name "Wsftpsi.dll version" -value "12.3.0.1"
	    return $true
	}
	return $false
}
...
Function CheckWsftpsiVersion()    #Check if the binary version is 12.3.0.1
{
	if($Script:Wsftpsi.FileVersionInfo.ProductVersion -eq '12.3.0.1')
	{
	    return $true     
	}
	return $false     # with version other than 12.3.0.1
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDrL2R4e/ZbG8Zz
# WoKkrPkjZnQmHa82/xLHUP010WP+qaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINbxvzuaKK9aM5uXzC+YPNJJ
# O5fG9dktJsVNtuc6gTWQMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA