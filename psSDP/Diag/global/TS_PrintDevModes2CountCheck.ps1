#************************************************
# TS_PrintDevModes2CountCheck.ps1
# Version 1.0.1
# Date: 6/7/2012
# Author: v-kaw
# Description:  [Idea ID 1872] [Windows] Detecting bloated HKEY_USERS\.default\printers\Devmodes2 registry key on Terminal servers
# Rule number:  1872
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=1872
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 1872

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_PrintDevModes2CountCheck"
$PublicContent = "http://support.microsoft.com/kb/906952"
$InternalContent = ""
$Verbosity = "Warning"
$Visibility = "4"
$SupportTopicsID = "8130"
$Title = $ScriptStrings.ID_PrintDevModes2CountCheck_ST
...
{
	return (
	        (($OSVersion.Major -eq 5) -and ($OSVersion.Minor -eq 2)) -or  #Windows Sever 2003,
	        ($OSVersion.Major -eq 6) -or  #Windows Server 2008, Windows Server 2008 R2, Windows Server 2012
...
{
    $Count = GetSubKeyCountForDevModes2
    if( $Count -ge 50)
	{
	    Add-member -InputObject $InformationCollected -Membertype noteproperty -Name "Current number of DevModes2 subkeys" -Value $Count
	    return $true
	}
}
...
Function GetSubKeyCountForDevModes2()
{
    $Path = "Registry::HKEY_USERS\.DEFAULT\Printers\DevModes2"
    if(Test-Path -Path $Path)
    {
        return (Get-Item -Path $Path).SubKeyCount	
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDNuhjrMNFIRz4M
# SvQDVltrVATAUZGNVMrcJ1EqXht5M6CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg4EON9Bcf
# kvezF5P9mCfdj02bxTP9ZFwqayvsSVgWRJ0wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAIcp8PqT/b9IIaYG/p9askOt1km/alZyrkZeADxIYrl95cKx0wmsx30m
# WW/1umOpuVi67GP6t/5ijviX8DmwGPujp1HY2HI7t+yMeEHhrdvpOUOLynOzpV3U
# sMslFdYuhI3lmKXZRwXPn7H9BAUbdbA7I7hRquiG99O0YI+WB5ldOXrU2Hzci1fN
# beWeIwLdeIUJSmOutQbewul/n1nNeagTbh9dl648319taPAWwTQcT+r0PyE0OOBd
# rVsOxsREtMselbQuVXusHFNoV5bap6ZWZKOR1FQ85+k6OK+rH+KcvDP2qQ5O7dIE
# xqDuW3GoHWExWCqsGjfe4rM4lBhDvLuhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgx6B7BP69yb344l/85wZ4fQnAjsgqBRFRPH+ZjMDC0AACBmGB8A0Q
# XRgTMjAyMTExMTExNjUzMzguNjAzWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCB8sBCF
# NVaH71Q7+XGnu/Y6rr/54dPKOkxlO4y+VFRAJDCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEASuo8iBNg9uDWtba/LK8x0l/iBuF0bjB96IU2JX+nGdA4BP3r
# tum5tS5mjprIl+81Tvj2xwvqfOuumAxrKz+0zoq9W3UF3K+YoQKRWJZcOlUpGdo6
# 8Y6YF1QfKVprDB/l84R/O8MfI7NmF6PDz0jzocblowPb8mGUBF9BfdkmookKVwUk
# eTx+2HLj8ljYVnkUDgRVw4m6nR7AjZ36ZzZldv6UwEd9XNLO2FKN+jzOGZm34GmW
# Gco0/Xtt7AfPqrDTvSwopr2irVUIXsMFIASJ5AeG1QtjdVXdwq+VW0UoS3Ur2lQU
# +zGds8DPyTaU2LEpI1BtKcAb6y6H6RM92792eA==
