#************************************************
# TS_RedArrowRegistryCheck.ps1
# Version 1.0.1
# Date: 10/26/2012
# Author: v-maam
# Description:  [Idea ID 5452] [Windows] The “Red Arrow” issue in Component Services caused by registry keys corruption
# Rule number:  5452
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=5452
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 5452

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_RedArrowRegistryCheck"
...
#Check if $ChechingKeys registry keys are present, If any keys are missing, then issue found.
Function ChecRedArrowRegistryKeyIssue
{
	$ChechingKeys  = @(
	...
	foreach($key in $ChechingKeys)
	{
		...
		if((-not(Test-Path $Registrykey)))
		{
			...
			$MissingRegistryKeys += $key
		}
	}
	$InformationCollected | add-member -membertype noteproperty -name "Missing Registry Key" -value ([string]::Join(', ', $MissingRegistryKeys))
	return $HasIssue
}
...
if (AppliesToSystem)
{
	...
	if (ChecRedArrowRegistryKeyIssue)
	{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCWRrXUQ741Zy2u
# 2AEPvn6JMakNxUufcAwlVXPRc2aIgKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgcWiAVTVr
# Zpb7AFPcPrXmcb1HItVOxyOtYhYOHFl7cH0wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAIOlCi3Ylb27FvF4Gkeir9ang29aO1VEmq+zXnGkrAkgRMs51q4GrZtH
# BCNRNUYefZIRoPG98UfrA6k0jtihLd3pQarjXGonqOAi5kcyiF0t6AVZ/v/0Ve3P
# Hf4Zzk9y+gsHRyrhb1dplD+fFB5dKHVZOq4zFFDnfYBD2Y84wQN1WpFvKFsLAl2q
# /DZDPsMhfIi5F7qIe7FwjYddtGlgnuZoIVCyZO1vukpqviYy0bY/s6KdWAqW7sVt
# SuWvN5IosgGVxmJDFLpLMMQ8Zmovos8iCWWrCFggsizf4PShQ1uPiJgXUNE9yCEY
# tljD2LjNc/liczF2IUFMkW2JjpVzKSOhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgDAuWmnGnjLsfpe+ezqRM18VD2Z+zwYcWl/1xo4u/X34CBmGB2SqX
# BRgTMjAyMTExMTExNjUzMzQuMDA0WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCARphz9
# JYIpCMqjzEQOU6Fvjf5ss9HR3TtdNj4VvawOGTCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAcqCnbUPRgEWzsDrXY5lZ6pvyGuOTSNMy2CjCMXBhHo22jHZp
# tT9VYU7y1zsSSflbcR04K0tpIJSb9QzauzM9O3DdBNYKMIeZNq8U0VP5pp+rkQlZ
# RE3MFSyejlC4deqHwfGEjEtAZzXbVmi322MAVOvVSLnfHTAmPt6KqPLVCxli7rXk
# +US4uZrYAWGu2IydYj7Y9+wufSFb1bq1i4UIjok7NOtFMvEPSRHumbFnB2fWMZNn
# Hu4954hkSQnPmtwni39L22pFYX5TBUSFKMgwSz3+RiuGoRnjMm9nyZx9E9FitrpB
# OIjDzLV11miRq/CoXTx17/4LVyVThfIAzvBHnw==
