...
# Description:  This script queries for details on all
...
#Define output file.
$FileDescription = "Text File containing details about the local Active Directory forest."
$SectionDescription = "Active Directory Forest Information (TXT)"
$ExportFile = Join-Path $Pwd.Path ($ComputerName + "_ForestInfo.txt")
$global:FormatEnumerationLimit = -1

$ForestInfo = [System.DirectoryServices.ActiveDirectory.Forest]::GetCurrentForest()
$Domains = $ForestInfo.get_Domains()
"List of Domains in Forest $ForestInfo" | Out-File $ExportFile -Append
"***************************************" | Out-File $ExportFile -Append
"***************************************" | Out-File $ExportFile -Append
"`n `r" | Out-File $ExportFile -Append

foreach ($Domain in $Domains)
	{
	#Display info on every domain in the forest.
	...
	Add-Member -InputObject $DomainObject -MemberType NoteProperty -Name 'DomainMode' -Value $Domain.DomainMode
	...
	"Domain Details for $Domain" | Out-File $ExportFile -Append
	"*******************" | Out-File $ExportFile -Append
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDTnVvNBERdsIgP
# YbfVhgvokfrlKx6WFFItUINA2lAMr6CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgymelGQPE
# O2hSyHnmun+tc7zE3J3osmsN7hQQYcgzOckwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAARooMgd3nb1m21NvPUdVIat41FhG1IiED/YSTp8Q/CXUATnmZaduR57
# ErWdQsW/utjE/h2Zbbv7en+HVD4QfOb1A+1nNG4cOwKQYpqjg7m2chWD9S2GMdVs
# JEj3iqmL9OQ/yaxqlJCcYe+QCukOqkxDI5mLffNL1T0d8UOQpizBv0tUBo5QgYP9
# fkkjxAhTmVX9K1vGwoWNDN/T8DWNEy1dBEifRBcTJyHbuToV6qAKUA8nh9DHBP8U
# UVBItZbsMy/rAkxbWWM/HB9Uv7zUtXL/iuEkLJo7N7PqUefsMu9f2a4f+L52bYsM
# QWRsvhZCSrDzqlufsIPFnthLpVs3u7yhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgUhr1pDTvUxEj3fZpkk4h9LEIVu+nBR7dHIaJRNCKqVMCBmGB81FC
# hxgTMjAyMTExMTExNjUzMzUuMDEzWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCA8G6Yr
# Xnv0hd9RPVhe/3FAPsKLmyKBk6T58KuIRGDDXzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAJu+YRNuuMTL1fzcrB1ufzvP9Jmr1X5miQjmrGtDFGrOCyrEa
# PoqddIENKb4sGP635XjEJeIJPury6qfDv7x4zCceh8yt0s0IZQVofBgdCTh8jRUs
# hQis2JWytCKokVX08biwZ14NTsKS9jXNEOtRsts7pWdMjf95coYIS9RuJAYs2ZyO
# wtz9cF4DHyr/evKq98mNb13V55mITKvfxCUmDG5F4sQ8Oy3gQaJaaQ9sA9Ho1Y9n
# /6JLlcqMJDfGBYL2CuTmiJTQMzCAZ+39VaKQ/zsugo3ppZeQs8xIc3HlDw2q7QPC
# 9W5x5HR/dklPO/nvfSOBD4aT7mplz6neJElnmw==
