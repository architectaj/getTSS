...
if($debug -eq $true){[void]$shell.popup("Running DC_Ex2003_ExchDump.ps1")}

Import-LocalizedData -BindingVariable ExchDumpStrings

Write-DiagProgress -Activity $ExchDumpStrings.ID_Ex2003_ExchDumpAct -Status $ExchDumpStrings.ID_Ex2003_ExchDumpStat

$OutputFile = join-path $pwd.path ("ExchDump_*_*.*")
$CommandLineToExecute = ($Env:windir + "\system32\cscript.exe ExchDump.VBS")

if($debug -eq $true){[void]$shell.popup("Command line: $CommandLineToExecute")}

RunCmD -commandToRun $CommandLineToExecute -sectionDescription $ExchDumpStrings.ID_Ex2003_ExchDumpReportSection -filesToCollect $OutputFile -fileDescription $ExchDumpStrings.ID_Ex2003_ExchDumpFileDescription -RenameOutput $true -BackgroundExecution -useSystemDiagnosticsObject

Trap{WriteTo-StdOut "$($_.InvocationInfo.ScriptName)($($_.InvocationInfo.ScriptLineNumber)): $_" -shortformat;Continue}

if($debug -eq $true){[void]$shell.popup("Ran DC_Ex2003_ExchDump.ps1")}

# SIG # Begin signature block
# MIIjlQYJKoZIhvcNAQcCoIIjhjCCI4ICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBMEpkNuYJlLpbz
# 7dfESBlVVQ+HZgItMu+c6Gde6k02paCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg+SLn9cZ3
# oF0ZhlwsXxm2JYqe0b42isTOPb9n7YR2VvowOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBADkRY7s+bvRnJnLp6Ff7MT9cIfA6e+gsFju3yocCBkC/SioW6gZB/068
# FqD6/N8LWEzY92aBLlPjyo6bZlCnj4//K3F8bOf2dysez+5kwt8hMfkZeMn/FPcl
# Jk0kQyuikTJWgUnetJt9Ks3VX6Oz+QVDeGBnUx12DBAWnkE/mrWa0LORzSbxJPKN
# /HmsI9wKv4TjjwN/k+vrUL00wR+IUiT8R9fEHMyFETHymfJfwT1SqkV1F4QJLWLU
# H2P0mrEpsSj5tyIp1uYuBi0FRmeR0GMgNqPWzzPiiNxCeXDHdUbC+ldRChtA/UDD
# bwsvaOVXq2xwq/TcVETEeJriGyjCEHOhghL+MIIS+gYKKwYBBAGCNwMDATGCEuow
...
# ZQMEAgEFAAQgEBFhGYezXXw3iU8g+if47S9ObJaaLqKjKgN4+SsRklsCBmGDCPNZ
# 6BgTMjAyMTExMTExNjUzMzguMzI5WjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMC
...
# 9w0BCQQxIgQgzeE6zH1Ul3oxley1UG9YwV6S03ESjHjRN9br4kpHLRUwgfoGCyqG
...
# WRAMxNnzMA0GCSqGSIb3DQEBCwUABIIBAFRCzzCR4lsnxR1E7pUVeQgiuJpnf+Eu
# BFF9QJrNkBV+z74M75UuSEumioyAKdvDddLMGp6Onx/i4EptoVHkB0vbs5mDYko4
# SJyRaneiofGED8T4Ph5qoHu/QBI4VpOtgHOb+T8xJ2WWymDDYEUhpXzKWomClUUS
# PbTDufFZF6z8Z6BoL741JJoPFiX5ZXSpI7VY4BDFf0AggsIaicRZcHMFasGkHKqm
# NkkSq6b6TjVOqXS7zTZ5ZXgLWAhUpVj4v36frDLggB6WNsQ8YT4pfVeKRvdrKtug
# 2YvIgSKVKrIOIQN/NZOT/+kH3/apjN9twM36mdRwbG66hOSd51fYAy8=
