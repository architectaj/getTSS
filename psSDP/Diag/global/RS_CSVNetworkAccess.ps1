...
$SharedVolumesNetworkAccess_Summary = new-object PSObject

$CSVMsgs += "<br/> Please open the file " + $ComputerName + "_CSVInfo.HTM for more information."

foreach ($CSVMsgs in $CSVMsgs) {
	$msg = "Network CSV Access"
	add-member -inputobject $SharedVolumesNetworkAccess_Summary -membertype noteproperty -name $msg -value $CSVMsgs
}

$SharedVolumesNetworkAccess_Summary | ConvertTo-Xml2 | update-diagreport -ID 00_CSVNetworkAccess -name "CSV Network Access" -verbosity "Warning"
# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAkES4GF8gPN9CO
# AEjnfrtxoEAPLGNLsFRS2RdkV5BqeKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg1I4ZMVJ3
# H2OtbnPf0kot2MtCImQLmu27jHDvXCJgrGkwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAHwdVY38wqvBCPuQR5pU4W8xD66RjSL2uRVpSRvmsE/GP968MPSezurU
# SAUOuyhArdXIQJT+QcWNVDf7lGFmzJ1Mg3JgF0H33w4ukac5J+d6bPsdRvN8SCCd
# HIdoDG+UdrGMSci0udbU9rC3VZ6U/MvhEG0EAIE1ET2rOFKV01zBLDpDm+/9ttIH
# Eb3LU9wF1QgB1r23Y5fOOYBhTw05gmBLRpeumOE/Cj175EBessQJCNuBGW91eJnM
# lmHuwza8XujC9hkOtRjkCCr1M0J2HMFU6F7kwBr/CTpydp7/kfwXmjXmWo4mnSxl
# TKK2d4qYG09pOe9U7wTTHmzwu/mA8hShghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgK+JnmaHczsCS1IlLf10PddnpfCunDsBVv9zObR+AtBcCBmGCBVHy
# ixgTMjAyMTExMTExNjUzMzIuNDI2WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCHCpKk
# J0kEetRY1JHWLxXacfTeS5oHo3haeWrPwFqJ8zCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAtxe7qXizsE+pFbaCHrM5bykVpxsFDxAJjhZeA0uIMGAmf3LO
# l/mGWPCB3sYkZWHGrnI2Xkern3YOY8O0DfxQF7zfJX2jnWZJgl/i0MeAULtKyS6F
# t/y8gienpAgdVSemisjH6+fMXsdwc0w+L/FLXLzzGE1JPR+dpi2gWwpAvTRvfhCA
# 1AyfnHUJsA7qKHBr8yOuKfsRUVJRqi0Lcoye/f1pGn5p1UHonRvcNBhoPKlLqHGZ
# GIBc2WvAhzhza7IA0gK6P/W8RFZAbndhtx/TnrwW+dSZKp+UVCD9VlsJAJxsWzOP
# nL+tGsL6ChGz3sKcvnmjLa0Tgd5XU8XBMdVsrA==
