...
{
	if((($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 1)) -or #Win7/R2
	   (($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 2))) #Win8
	{
		return $true
	}
	else
...
Function isIssueFileVersion
{
	if(Test-Path $filePath)
	{
		...
		if(($fileVersionInfo.FileMajorPart -eq 6) -and
			($fileVersionInfo.FileMinorPart -eq 0) -and
			($fileVersionInfo.FileBuildPart -eq 2) -and
			($fileVersionInfo.FilePrivatePart -eq 12006))
		{
			return $true
		}
		else
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBASOwSGp2hF6Zx
# fo/X+DLZLJFntXTT7THDf42t2jylXaCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg+IFztmN9
# Lfag+biNqbd5sdGiz5eZN+7zQHONUx0VPBwwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBACXv4X4J93oiJCG7Y3kuZ2HG8Pd3bLirQdcAnvMuwdp+M6Wc0PhnpRds
# u7a8dHfFsoiovd5a+/ePkqyB8sxZl7Hngs6eU06HZR3DyDOZZcHfnvj3b3R7YuTG
# C9dKjQRHJkERs9k2WUOIb0b+dZi+b6FpmE43yYp1RpFsiX/MTsXDbzFS32sYnaxF
# 5It84hjL+ywS1fLNFFy02vglYeMXJPCj5r/48iImtVs9bSG2P7tHQGu+V9dvEANj
# bx6HDXfmYxQj7udx7xn7dH/66BhTPYYjD/uk3rAvBXIorEA0avhCe18x5E7ix97p
# 61jZc4lsw83qXHNSwcm4VDgD8Cw/Jc+hghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgnVrpSbqgfQWWL9aw+uzXHvY/7u5y4JYEHXVCA4XIycoCBmGB56/O
# eBgTMjAyMTExMTExNjUzMzMuOTk4WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCB+rOu8
# PJnw0P+k/Fx9Gv3GxlQcoAaFxZL/VQs4PxkhzjCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAWMHrrMyZEKspQNq1Ci2KxSDFDf6iEJEyEhkeimPUGP9eTa6Q
# +6NMYEty4MjNihLLFGaDLKtlymuxqTjTmkPzC1RH438mRJ9oh/k6xCxxoQ+oNCxN
# zwdJPE4JzZCrt385T1EMPiO5dqEDDCeY/98S89rnXYD4H4lgegZjZKHPgBKrkjIt
# eHQXNAQOg5MfXv4FqjFje/81Z86CYHzlB1yNrNJ4CT+AquMlNsvIgl1UeLcjZqT6
# hX7DctHvJlZCsF1S5PcPtJX6jWIMPFqm8ErvFMALd0OGt2LvnBUvpCL59qiLlVCT
# BsTTaOLVxUxKcZofJk7oM5I5uhIe+i8XssZCZw==
