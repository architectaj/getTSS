...
# Description: Collects information about the Network Store Interface (NSI) Component.
...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSNetworkStoreInterface -Status $ScriptVariable.ID_CTSNetworkStoreInterfaceDescription
...
{
	#----------Registry
	$OutputFile= $Computername + "_NetworkStoreInterface_reg_.TXT"
	$sectionDescription = "Network Store Interface"
	$CurrentVersionKeys =	"HKLM\SYSTEM\CurrentControlSet\services\nsi",
							"HKLM\SYSTEM\CurrentControlSet\services\nsiproxy"
	RegQuery -Registrykeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "Network Store Interface Service Registry Keys" -SectionDescription $sectionDescription
}

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCPyl6em6lC74Kq
# fv4KVRcUA1B0g+7JQcPOIshjQWvM9aCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgkzsXz6oX
# AcFgl8kMg2dQkLlQFT1ams67Pt+mE15YWTMwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAKKhOSlu8MBia3hfd2oQLHYe56kWM+nkjruzB+bgBBMmQ/Th10PTpoP7
# 5Km+Bc2ZJxuSTA1SNUJ418S4QsDplrvDN8IqnuMp/4wQNiO01FzEXtS+0T7Pin/n
# S3njTfd9MAiBI6x1u2XVM9u4H2pCXbPyLGyd2Nd66yKvNDjv19jUaX2B0S2xX6V/
# A+phXVKioBBu7lvlLwmBc41I1XvlFgPgLr+XotgbK/kIZn2/DY0R/EAGZzCleIdk
# CkM/YizH+HP9+rVjxhtpwfD3yhR56A5zHyYmFmTFPLVDqqJhcEObOiuuq8IFo2T8
# cZqMIjQ/SUuHMB63XJawaqq5AypkiOihghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgnXccI4uQkpU9x9zmni4OtmdM77AYPSm9DWjFkQfTDm4CBmGBv6X/
# GRgTMjAyMTExMTExNjUzMzYuMTgxWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDAIsf1
# SZBQoyFPLXmRtUZ0+kyNzMdgdKFIpT9dXJuv6TCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAx1OOXgreHhUsgEzyeCmg4yThJiFJC3aDsty5H+n5mBc2xUg3
# cWs94G8+HnGl+rPhwDgPdekXV7xbQ2Dmq1qbddpmyPsfY1hioVxwvB6UVSK9KrAf
# R3373egl9GbNdkvNhOsgHaV+EZwEyKY8L8uugLKqzJ5aP83j0Hf1bsz9kHsQgN6R
# BVptUmDJ1Wpvh9a/np2lq/2s2LEKKAjogkr09X3DRPIfEbAoeENfDbI/wKWptYcF
# aLlH7BUJAEMZYdw/zF2nIfnJ3XgdQS40lgFWEIFhFaLJku7srqSx02P1mxQEOPpK
# RNYzKIfq4rggAa+yn+dxpDrCrxLqqoHv38k57Q==
