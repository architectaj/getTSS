...
Write-DiagProgress -Activity $ScriptStrings.ID_PrintingHPTCPMonCheck -Status $ScriptStrings.ID_PrintingHPTCPMonCheckDesc

$RootCauseDetected = $false
$RootCauseName = "RC_PrintingHPTCPMonCheck"



#Rule ID 1939
#-----------
# http://sharepoint/sites/rules/Rule%20Submissions/Windows_digvijan_2011-11-17T10_03_25.xml
#
#Description
#-----------
...
#********************
	...
	Function Get-PortDriver
	{	
		if(Test-Path "HKLM:\System\CurrentControlSet\Control\Print\Monitors\HP Standard TCP/IP Port")
		{
			return $true
		}
		else
...
#********************
	...
	if($HasIssue)
	{
		...
		Write-GenericMessage -RootCauseId $RootCauseName -PublicContentURL "http://support.microsoft.com/kb/947477" -Verbosity "Warning" -Visibility 4 -SupportTopicsID 8066 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCrbScvW7dXiKar
# v/wagmsTwCnwMHpwwoe8TNgI2l0786CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgtrGkmNu2
# D4KWlO6x3TLNaeWgcObHwBUqDkh6izykXzQwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAHBhU9iWjZJR1lDlHga1GgG2oq7S3NDvlN+U5bakEWcM7sWyNIoY8/sE
# a5hB2JDmtXX9IzNWatiXGf4wfTW2eA1km2VVNY1dMwFkH3eaO0T1LCpYlKtOEQjI
# Jmwj4nKavVogiVY3SLtshA/WEpEBjNl1Xz4xvrFSLs+ci7KhyHujX1Cgv9RIpWUW
# tGp/lNq2qu4R1J5nzeh+f5WSz9JemQGT19XgrHGBAYeRfjXZCyVm7Mjf+5sLEfit
# yVtSHJSNUyYuTkEcgdfc5VllY3SnPPi/oxOVJU+Lkk/zPNVvC4Qxb2pAw/d5QXdR
# vtkAIIcEtOgb6Fzbh4rIrg0SkGXa1KahghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgj/w8vkFBZtEze0Txe5SdFsaFVjXF3OnRACEDxcEe4VICBmGCAKQy
# 5BgTMjAyMTExMTExNjUzMzQuMDE4WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDl95rV
# 9YpQ1MbicjqmqypwhUfyx+btnBpX+vw8Lal1KDCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEARxxtAECKbMcDnHn4S5/zlNsIiH1i0LLRmb5YPwPusGl3MJLe
# S0m9EoYLjwjptM99L2TdUZw5dj3/ayS6lbThhE/HDCgRhVgwN9UqTTfFCtUXZMqQ
# Bhw7lzMBgAA9hd0AIlJ+/eAuyxsHjJYoaDsRxnG4t43chaWdbFrgzShY1flKR/Zk
# lEWkTXHJxuICOHKTTi5ORAt2+fxfk4feHfoRVPcN9XEWw8gAXVNqawhOaVZN8/pX
# cjhewMOCYvEsMWWtFRHCH9tsS8fZFJ/CaprWc7gGM+1g5cD1Nw+7STtFzW1qG+Lk
# gJX1rNSIRlomty0UUcah7PDhnqc0b4CJeCHm+A==
