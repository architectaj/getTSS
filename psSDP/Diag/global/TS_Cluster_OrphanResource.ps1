...
Function FindMissingResources()
{
    ...
    $ResourceGUIDs=@()
    $Resources | ForEach-Object {$ResourceGUIDs+=$_.PSChildName}
    #
    ...
    $CluGroups | ForEach-Object{
        $once = $true
        $Name = $_.Name
        $PSChildName = $_.PSChildName
        $_.Contains | ForEach-Object{
...
Function FindMissingCryptoResource()
{
    ...
    $index = 0  
    $CryptoGUIDs | ForEach-Object{
	    $CryptoResource = $CryptoGUIDs[$index]
	    $foundmatch = $false
	    $ResourceGUIDs | ForEach-Object{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAoF2PRPsxSnU/D
# EMYF1eY+H+w2s90dM5gEskp3MwQ2N6CCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILDKsbdXzcBeZG+hntbyTtAq
# G7xXggC2is4BrfsBhx5GMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQAcWcDwjiME8KuML8cx2F0CHIs6lw+a/oaN3MecZNS0OFO5ES0ERfs7
# KVoA7vDhTmPZlu9lAL5iDns/VApZX7QvHvIdSChicF7yKhX646QX4tkSOp9xpRiE
# HSrJgHS359vsrTY7oMNuZ1LLvD2aG81rbEr7D+sFIGio7eB4oTLC6EKZ6I4KEvWX
# 9bSOUEFKTC/+PuERB8f1aQbSh8jVn/BjosO3RuGtPYGxJQ1zaNYiw+xuzgwt8bJv
# Y0RrK7waEi5idCJm3a+3v4xUn/5bxz8tnbmbEr+YkILxo+lo0ulBxvdX8+YVCEIR
# i+UGXy+T9wXMBXVgF+UgJTgtL0J8njgjoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEICDpse/yYasEtbSrIQez4SIfYYtDZyV21hk2o+Yqs5c1AgZi3mQf
# LZ8YEzIwMjIwODAxMDgwMDI0LjI4NVowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEINPOh/0ZyksV/MO1LdeR
# W5rO/ZHiX0RHv653xJricd3WMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgBC/fDfSJJ5XdewcLDnR0pr0+mYAxeggpAnD8QhE9Eu6bIkxCokFEKbEauV7zBY
# UktwO8HtzgCN2BmhHc3dWhYpnxYkIIp27yra7BoIJ6kGNdDjvEc4LpcLH9+jhybY
# Z2EmZD6e4FqMCjnrOmY8UVpp5OigPkmKup1YLv0ZeEBl8HZIYobbXhKzBzbt4ICD
# JhMT6iQU37s7A9gjDF3BP6L67hFZ5lDvdv1v+E6VpJooHWJbNykWSpBeSMN1jnie
# TzyBSf5vtSxX9595QKgAd2BVzeStbAenlCL/5SOtg4ttNqWQ5KDmi3xggctlDgLY
# WNZ3pYfvVjCf4GBi6gqVvuBeVakhyrJ5MO0FmvLFkLAeS6cGHWTTdXHVEil4tyZX
# 1iCiHlc5tlQ9waK1aGYabmQdxpMZViubf/haPmgAQq1zSNHFhcaHu7dDh5WYPx/K
# YWsoIby/98ARKsxFpcbdH5PKuZFvnlywUhkeYoTIEjprptCT+rYP23Q+5lOwoOPy
# AH2nJIjLQdtqjMqCrV9LPPQraA/9qvVyZl4T6mSkAlC8L6vkqCZGmXU+hbsuQAvP
# wHC57I5bDdB85N5b25cuKSZXCMNsmIqrKupGdQKRuyWdvuF5t71zJfuAFSfCCrLE
# x1lAeGZjQACHuY57gt6Oe24CwMBlNot/2ZUQNL84u/M/2g==
