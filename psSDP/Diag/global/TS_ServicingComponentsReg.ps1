#************************************************
# TS_ServicingComponentsReg.ps1
# Version 1.0.1
# Date: 6/5/2012
# Author: v-kaw
# Description:  [Idea ID 3474] [Windows] Pending Trans Rule - PendingXmlIdentifier, NextQueueEntryIndex, AdvancedInstallersNeedResolving
# Rule number:  3474
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=3474
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 3474

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_ServicingComponentsReg"
$PublicContent = "http://support.microsoft.com/kb/2509997"
$InternalContent = ""
$Verbosity = "Warning"
$Visibility = "4"
$SupportTopicsID = "8110"
$Title = $ScriptStrings.ID_ServicingComponentsReg_ST
...
{
	return ($OSVersion.Major -ge 6) # Windows 7 Client, Server 2008, Windows Vista, Windows Server 2008 R2
}

Function CollectedData
{
    $FirstKeyDetected = CheckRegComponents
    if( $null -ne $FirstKeyDetected)
	{
		Add-member -InputObject $InformationCollected -Membertype noteproperty -Name "Registy Value" -Value $FirstKeyDetected
	    return $true
	}
}
...
function CheckRegComponents()    #Check none of the specific keys exists
{
    $Path="HKLM:\COMPONENTS" 
	$Properties= ("PendingXmlIdentifier","NextQueueEntryIndex","AdvancedInstallersNeedResolving")
	if(Test-Path -Path $Path)
    {
        foreach($Property in $Properties)
        {
            if($null -ne (Get-ItemProperty -Path $Path).$Property)
            {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDBhN+TcP+V5r3p
# 0BQQHUPM/CH3dYGcVObsllhY6iuRGqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMLh2HeGOIgjiCbpeXqruUmJ
# 5A6SPhYmIFrsom9VV6FnMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQB4zQC/5TLelJWYt2/TT3R5ErWIRi96Qeh4SkmI3cbxp4gmqEjnHgC/
# Wri5X6/WGI6h3EFGM8GnmvwNt3DX0AwTRYe7Lu2CshRUHydGmhDbFVCaqlxj7VUP
# xzbB7EnWQayMLeFbkqKBLyk++AW1hKofUrdVHDVWFKKFrlh005KznY3h7UIkdDix
# G5W72lVzoIDn968Ot33l5AvJnDpfagYbnKKrX7kFIt2m8OBhQ2xdTSYDGhzpdXuc
# mIwUjM5j10oSutWTqVUWadnQxG0Dd72xpAnwo+HUr9njrbKjKqI+xLluZcFdQ+EB
# QpJLUvH3ZDD1ZH9+QB+S4sXJ0CSWYh1+oYIXDDCCFwgGCisGAQQBgjcDAwExghb4
...
# AWUDBAIBBQAEIGZX5yFX3kUDuP+vKl7UaF9YoqLDAo6FwKiGJEcITSyHAgZi2wZs
# j6kYEzIwMjIwODAxMDgwNjAyLjc1MVowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQge0OLr+V2lWWOMZSqSXtzmVOVaLP5Ml3M
# qmMPMjaeVocwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCDNBgtDd8uf9KTj
...
# lOK94kvWvU2F8vPBc3hLhZ9yD3zCMA0GCSqGSIb3DQEBCwUABIICABNtdODfKHyt
# rclQRoM3rl71UHuOHdou4GOg+hp4vfiMMJDMjihTNTcqpUDTA6Cl6Mc6AbjQI8to
# uIzJ5OjoJpbUrrJ4HrTzEpmRCAzBgDcnHOmqVHoNbArukv6BhXOQ5BMchkgiPYJL
# Vs/JGsJUumtlNprlz5m59XuupOSGIJk13rDkWZfTRC3aDoAEK45wMU7ctNQokKPd
# oiThQWdw+myUCozihvH8c7U9wYbkHftMMKoflE+55Ga2TxPXzuhFZW4mk8BktnT2
# Rg745oMAFm8o+HaXl0Idp8BD+aNV5abfvDI80UXV/f6PBfThbSxFNy4jkxRdmIFm
# rN1S6mAHw2kYkUAWcvJvEB1GgkvZGaqxE9b1r/dR8HxjxML/sCNhFLlWVn5RSljg
# sioS44gokZVYWN67Pe9AIlhwqPk5Ox7Lp/Y11iAf8l+egMQgHRHe9jiinQZ+Tn/y
# tDPKQf8cqMJZSbrbNS53aUg0HTSoK/PUoygvlRCqkRRBE8oz13nOJIakDJPkbbgB
# WtVYdkUW7SIVpq96adlBV/3oYTRjOaJV5GGW6ix0WZHddL4W7ckOugHcezkZpkgO
# HV/bVir5IjUkkGg4vawC242Rzah3+2p9ZOUHcCWPruOlK6q5iBJKnXZYgm+sHh4o
# oXr8VXQ2F7d2HxW1dpPIJtaevfabk9Rx
