...
#************************************************
# DC_AppliedSecTempl.ps1
# Version 2.0
# Date: 11-17-2011
# Author: clandis, Andret
# Description: Gathers security templates currently cached on the system
#************************************************

Import-LocalizedData -BindingVariable AppliedSecTemplStrings -FileName DC_AppliedSecTempl -UICulture en-us
	
Write-DiagProgress -Activity $AppliedSecTemplStrings.ID_AppliedSecTemplOutput -Status $AppliedSecTemplStrings.ID_AppliedSecTemplObtaining

$OutputFile = $ComputerName + "_AppliedSecTempl.txt"
$fileDescription = "Applied Security Templates"
$sectionDescription = "Applied Security Templates"

$PoliciesFolderName = Join-Path $Env:windir "Security\Templates\Policies"

if (test-path $PoliciesFolderName)
{
	$PoliciesFolderName | Get-ChildItem | ForEach-Object -Process{
		("=" * ($_.FullName.Length)) | Out-File $OutputFile -Append
		$_.FullName | Out-File $OutputFile -Append
		("=" * ($_.FullName.Length)) | Out-File $OutputFile -Append
		$_ | Get-Content | Out-File $OutputFile -Append
		"" | Out-File $OutputFile -Append
	}

	Collectfiles -fileDescription $fileDescription -sectionDescription $sectionDescription -filesToCollect $OutputFile
}
else
{
	"Warning: $PoliciesFolderName does not exist" | writeto-stdout
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB651RIxRYxVxvT
# VYBnaxat66aZ0iyNz1GSIoV9fbI9LaCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgWNHIXcov
# ii3CGWk0IU56wSbYB+Hv+rUyef51TtHmZeYwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBADOmYyUejh40LA9zFO5wWAR9UJc4vTk9Vc2QyynO8JeGefH36kgcjERW
# fi2DTyf5qJLWE53ZbIg6Zog4gyHOifzlLF2H6tZtkfcNTusjZh3TbKdVLA/UOMtA
# /+CiYnEeGeZnB7ewc7LFGRuaS1/4el1KfDWxWJxLp9Z2rseeAQ8bwM+QE8cwuI/S
# zWpgQgfU4CnJMN85CuXYdDO1Nz5chtMcdsx32MEEmtgO3FISxAO7H8Tfzlxg3vPV
# MRZMJoGOb2viM2WHvKtGFuqhU31OYSk1sM9/In4pQw/fQ2uJQicfmzzt+TIMl+dz
# nnRSU8QMaadR8DcVVZ9IpxjlbWu8d/GhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQg/nT3Pj7L8C61yO33FCfITYaFoVGdslKmQ2G37DEdT3wCBmGCAKQz
# KRgTMjAyMTExMTExNjUzMzYuMjcxWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBZqzOD
# qxUVhlqFNfzWOvSGhWz4CTculk3sCJssf1W4FDCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEABBnQ9EJO7XY8rmKNgvslxBRbqX8//XPcRgNHj+m0QiX014qm
# zQm1w2bhTwfISn6ipJlR4MiOUsP3d+b6WKSw9qYpMtmDPHmWkEC5TOmbUjhdhKhT
# 0o31BjQRdVxQEJq3HMrvV1GOlLODzwVsSD64OubcD9hVvvl/N3hDHdN3TLlruBar
# pWQ7OMY8xTwn2x0ugDHYFxtBy9SDHIp8smXPtn1/fCn5UJcIr2pk//ozLn/+NIwq
# +OUbapQJgwxPxz9pHNg8xxN9WDKb3Q3z52jV2Ry+1GyzbQw30LZS04qi2xjcnT+M
# fiST1t//iwqUa9tbpky0W/3gEhtmlByXaYupQw==
