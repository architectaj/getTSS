...
#               If it is large (more than 500), generate an alert
# References:   http://support.microsoft.com/default.aspx?scid=kb;EN-US;982210
#************************************************

Import-LocalizedData -BindingVariable HyperVCheck
Write-DiagProgress -Activity $HyperVCheck.ID_HyperVRegCheck -Status $HyperVCheck.ID_HyperVRegCheckDesc
...
{
	$VDiskKey = "HKLM:\SYSTEM\CurrentControlSet\Enum\SCSI\Disk&Ven_Msft&Prod_Virtual_Disk"
	if (Test-Path ($VDiskKey))
	{
		$SubkeyCount = (Get-Item $VDiskKey).get_SubKeyCount()
		if ($SubkeyCount -ge 500)
		{
...
$RootCauseName = "RC_HyperVSCSIDiskEnum"
...
{
	$InformationCollected = @{"Registry Key"="HKLM\SYSTEM\CurrentControlSet\Enum\SCSI\Disk&amp;Ven_Msft&amp;Prod_Virtual_Disk"}
	$InformationCollected += @{"Number of subkeys"=$SubkeyCount.ToString()}
	
	Update-DiagRootCause -id $RootCauseName -Detected $true
	Write-GenericMessage -RootCauseId $RootCauseName -PublicContentURL "http://support.microsoft.com/kb/982210" -Verbosity "Error" -InternalContentURL "http://bugcheck/bugs/WindowsSE/318935.asp" -InformationCollected $InformationCollected
	
}
# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBWsqxH4AOAt8pm
# V7wltsBHwQtq3e7hkg403CKbX1dDdaCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgWKKWLAzf
# mj3CwRT2U9eMHBb6xXJt0jFzMwo9FCvcI8QwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAGlZhwRzkV02YX6CEnuA1cK7y/sGBv/INhNHX9z0LL6lCdCB+cRo0vhQ
# dzIkeV+Po3yjlkNZmymLo1g3ts3paDz99Bom3c/D71qULHP2l8pjU0MssPWZfrFx
# 2EHGqfwfER9jMIeCpFSyibkMERwYJ1arnMEAy/kStNosgC7azyVZELGt390TIxWW
# 356scE6aJCd5xO/9u/jwEoLEuqhaVqmO0FqEbs5F1s+OoVIZw7ZRbCFGyNdG9HjI
# DdlqR4+OlFKI16vbldlXlaz6+Ecge/A6raO6D19kz6yCBM2i0IL9RGhw0E2WX5MT
# Cd7MHKzDtMtO4E4g2il/Ar6lZmBoS7WhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQggcmOBhkRyP9Oy+Z8Mm2ubU/IE9hHTYFwgEZ45Smon60CBmGB8A0Q
# DhgTMjAyMTExMTExNjUzMzIuNTE1WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAMrGa/
# wQUQgvnp8lMl5db08c+MS1SVSu6I4OP4LBSVTTCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAS3yaXmKUs4JYycxQDfkLxcjjoZf2acdJSgV3AIb/1/urPuXi
# JRtusuwjXibj7V8EORKsQ5hXWXeA4SAFOoqN6bUIMS73Qf+F5FC4RSfoUtcs42rs
# rU3bXO4as8Y0SW9L+gH3D1ih0EyM3Ovgofg5oOx7RrZNdDfxLvvBLQ6UI+WS6wDU
# kRlmonHxVNcowNdqCh7QH3aM/51qLxNwK4cljIE8CVMvFANJ9WiaUNdW8EiPsqko
# YoJ5NvbcTxZqZkKGilCOASwCYipnhVLVE9gTqlUcec8hchalxT0ZYr7Qfb1Wc5qO
# AB7HhDdObBfmJc9wBSjfpnu/lBlxF0mvLFjRHg==
