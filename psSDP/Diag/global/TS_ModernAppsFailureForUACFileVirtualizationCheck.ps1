#************************************************
# TS_ModernAppsFailureForUACFileVirtualizationCheck.ps1
# Version 1.0.1
# Date: 03/29/2013
# Author: v-alyao
# Description:  [Idea ID 7712] [Windows] WinStore - Modern Apps fail to run if the UAC File Virtualization driver is not running
# Rule number:  7712
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=7712
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 7712

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_ModernAppsFailureForUACFileVirtualizationCheck"
...
Function CheckUACFileVirtualizationState()
{
	$fileVirtualization = Get-CimInstance -Class Win32_SystemDriver | Where-Object {$_.name -eq "luafv"}
	if($null -eq $fileVirtualization)
	{
		$InformationCollected | add-member -membertype noteproperty -name "UAC File Virtualization Driver State" -value "[Not Found]"
		return $true
	}
	elseif($fileVirtualization.State -ne "running")
	{
		$InformationCollected | add-member -membertype noteproperty -name "UAC File Virtualization Driver State" -value ($fileVirtualization.State)
		return $true
	}
	else
	{
...
{
	$RuleApplicable = $true
	$RootCauseDetected = CheckUACFileVirtualizationState	
}	
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCO45/FR96i90Sk
# FQCXvvPygempR2S0Otn+FkII3sFHzqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKX3vZson23Fk7fbF9fBBO7u
# PiVXwmuzUHlrwF9ZIojuMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQBk7Alq+J8vwkD+TkhkTn6CQRAxzGEbsSGKs7M7pfKU7aip2en3+S8+
# iXP6CB9/sKRC/JPawcpS6P2UYEpzVGtI/ai33D/KVeNUywZ0OqOxVkXVOHevNTtX
# TQAMDofyoE4dM8ghmZAbU5yK07P1eRYUL5vyB1FLsnuCBEhbAtMVLa9SmoSGXBlG
# yOkSRyV/df9o3e4ummQX8bsN1uGKlyJp3BgtpBHs+bpL+K0ylkq4GS6Rce5l0gMz
# N8dlXMPtGSoLA+47hV0zlqOPkcQhs+CegHBJokodHURzJ3jYrYnfcCwg7MvNzZgm
# 6exraXZmKsw2ASI2Sr37s0cT1VgJ9Dv3oYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIDWNDwgdrKN2FTEckYkp59KZHr1QxB9XlWu2r+MHILP0AgZi3ohP
# 6gIYEzIwMjIwODAxMDc0MjMwLjAzMlowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIG0Jd+pug475ThdT8qXI
# i2XOG8xBEQht0iCKJ684Kaf6MIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgAJpIWXqvMtMaH1ZlUQui7G/SnTQOrkWz6pS++h+Ex7n/5xfNEHkFMpSLdh4NAr
# TgMcMOiI/ckDC1GoVYnFy/SYJSoIGmnAZsG31fRzff3NX58nRbAbbqmXsFaK8Vfb
# Pycpm4+YfH2N46l1xXHvmcGIdAxx0/MrID3g0+4888FSyKbIpUg9LbxXxiO0K8PA
# 13GCYr0T/2cd35QvxnqgFDod4ZjkGNOsYj0EeC2wiS7ZRi+OekgSE4ZTe/t1IJr0
# cxSaAHOWiG5Sg8PZGyKS4D8rAnkh2FNb8/T3gt7/e6BDbhSmPfgM5J+48ZB8H5Z2
# dK5OerU89eGmYXXES4sZtktFx7FM1GUeuUZJkfQHUzZg3mzXlCkzY4IorY/BRXBX
# 7mw+dW2mPuzyaJDk70hvfFubntTACiHpqEW84cXv4ijXLRXTYXI8MOghjMqnC+wQ
# Q4dkNw0eVZWqcg5TuzQrmEmNcPqoXxuB76n6d/uqw4OCxCeB9/4SJz6FNV5kCQ2z
# wEPBOAr4ZhjZaty00Aoe3p0T2zz5u2FIb7rj1KvCvPF7xn961lDVCMoMSEuQrY1y
# quW0UKEdJ/5gEGtg3eE/omjc3/rR0brUitA5DTldnW4a2XSIU5yXMIcXFLoRT95S
# GXwHc1MRLgV+eOjaWtHvr1jwAM9aYQf5cjKAS4fEQ6LkdQ==
