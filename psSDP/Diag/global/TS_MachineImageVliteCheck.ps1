#************************************************
# TS_MachineImageVliteCheck.ps1
# Version 1.0.1
# Date: 12/27/2012
# Author: v-kaw
# Description:  [Idea ID 5327] [Windows] Machine imaged using vlite 1.2 will fail to install SP1
# Rule number:  5327
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=5327
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 5327

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_MachineImageVliteCheck"
...
{
	#this rule will appy to Windows vista/ Windows server 2008/ Windows 7/ Windows Server 2008 R2 sp0
	return ($OSVersion.Build -eq 7600)   
}
...
{
	$RuleApplicable = $true
	$RegVlite = "HKLM:\Software\vlite"
	$RootCauseDetected = Test-Path -Path $RegVlite
}	
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCZ+CVwMH2yxMKU
# hPPBWUQDYDqyqdxqBaGSb/a88OF9EKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgJo1bvMe6
# VN4oVajie2Wb1bz28Dc1YAAKMwktjd/npEIwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAB77WMoC1VgPthPwqwPuA+McXoEu+ldp4XhbdFZJxjC09uWoUt1fxpid
# yYSUkCVU7NwOGfRNHGfGhYPGz3uW4lWZ2Bd+wo5FXho578xabAqgV0cDsEggIDs/
# 9mUJEWIuU+pXemEac7Z6MquLq+5+m+5Vn6eW4EmT7yaWDvzaDDnWHm+ol8+bEKmI
# VtWSOB53TK8FLkCDftplg5oDABv/WFH8q9vK/AodV7Xpk4ylVcrErGSBaTJ2U7is
# t9DfQD5/OvwLXvV5BlS/Esd6ozo1H82ETsCqkTltt/8O7PFg5Mav3SdYwXkN0XtT
# POsuzaW1eM/NgkCDy2wVqDnPUF1/HgihghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgCIkQAY0Uum2eNuZ5r0NaxUARcPwPKe5x+iAcUdEY5iwCBmGB++Yl
# ZBgTMjAyMTExMTExNjUzMzYuMTk0WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBn6dSJ
# eUmt01Iwk9Wzb6yXTev6ZG2tPK0atx/2q1JseTCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAQqYo95r8mTQ3WUVgdRO77pGiBdcByc4ncPIuBTW/WnTbePXd
# +pNBftm5ZHLzifDLXbgFVbx5nTgV50qMKz7dw6P7wQk/2QUglMyY6Cv4xbXKb2xG
# 665qP+8GZM9ZWpAbyp4DfKDUh93JSP1AwD57lmkraU8pPVVXDeLy2PmymopljKK2
# 8iVmcEsSoqokuBElGjWfP2jGIxmrkP5TYA6jiQ6HnFl9qm8jFM14DLD6NsD70BaX
# MERID51WsTg9Curqz66W3DPy2p3h/mN9nMxvbeFqyI5wfj1QJ8gIfX+UUpbsub9N
# x0MLV/N1+LSC8TOcylqovevTcnHg6mBlCv0nTA==
