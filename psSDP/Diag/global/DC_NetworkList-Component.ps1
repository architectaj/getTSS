...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSNetworkList -Status $ScriptVariable.ID_CTSNetworkListDescription
...
{
	#----------Registry
	$OutputFile= $Computername + "_NetworkList_reg_.TXT"
	$sectionDescription = "Network List"
	$CurrentVersionKeys =	"HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\NetworkList",
							"HKLM\SYSTEM\CurrentControlSet\services\netprofm"
	RegQuery -Registrykeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "Network List Registry Keys" -SectionDescription $sectionDescription

	#----------NetworkProfile EventLog
	$sectionDescription = "Network List EventLog"
	$EventLogNames = "Microsoft-Windows-NetworkProfile/Operational"
	$Prefix = ""
	$Suffix = "_evt_"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAiggWETLqd6i/G
# 8pPg8mQmg7mN74+/SncpSnc1ew2L56CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgAUDV3rXw
# 2Va6yq4fDtOU+Ut5v5gR0rFFlklxovkjBMQwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAGoD+MRuVX0rUxr3DojUIkP89/NzWFQNY41yTRA7RBjgtiJKaarHf2yF
# kzoRyNWjr4xBB2zxTIcclui5SEDsu0ElKWekMD/HkAU4Ny1wmP1Rgls11ZSyedZ5
# Mr6ToUpshr9aElfdbmE+6VQ8f142+YgxZmrKXkyJG6vyXJcWM/ss1a507qH+KWfH
# 2zGZGyYxCjZHAJPhoOVi24cLLSyxZZW+e4nCpYY75K0R0rTrWRRrI76E/6OZHYvs
# fpr0ELb5SqvNTkEmz0lcynvIAirriKhOraA7PWUCcd1c+5r79xkuS9tB2M4WapUM
# sen5PtQm5Wfwj/Zd47vpSWJLOfK1KjOhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgOk+9aDYd2E37RidcT3w/e6mVFNY72hjT1eWQmW2hS8ACBmGB3Gir
# TBgTMjAyMTExMTExNjUzMzQuMTQ2WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCC/vdG9
# Ughfh11JEYao40v5MDIQ9XDMmPpXxPNMrCnX7DCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAi3jL6EzOFGSkY/eaOra8v4JYIASf6DUmsr6CQxEtg00Cg+2F
# P5qaDB0VzDDcGFjDjV39MhjcJRAmlhy5CP9iAGHGVLBr+X2NQtm0chJhmCwAsBm6
# jEZLC6VM7rOD/f1L4PlideVM2bA5Ssa9vzyGiz47paa+Et0vuxMY4rMCWxCnqlfL
# K7Et3jMqTz8EbYk+xc+E5zAsdYNyuRGLYx6gSdrO5R7qef5ZU7QC5x/zEFu1zfMq
# AfD6Va5vtxhBykbsTpdKKs6dH4o/Z/DtaTrZ5WDsICfwULO7mSahYz0Ss5WOY5NQ
# neAxfAsIhDTLCerv/O22Bm9TFrI+i/8GzvTASA==
