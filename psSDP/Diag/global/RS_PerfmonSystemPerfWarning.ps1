		...
		if ($Table.name -eq "warning")
		{
			...
			foreach ($Item in $Table.SelectNodes("Item"))
			{
				...
				foreach ($Data in $Item.SelectNodes("Data")) 
				{
					...
					if ($null -ne $Data.img)
					{
						$AlertSeverity = $Data.img
					}
					
					if ($Data.name -eq "severity")
					{
						$AlertDisplay = $Data.Get_InnerText()
					} 
					elseif ($Data.name -eq "warning")
					{
						$WarningMsg = $Data.Get_InnerText()
					}
					else
					{
						$WarningMsg = $Data.Get_InnerText()
						$ColumnName = ($Data.name.Substring(0,1).ToUpper()) + $Data.name.Substring(1,$Data.name.Length -1)
					}
					...
					switch ($AlertSeverity)
					{
						"warning" 
						{
							$AlertVerbosity = "Warning"
						}
						"error"   
						{
							$AlertVerbosity = "Error"
						}
						default   
						{
							$AlertVerbosity = "Informational"
						}
					}
					
					if ($ColumnName -ne 'Related')
					{
						add-member -inputobject $MSG_Summary -membertype noteproperty -name $ColumnName -value $WarningMsg
					}
				}
				
				if (($MSG_Summary | Get-Member).Count -gt 4)
				{
					$MSG_Summary | ConvertTo-Xml2 | update-diagreport -ID ("MSG_" + $ItemNumber.ToString() + "_" + (Get-Random) + "_Details") -name $AlertDisplay -verbosity $AlertVerbosity
				}
				else
				{
					"There is nothing to add. XML: " + $Table.get_InnerXML()
				}
			}
...
{
	"Error: $XMLFilename does not exist" | WriteTo-StdOut
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA9H5aCP4z+BoXW
# Qxe3ddsAYNVW9E/eUi7A/fuXSeJoaKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKzfeyrzxN2b8Tu1Fh+EJCt4
# IQtCOYJ7YSyPBIb5jhZvMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCcGIFmeEWnqN47/XGaVvf+qFyXpmVjM0W0j348YVEH9X7AQgdhM+uG
# sm+aoH4e3TZK2rZP9xDD3eDhMbvrnfpMJUvHHYxMiQ6Ta5dMsQuB2GsMtRHUeJLe
# vD2lCEWOeWXB1vb2CfFFP5hlxUxjTZrM7IQ02Z5affbrz4rN7QBDDbfsFmhYDtnN
# Vp42eln0z8hgAO3Wz0co7ekVRk7+oIz6AQIMAhEvMMUJfzDCkGHZ3gJqbcapB/ZT
# acIt/0UCXW5xk8DMrsvtS2QqWq2u5xtiB5n32/84JfClNO8Mi5APW5QEmcUDN6Zd
# HNde9cR9IAOPzTGrLrxnS395CPo5JLNQoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEILLpwUG1xZ54bvCena6iDtahqb7LhWgDkeEcHmHOPDZwAgZi3mQf
# ITcYEzIwMjIwODAxMDc1NTI2LjU1MVowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIMtVmckqCBJz7Gn5gZUS
# g5thCQVwjzau5Wio1jx8qEphMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgAEIMHxrvRrSHRFrqF/tL5H10Izy7TaFqKzE/wI/5xdxxvJU2GBG+KyjymHWUod
# Jl/BWUkBpwMvJsp5BrDIwbMHKaVUf5LqYnlnKpZd81XjMm2WiPct2d+t/MFSI0xC
# 0oPz62a+XuPaiyUOMj3El3slMSC/ETKr+xcd3iOympuwvnLQx/FUiij6k76tdUyP
# LCiu7yBtUqsjz99xc6/5Nf34TU42HmzO0+TcdPjwfCoO0qKMaQw6q/0Br5zys8Rp
# 98E7qSW2Qfu7TgPvUo36UXmhz51pTAfMmKBgsxPE9h+D5VjkdoL8ONsBBrOMVq/T
# 9L1ioU4ItaOADXMtdmcaLf8uRfWQLE+jddNCYGl2GHh3saY4R1dugWHVcKyFlaju
# maSBmVJqGGivfL+h09JsZWu3S2moepJSzKFvM41havbv7KYKRUCOdT01VYcYDBIx
# BtbkQXRBsgHlTtjw3BKgnzXzAFBkEE3ZiTbemzFQc8UZOGtMxmAMkdhqczDrnUGN
# kW4YW7NDgpxKGk66asDlgz7diGIDzWSIdRrTQoakRPPV4YbpDWFASk8gd+U6ywQQ
# OfqPZidWwrMKKWnx4ldRkvtA5BttnBpuYm8QoT6xax/7tDWCl2ABCf9swnUanjs7
# dNz1a3cQNLLRY9vWUZMOV/3+7jnn9XdqOym4GFSey2wcMQ==
