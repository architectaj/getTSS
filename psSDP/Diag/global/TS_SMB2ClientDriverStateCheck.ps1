...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSSMB2ClientDriverStateCheck -Status $ScriptVariable.ID_CTSSMB2ClientDriverStateCheckDescription

$RootCauseName = "RC_SMB2ClientDriverStateCheck"

$RootCauseDetected=$false

$var = $null

if (test-path -path "hklm:\System\CurrentControlSet\services\mrxsmb20")
{
	$var = Get-CimInstance -query "select * from win32_systemdriver where name = 'mrxsmb20'"
	if ($var.State -ne "Running") 
	{ 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBw4LK6wQehyP4D
# Nmy3gQO3GqUw6gKqKc7M10yY0tZ8qqCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgvxZUc3XJ
# Df+lWAXv6vES0d/mle7kfOePXeyNphIOP/gwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAFd/fnIBw2nmBJtJf9smp90RcEMzPENbPjfEczoTi4gaGJcPkx+Pr0qe
# flTInMqaKc4mzzP6paVYrVy4ANagT5xngkH60eqrPyc7uA4GBX9kLrSgaiC8No5e
# eo96/qax+lLXjepplzwsV4T2UjgOGuxfI3MPhyFfh253J969y8w03If7c0P6ysB0
# GCNk6CtNT9ScQ/9r/CximzHZhkcUuY5dQ/TzDzUgaaIwslEEg17g8RhUt5eFQAed
# HGbRKL6fOp/UngdbxEbgcel3af66lmZUIQ2/JWTeBpGk+SD612A6SQiTAQErhsl4
# V49hZRXjU3ev5nMJ/hZoJN0HulGITXmhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgwqT7f7bbgq3KkFwUj8oevrxwGTmSyTmt+9MvGFQZ52ICBmGCAKQz
# aBgTMjAyMTExMTExNjUzMzguNjg2WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDubaTG
# 8bo3W+e1WhGhM2DTrImSnMhn8jNtsQkyp6aMiTCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAFIK3qAZ+6gGgRi9YfHMk31P4HwhvuPxBcYJrOu7OShfiK4WE
# L9hL+dDZA+0JJVmoLkhAaG5v4CtCh3XtOuFyF5BpLOK4eNsqV1zN4j5zLDD2WQ6d
# VwTnxsvHCI4rCqTXl4ohTIp8V3MaSxsTl7Ifs94gJNold3LVV/IGh7f5nxby5opH
# SdAXveADlehfqDMKr/rE3wDs0515RL/xtFn+Flaxa4ODcSHcFAdV3H3Gh+7IeEr1
# aJEAFiej0/xYzTY6YTxmN+G9LzDzq4pKHGaydSg1eKA/z7CMI5Py676cagQEnNdW
# xeQSHZMSRANiScmL10xmcyHKzkkzWVr1LbnTpw==
