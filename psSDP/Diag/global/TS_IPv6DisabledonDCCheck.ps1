#************************************************
# TS_IPv6DisabledonDCCheck.ps1
# Version 1.0.1
# Date: 6/21/2012
# Author: v-blchen
# Description:  [Idea ID 2593] [Windows] UDP 389 on DC does not respond
# Rule number:  2593
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=2593
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 2593

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_IPv6DisabledonDCCheck"
$PublicContent = "http://blogs.technet.com/b/netro/archive/2010/11/24/arguments-against-disabling-ipv6.aspx"
$InternalContent = ""
$Verbosity = "Error"
$Visibility = "4"
$SupportTopicsID = "7978"
$Title = $ScriptStrings.ID_IPv6DisabledonDCCheck_ST
...
# check if it can apply for current system
Function AppliesToSystem
{
	#_# if((($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 0)) -or (($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 1))) # Win 7/R2 
	if ((($OSVersion.major -eq 6) -and ($OSVersion.minor -ge 0 -and $OSVersion.minor -le 2)) -or ($OSVersion.major -eq 10))  # Win 7/R2 .. Win10
	{
		$ProductTypePath ="HKLM:\SYSTEM\CurrentControlSet\Control\ProductOptions"
		if(Test-Path $ProductTypePath)
		{
			if((Get-ItemProperty $ProductTypePath).ProductType -eq "LanmanNT")
			{
				return $true
			}
		}
...
if (AppliesToSystem)
{
	...
	if ($RuleApplicable)
	{
		$RootCauseDetected = IPv6DisabledonDCCheck	
	}
}	
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBJcC9GxMDNmkTv
# qiBJTf8nOSQlE12ulw4hkvb29CFu96CCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIclVfjyzrxzTqoiv3NAG389
# dXPIjC0HEdm/TtIOys77MEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQAfwRf1gfo3Swf3i7C2bQoi7NjfELRUHDKWKAA5oMbVwgcYjDR4r3d5
# iVC0KISS3+Qha8zAWK7hrzsmTM6Fa+l/HM+2aCzjHcEHafFtyXfa1vsIJlUkOLlX
# alyfay/WbL2KWtdbqG70NG+ghf9cLn3kT5ZP92GNK+763Wn9aL2ZqF4QVWSLxoJi
# b3rj71yXVNKDtVt5h1PAdJFClFywTW9mb597ba04US8bMwA142a2SXjCRkL01qaJ
# Xci8znW+iYhxKD52gcAvwBUoVr8ALci5DzzsOdaQ06mACH2j0kPdQ7adsS6X+61Z
# Fd9rZB02J+YyWqiy+ghdhXQrf4nt1kysoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIDnhtL53h3zO0gCmR334hLErEvQQLKQ/3TBLWNnWt6JKAgZi3mQf
# LqcYEzIwMjIwODAxMDgwMTU2LjIyOFowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIDTgzDiwInaILVDH51Yg
# Vrqf6B/Gp2TR9nq5QsnuIr1jMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgAImcbn5ytgqKbBpS5ibfSVcOwdanjwifZ3suDqOG0JOv4AWiUerTfZsmzq/4O1
# ELlurRo6mz9NYhxZE2mpbKjRGfmM8MNHhlpSC+xVwm2KDaS4el5hT9kUrw9TLIrP
# HLFVgqdhDkkB6I1rZrlQDZSzbsdknJYz6ZkHE7pSa8vR+7XunJHtkIDC+Um00pef
# FEUbwBJofGR6C223Re4pGvnZLTnqNEFtQxSc6vLKekyBt8kdlas8VvfUSPDCcm0y
# tzsUpDVUbaXpgHHzhKlTYSuTApINuG5Ev7ZqWtIYiffFKN59g2Ym7gxReSeVVZYO
# zbo79gDlSKGyb8nXRTco2dKvmgRishZUsaCRw1n6CS7PPNGKa2E7v90mjy1FzzQ9
# JQiJrkYkTCFTteazZkcMZroU7JfAI9AUdyuAxprVhOxdjHKGGQ1uUGU4sZh7xpa8
# HblOLEFceze6pvIublWn0PI+rt+GlXPLBIP1bKQPqnurrAcgjgkOSTWiG/r+8xsq
# krHKFID0jfbjeD4tTt/EEQepcFhkTwktPVx6Pun5zNUPxv3eH/vPCL3t+z0XyAQV
# xzT82sZl3OEMPTidMbbAUeYC9gIeKaYlfa58+Isjvo7aHXaTktxBkgK+eMaTKgd4
# epbyaYSSeYfeKcKYjtdGGx3Fi0jE8mt+EN8eefLfqrJumg==
