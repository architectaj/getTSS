#************************************************
# TS_PrintZSDDMUICheck.ps1
# Version 1.0.1
# Date: 6/7/2012
# Author: v-alyao
# Description:  [Idea ID 4091] [Windows] frequent spooler crash due to zsdnt5ui.dll
# Rule number:  4091
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=4091
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 4091

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_PrintZSDDMUICheck"
$PublicContent = ""
$InternalContent = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=B;en-US;2003705"
$Verbosity = "Warning"
$Visibility = "3"
$SupportTopicsID = "8066"
$Title = $ScriptStrings.ID_PrintZSDDMUICheck_ST
...
{
	$file="$Env:Windir\system32\spool\drivers\w32x86\3\zsddmui.dll"
	$fileVersion='6.21.1207.0'
	if(Test-Path -Path $file)
	{
		$fileVersionInfo = ([System.Diagnostics.FileVersionInfo]::GetVersionInfo($file))
		if(($fileVersionInfo.FileMajorPart -eq 6) -and
			($fileVersionInfo.FileMinorPart -eq 21) -and
			($fileVersionInfo.FileBuildPart -eq 1207) -and
			($fileVersionInfo.FilePrivatePart -eq 0))
		{
			$InformationCollected | add-member -membertype noteproperty -name "File Path" -value $fileVersionInfo.FileName
			$InformationCollected | add-member -membertype noteproperty -name "File Description" -value $fileVersionInfo.FileDescription
			$InformationCollected | add-member -membertype noteproperty -name "Current File Version" -value (Get-FileVersionString($file))
			return $true
		}
	}
	return $false
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAIHZ3CBVWhUlAp
# 8bRLU+R/mUM/nMajEcS+CnvlqlVt6aCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgXVCTQB36
# 6H977yDd0XS32dHxsr13q1ZLELekCX8XLFQwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAHnbVlFaZYz9CWZiRvWBIAhj3YBQafRScNUyuDB8epgyfObLy05NF/7y
# ZZc/sa3jhTg9ZvKvRX7eeU9+Ni2pzjwneKafzZCFGl1+Y4GEiY6dDnDJbJbrfPr1
# 2rW1klVJt3ItaKspa8remPB6LfEaAK/moQd7yzPDmvjuHmxyNZIuj3yYLTl+I3uW
# alr2L2WUwkL8W9Q99ZpY3XwsNVZBca/V6g78uJM022U1mTRC9lTotaQrDjTWOKjR
# CmfQDSpil/Svee4S+uzAB0Qp8kK0DCVEHZAfFzW4vnZIXJQ1TwZlDkAsDsLUFEUE
# NcOieqXSFEOQ5XnsOdDqSOTUVa8gS6ihghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgZbkMUnNUZ2hS0EHRwVjkTV318bZqdILH3/Sxx2MChWgCBmGB++Yl
# BRgTMjAyMTExMTExNjUzMzMuMjM4WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAw9yxC
# GVBgNhU2IQV1kmkHObRni3Mx/A711jc04QRZzjCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAjRH6l04mXpyTHo3EqnFMfXMl8j5AUVWZg0se3LsnmZatfink
# euXR+JCG0Vto8fYaMWfpQYqr4WyKJ+qzJX8BFk1yqML0fuRtDJAUJBuHnn7qQgmF
# vMe+2ZlNni7v8IfKgKwWxzZNady4yLG/3Jk5TM0hw5QrnCm1QAxgeSb7dOrmKaem
# YbunEsuUmEs5oOwGUn85T7ILcJxH7GZhqrPzKp/iL0Ml3WCotGcfeDP4xrY+JwNU
# x0B8wHuy2aS1GwiUXC7pp3dyrEs2vtXQEuWTfmlloZEZfgmsA54vujNLPLfurOU+
# c4j56bP2i15kUVFfIXhkU7MS61nVKJSQpKhrHQ==
