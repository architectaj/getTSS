#************************************************
# TS_HyperVCheckVerificationKB2761004.ps1
# Version 1.0.1
# Date: 4/25/2013
# Author: V-maam
# Description:  [Idea ID 6134] [Windows] You cannot start Hyper-V virtual machines after you enable the IO verification option on a HyperV
# Rule number:  6134
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=6134
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 6134

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_HyperVCheckVerificationKB2761004"
...
Function AppliesToSystem
{
	...
	if((Test-Path $vmmskey) -and  #Test if machine is Hyper-V Host machine
		((($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 2))) -or ($OSVersion.Major -eq 10)) # Windows Server 2012 or Windows 8 or Win10
	{
		return $true
	}
	else
...
Function IsIOVerificationEnabled
{
	$keyPath = "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management"
	if(Test-Path $keyPath)
	{
		$Driver = Get-ItemProperty -Path $keyPath -Name "VerifyDriverLevel" -ErrorAction SilentlyContinue
		if($null -ne $Driver)
		{
			$verifyDriverLevel = $Driver.VerifyDriverLevel
			$InformationCollected | add-member -membertype noteproperty -name "I/O verification Level Value" -value $verifyDriverLevel

			if($verifyDriverLevel -band 16)
			{
				return $true
			}
		}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9eo1AylD7Kx4g
# JrP8cswhkTL7Y7HbJiF7XdmXxBBRS6CCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM9tW+kb6ddEpOrT0RXn79CW
# kCpt0mN/cZbYLjqYb/jnMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQC08tG8ziIkYuglwd1DIomqtD4sn5rWAHu4ZX44XvziJ9+Y7IGI8jf6
# GgBmOWNGu2oq92G81PnV+5eYjdu8zIb/icGQDhtVtbsOGV0sA2CF9Mqb+D3blrQl
# AYp4GgZX8K3/svGNomWj6RFOaeuuxYUObFLxEGT3Ua1HPpHueqhQWT8GLt9L5Nxg
# CbJOrpVk4A14JLQPK4/6+EhQ8Jk4JljW6kGZESqqrm1BBqP0NmPHP/oWdTXVkTXt
# G22uLAkArZuOIA5iVua6m03F2rqNvsA8ESYsoIaC3+BUhGcJWfZSWOgxLMcb36So
# oEd4meMos73FE0NxLw9gPqp0Uw1I4OwooYIXCTCCFwUGCisGAQQBgjcDAwExghb1
...
# AWUDBAIBBQAEIJ7dd+ZWYJ04ani0yaQWoKQA21088KG27nyOVEFs3cceAgZi2xAP
# aukYEzIwMjIwODAxMDgwMTQ3LjkyMVowBIACAfSggdSkgdEwgc4xCzAJBgNVBAYT
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQg1dV2AiBtVK3W4LYDO3VR+TLZrtBgX4znotnj
# hLVsleAwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAOHK/6sIVgEVSVD3Ar
...
# /DQk+dqQy1YkmvsPNzOkpL0iMA0GCSqGSIb3DQEBCwUABIICAJg+rN83bBipB7Yq
# X2gUU4sohirwTisnhW/akgnftrzM80DpT1S+Bi3qluEtm8m+1a9eC8CcHVX4GFX2
# TNsHHOKNYCiMfcLyH+wwnEBYWUkHBU7uBYKqj0aBKJUrBrWrGm3VzzfGnrK19dyX
# Mzuu9IMqI+42w34CN9yNoQGyM5S3DYCbeeLI3DTq4+GcMYPaqbIP0DVkzhfnUMOx
# QIR7pL3/c0IVCdQsmfgKQvmJ1ge0bvfgM5rGT70UpIZjwbfA8SQv1j5jkMrY7mMu
# yTo1P9VMgUwWMzNrN7aGoofFZrFcyXkmThk58KCjHA8xtuyHuwRp2Ti77O0YZjo9
# lmjCUWd7cizsnKdMfr/5V0nREWK4mrha9ISKBVKKhoEO9Ov40UrNUxgOlhHP+unp
# Xv1+egCfzhv51O2GL1LQ2dTJOUl4bvL4J3A70ywZn+0L+fzgePdLhAIC0sPGVMOV
# mHjGHA/Si7SL93vDXxlAvE6GcCjas+zvlaxHsk/HAq0Htp9esbcLfZWBbsqKi6BQ
# iKkWbFbbjkEkNrJlm+B7/lqFLP/stl0Uum2zyz9AUtk7JQsvoKtwayoV7E8jnUSV
# GWbe5rmvVFTYGzmSyZAugul0B59n6VFm+Obe+TZoTamzAq3d3jErMlNuYX5UaY29
# Ccax1W9pHYa4IQecStTLCOlVPtJ4
