...
Function RunCommand ([string]$cmdToRun="", [string]$OutputFile, [string]$FileDescription="", [string]$CollectFile=$false)
{
	...
	if ($CollectFile -ne $true)
	{
		...
		$Null = RunCmD -commandToRun $CommandLineToExecute -sectionDescription $NetBasicInfoStrings.ID_NetBasicInfo -filesToCollect $OutputFile -fileDescription $FileDescription -noFileExtensionsOnDescription
	}
}
...
Get-CimInstance -namespace root\cimv2 -class Win32_NetworkAdapterConfiguration | Where-Object { $_.IPAddress -ne $null } | `
...
$Temp = (Get-Service | Where-Object {$_.DisplayName -match 'Windows Firewall'} | Select-Object Status)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDhjIVBCjcyC3mV
# drIAoLwlVJ9TAZIJJtrkRGjxNqv9JKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDybYX0H3nWcgDodvAPFlzm4
# JuEYlF79opoKjsxSZKNaMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQAuFa/A5MOQBsqUCHR2vHgcfmzSO/59eNyfgKUKfPxy0X2BRHTE2nuH
# R6dxu0SO388hWR64lLn5saGhG0BDWI4HZRCHZGLXsY+yExCphhbCAIOu8I3KBeQw
# H+3ogjR8JfY4yTSSE+/Kd6NmK7kGzpSfnzmP/Mi2d/1wfglset++WH9zJFkOrkTn
# +btzpLNBd6jKtHU4UPTos0x0qDNkxgNeMrSEaQOw+iw1IMSg9LR5yw6FAuOJXM5O
# PDUKi9C5c/77OcIwj58KP6wkrTZmXcXh3yLH3q0PxsLSd3F74U3uPPyjRIxf551O
# ADwRjOf3s36kbrWnkPpHQobauEEUPRBsoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIEjWf1vMtSTNJu2itIMUBnZlrRRCZBqHNGUmtK/uwNCfAgZi3mQf
# Gu4YEzIwMjIwODAxMDc0MTA3LjM3NlowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIKhN2eGriJsStf+RXjvm
# g1/JdaDkQv7g/Uo9z+y+MwPPMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgCkFZAmjkfO9xZCixvdru2xCbl1KEUEHwOC17YbCpuLTDj2ZU5f65VcsN+l84rc
# YwKfv5QPh4EIfNGHoKIYD4RngVIIlAsZOvFigFxiJLOT+yO+cYDpPLl2Ig6uMO2J
# dxTNV+HYDfuCXgxOwWiVXVcKzEOTMI/2xOVTxgd4e5VJ/IpGmL37TqT29pQLFnTS
# rM7Svzw0s08wilXPYyn8vPwXsIu7wuu6RrgUVUty9YtZq+HxwmrLMdC0HJt6Em/y
# AMEaaekwD9xtHc1KJPUPjXMsXXZ2ehEKqApeZLrFBpfQTTyXaCopUlf/lAvlchj2
# w49+bbT3oGgXFpvdmJxN5+iWfzHOKMy30+5kUDszyTT/f6+fba0fC+xA6qZNe5QF
# le8LUqozVujsk9AE8855CaG/B/MwGvxGCrvIgvnBw/C/jKTeJZ4h0OGqNC/Y6JX4
# XoRYlZqQFx6iuD7+78M9wsLTJGnwaBQ1mBuxtjlf6e+2XeWhUxfckLpFDNpd+Q6R
# sZ095zQgAxGrUJGuTmduDqLGjhO3YiXj0nH1o4duysXc6mHl8WusYzKF+Rhl2DPY
# TYq1J+p2E4snaQ93OKONAiwfp/Ej5vAbASRAlMRWTwlqgjj9yZzFJicaCJ8ZEI6w
# pl0G27S44yAs2bdYrTjmY2xfJUGBYhYW5RHBP74dtx/QFA==
