...
# Called from: Main Networking Diag, PKI Interactive Diag, WebClient Interactive Diag
#*******************************************************
...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSWinHTTP -Status $ScriptVariable.ID_CTSWinHTTPDescription

$sectionDescription = "WinHTTP"
...
{
	Write-DiagProgress -Activity $ScriptVariable.ID_CTSWinHTTP -Status "netsh $NetSHCommandToExecute"
...
{
	#----------Netsh
	$OutputFile = $ComputerName + "_WinHTTP_netsh_proxy-settings.txt"
	RunNetSH -NetSHCommandToExecute "winhttp show proxy"
	CollectFiles -filesToCollect $OutputFile -fileDescription "WinHTTP proxy settings" -SectionDescription $sectionDescription
} 
else  #XP, WS2003
{
	#----------ProxyCfg
	$OutputFile = $ComputerName + "_WinHTTP_proxycfg.txt"
	$CommandToExecute = "cmd.exe /c proxycfg.exe >> $OutputFile"
	RunCmD -commandToRun $CommandToExecute -CollectFiles $false
	CollectFiles -filesToCollect $OutputFile -fileDescription "WinHTTP-proxy-settings_proxycfg" -SectionDescription $sectionDescription
}


#----------Registry
$OutputFile= $Computername + "_WinHTTP_reg_output.TXT"
$CurrentVersionKeys =	"HKLM\System\CurrentControlSet\Services\WinHttpAutoProxySvc"
RegQuery -RegistryKeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "WinHTTP registry output" -SectionDescription $sectionDescription

# Commented this out from the reg output for WinHTTP: "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings\Connections"
# Look at the InternetExplorer registry output file.

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCvLbAQ2H2qUV38
# tyrfvWMWSoCueRzxL9AgQ1aRDjuYc6CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgQ7wYkReu
# LSgYfo3tf7o6j+M6tS9LU/CEPEIAmCrKeIMwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAG7tXDgQUn/FLFi5pAfWuU+RWpMyIycZ9iwOR+Npk3iAk21+T45k3KQ0
# 06qSqn5UR4geYHnIUNB+aWkU4d4a8GDkPx+3W8skWSjnCRmWDxx453gGkrUPJQsy
# n9Kmpny44SQsJlnzW3IN9wrpTNBkBaam9JLsIvJir6OkNp020xxKcABw8Ud7wWwJ
# WVmv869zoW9sduHANTSdLZ1PmI+PP5TbCNZH80vNLhqACk6NiWETZ+Y2KwIGWLX/
# 1n5GVmNMBJl0HpLaf+EdJuWGQ3URBXzDWuVVB1LctnsAM7FT03aKt+AZV6HBVf37
# BZcTyN3n7yS+xzDzLliOzoio5MyF2aOhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgg0gsy7qaSXsi5WY7Bk9/yEqc8g5xvqtFHBHIBfVhkUwCBmGB8A0Q
# ORgTMjAyMTExMTExNjUzMzUuMTE2WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAoMJ7z
# U0Gk8zC+npclrp14mRotzyMvqT1dnot8RBE3RTCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAMBKR68koc4n9NGMS+wruLtTnYdMWPrRCaRvPN/BksbgfeRig
# VLOBKWCsOQWJkmtEkreXLyPm43PA6kLsy3iSuq40+2k1aiyI6YtoBchyiUZmFBvd
# 5bpH4XSYHSg0QiWHi5X1WKsnNl1BVNKc+MWBPVDq6q3Cd8zt3Zp48YNEP3ABOorC
# H9oQVw4vne5xfJyAu+KRc1/nrH0RxRM2iUyX+fb65ZhLxCENwkLXWYpU8x1OumYL
# jY9scvtmNrEDpcGNoPcBqwKhl1MKEdJg8pFXK6oURP1VvpqO1xpIuNN77YWM8tdl
# WXYFmG+uAbH1sFBbhvcXG68rPVsl2pTyFZJBKQ==
