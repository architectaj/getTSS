...
trap 
{
	"[Get-NetStart] : Trapped error ..." | WriteTo-Stdout
	Show-ErrorDetails $error[0]
}


if($debug -eq $true){[void]$shell.popup("Run DC_Net_Start_Output.ps1")}
Import-LocalizedData -BindingVariable AllServicesString -FileName SQL_Get_All_Services -UICulture en-us
	
Write-DiagProgress -Activity $AllServicesString.ID_SQL_Setup_Services -Status $AllServicesString.ID_SQL_Setup_Services2_Description

$OutputFile = $ComputerName + "_Net_Start_Output.txt"
$CommandLineToExecute = "cmd.exe /c Net Start > $OutputFile"
$fileDescription = "Microsoft Windows Running Services Output (Net Start)"
$sectionDescription = "Microsoft Windows Running Services (Net Start)"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCArF0ZeDL+L4jGA
# motqnti/6J998dSVWNhH/kvlF/IxBaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBvOS5kd07G5yytE88JieJat
# 2bdP803p7xpuua4OipuVMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCYBMooKu7ghJjlSYXcwIJVaMSgSq2ge+EDR0XLyt5lmXb7fQRfljT2
# QrUybQ/pBCHU3e9UbIg3d3Z9sjbsCv5t4zhipCB96qUZKtzkMympCZXAdk3KGRjm
# cKcvi0/A6ldPTIfmFEjc7pnHTzaXTZKjCs0MmhCVH+rVWBmQRK5myIHo4tQrspyK
# vlHuIar3JrX+nAnWjbjIh4JkE4U3fRzaKwgYhQ+gJHwxAaDKDx23n2oNe3lQscjQ
# BGWSopdHRKABSguoacU/JRo2KOlaAmxiqOi81FqtGLc1+pC7QMVSLOIKjt9z3A+K
# e1X5r+1RV9obKm7j7sROBRM2RwsU5LPCoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIPh/8IvGRK5cg7Uwv14mH+eHx5BomL4D7iFtZrtsNPhqAgZi3mrX
# 2eYYEzIwMjIwODAxMDc0MDU4LjczNFowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIApWlnz5cvCiB7b4A32s
# qW5xk3C59oovlbsgkOG+uyZwMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgBrlRt3wueD7QcBlCzU7fQBpaIFXkBsgTzZonsgLQj+gPFdgPHKhnVxAOu2asDi
# yZadpPbXql+vC8ySAwaZljoV/xEnj8vS/3/GlVBKgGC6BFD5ppEBMuiiNwIheixf
# UmFV1cXkKe3qYspNtwHy2c1jfQLIjmgSvhIL/IvEx3hGzG/FFSweOvl1zbjkicEc
# Ds1SfLIFJzwZY05GTTnlFi8C2J0rK/8pEQhtawJZigkoYwtCSpQGJzZO2NUT4Hqi
# 3zYMYUcOuNsfJOeAqieGzOXj6qj3DHhAN3OvmJmWJ8A6b0z/SVGSLebhXXOM6LkH
# KqxpSGJAJQEHWJdPJuHM1DxOm+OnpHYd8n3OR2CVtKe28QQYi+kwA7uW40zmX24+
# BZpTAnA5I3tZFADsAo3attaZIyi1Xz+WTc+blEIX0XG8IrVSg94kP2+SRGuL7XC1
# eM7BCTkuaLIFGpqt4ixeC+H2aoD3Rcy46RcDZoSxTK+SqrGLm+CGcYQZdg6CuXUw
# gAsJSe2ZFO7fE8wRGGcJCgBjoLK3Pg9lZ76hTuo0ltvwTQsmI8nIbpOagOOYqfTv
# nFg/B+u+wyr2azeGBVVr1aD9yBIcS3+BhURuyiSlZf2fImBiyurN6ctA8T5PxCHN
# D4YtInk55NJ8dk76F8RB40IoKi/9U1HMazvwMTtpHbGzJg==
