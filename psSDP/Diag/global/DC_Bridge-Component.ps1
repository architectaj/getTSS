...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSBridge -Status $ScriptVariable.ID_CTSBridgeDescription

function RunNetSH ([string]$NetSHCommandToExecute="")
{
	
	Write-DiagProgress -Activity $ScriptVariable.ID_CTSBridge -Status "netsh $NetSHCommandToExecute"
...
#----------Netsh
$OutputFile = $ComputerName + "_Bridge.TXT"
$sectionDescription = "Bridge"
RunNetSH -NetSHCommandToExecute "bridge show adapter"
CollectFiles -filesToCollect $OutputFile -fileDescription "Bridge netsh output" -SectionDescription $sectionDescription

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBbow0rqHCEGfu/
# L80rvV9VsreNuLZcUzbf07M77bU38qCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgwPHktEM+
# 5YKXuT/VIbFjgeBjnnm/zSDFEIs+m5BDMz8wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAGOg0jegPpiz5jdu1q+57hVssnZZrsU1o3uUo/8pbtz1pGVgrgZeS5yc
# NytffGjK6cqtWFliTyvlfYRHa3qCBRD1SSSNPfJF+WlG+rV1LEWbRsKCiisTd3rD
# Vyyqv6IoLD1+XSjefHzOV1TjSunUAzmhiFcnPV4zWaonIfC+X19W8USG+ML8/K2b
# DJ8Xs8lF3cu+QK6rx0Qh7/26DsQjHc+Rs+E9XVL7Z5iySvk9bzNfB/li5OA5TS4n
# pG5xLoz6ctY8C0/NXXZ/L8G0l0D3ep5gRwNnPk34v+ZHIy0YtLwDQajSzoEqQ42U
# 1PSr7vd+HJyC1gwQiTnt1F9R3S2AS2yhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgrXIM5wB1ceJ/CKjBrwKdgy7+ONtawkSZnTCJrrW6P2MCBmGCAKQz
# CxgTMjAyMTExMTExNjUzMzUuMjY3WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCGziWn
# utIyT/EZalQYY6TrFdjcBlLl9LQT+ALYiyFdxzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAdkfVGKWGHrm8zdU/Mc83PwAYDwuKd+q+mEMQQVjgU76r2bSs
# gYIveNuVdyT4Xh6GusiSDogVI/IHJzDzlCiqnIiulwHU2kljnatG35waNaygGkTv
# EJBHjnLSEBErx3oEhjRsNbtgEGYh1l2dt9VSaHi0GoBDhVKn3fkLt6K44a7eKg4O
# EZdSObQmZxMimMA1DNUhqS8/gJYfIz+OTJSWJ+wOBqD2yu0mEC93URh+1nfKXbRg
# /H2BUoWyc1yP4TI+2/murgywK/qFFtZ9+9v7jTt+0QUWHy6lQVe0+VO5J39+4xnh
# bsi/hRCS+9BoECVDzY9GVaA9C/m7fq8J7mELtw==
