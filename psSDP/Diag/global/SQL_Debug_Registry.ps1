...
trap 
{
	"[SQL_Debug_Registry] : Trapped error ..." | WriteTo-Stdout
	Show-ErrorDetails $error[0]
}

Import-LocalizedData -BindingVariable SQL_OS_Debug_Registry_Keys -FileName SQL_Debug_Registry -UICulture en-us

Write-DiagProgress -Activity $SQL_OS_Debug_Registry_Keys.ID_SQL_Setup_SQL_OS_Debug_Registry_Keys -Status $SQL_OS_Debug_Registry_Keys.ID_SQL_Setup_SQL_OS_Debug_Registry_Keys_Description

$OutputFile= $Computername + "_Recovery_Registry.TXT"
$CurrentDebugKeys = "HKLM\Software\Microsoft\Windows NT\CurrentVersion\AEDebug", 
                    "HKLM\Software\Microsoft\DrWatson",
					"HKLM\System\CurrentControlSet\Services\i8042prt\Parameters",
					"HKLM\System\CurrentControlSet\Control",
					"HKLM\System\CurrentControlSet\Control\Session Manager"
         
RegQuery -RegistryKeys $CurrentDebugKeys -OutputFile $OutputFile -fileDescription "CurrentOSDebugInformation"
# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCJpK7zuQyvi79Q
# V6nbabYVW8FZnCabji+dds4/7vokqaCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgf+OYvNk6
# 3TbSVcUegvbsPmxbjYGkVbI+z2re+b6X5TEwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBACc9JVztHO347oF7gcVJt4hK/YlkeU7lCflUDfQM3hoIcEcuf4hvPYM0
# ShhJM38AN1GN3RAmTM4dq7cSOEJdyhXA6Gs4xTilQQSM41tQ8Kf02Ib2/rDoftTc
# pJEu0jHh80IWy/KiYaXUEoYI5NXqmvPZZFOuRyR2+t6fjVF/xUnoKfWo+YToMegH
# 5oU2z3YElYRxNwhqGRlPVgcRmf5sBJGrbWJbUkNYBzhCb/P61AHLBDWh+mmoE8zj
# 9nGoYYqDysswg4iCja0GlsBs6UFWUqMhiCx6Kj/lbbZKTIcO7UCzmCk3Ft25QZL2
# t3bx/LDuy4FGgADhFxrMCzknZK87Z3ahghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgkNvNgZRLQmJQrQPEZQPXqpIyInP35W3MdLOnr6QLuG8CBmGBv6X+
# 9xgTMjAyMTExMTExNjUzMzQuMDU3WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBM6FTT
# ptO8yMETAC3YbVQNkAUPWJitoNw2YTGylVbZSjCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAHGxewVJBPLiHIGzSyLxoFenvWp1XKTqFvK+9ErH9vCP8Jsdp
# bAL6QVzG3OAnNH7NdU5z0MdOOrb4oBlYyzcKURVZJJ+vhbuSGdXp9N4XLdQtyEYf
# In5DcjzW4mzoFGMKR0CtpGrCr1Ng0hOB9xyg524kFuiKLBemGkrHYJ8xQIHF22H5
# 2sxFnVF79dxD11cM2WHtQGBQHnQvatw95b5I32yCexXHai2aUQ7OZWN/2E6uplAx
# 7gin7Wv8c+b4BZOEfYLgU2vuUYVpPcmnym25tcprPZO+Klo7Pj3zcdEiee9VrC9V
# 5sfirlgbdk/7VuMT/g82XvX7IcjJ887BhdZOVQ==
