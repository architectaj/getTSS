...
# Description: 
#	This script gets the RDP eventlogs.
# 1.0.0 Beta release
# 1.0.1 [dgrund] Made System and Application fixed, fixed $null logname 
# 1.0.2 [dgrund] moved from get-winevent to wevtutil SDP workitem #251685
# 1.0.3 [dgrund] added "Microsoft-Windows-RemoteDesktop*"
# 1.0.4 [dgrund] added "Microsoft-RDMS-UI*" for rule 5550
# 1.0.5 [dgrund] added "Microsoft-Windows-RemoteAssistance*" for rule 6109
#************************************************
PARAM(
	$TargetHost,
   	$RDSSDPStrings,
...
[array]$LogNames = @( "System", "Application")
[array]$TermEventLogs = @("Microsoft-Windows-TerminalService*", "Microsoft-Windows-RemoteApp*", "Microsoft-Windows-RemoteFX*",
	 "Microsoft-RDMS-UI*","Microsoft-Windows-RemoteDesktop*", "Microsoft-Windows-Remote-Desktop*", "Microsoft-Windows-Hyper-V*" ,
	 "Microsoft-Windows-RemoteAssistance*","Microsoft-Windows-VHDMP*", "Microsoft-Windows-CAPI2")
[array]$WevtLogNames = wevtutil el |Select-String -AllMatches $TermEventLogs
foreach($Log in $WevtLogNames)
{
	if($null -ne $Log){[array]$LogNames += $Log.ToString()}
}
.\TS_GetEvents.ps1 -EventLogNames $LogNames
#getting Security log sepperatly because we want to limit the size.
.\TS_GetEvents.ps1 -EventLogNames "Security" -Days 14


# SIG # Begin signature block
# MIInlQYJKoZIhvcNAQcCoIInhjCCJ4ICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBZ4lUhUagywTag
# nOSFNFbGp4fmE9QplVLUzyqr+qyOAaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOKssJRbnZUqcext/ZFsTYbB
# KrJ5GmqpvKkIdpW3QCnCMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQBR6OZNY1nN4XxaeBIhUDNyr3PuWyeK16/xyrRTkziH+oLHYEkJrQD0
# I9O7FgapImIU86Pdppygu2s8dZodRSRNuFTuRh7AXWLJQkm2+ZuKp0trkoQ5RLPO
# NHIhRAiLjLV8u/rUj9KpGjWQFKA1QMPzWZevF3Pp0iAFjFPqb3IfjkKPBRvkAj2m
# d0yFnfXWMStkRTFzeWmEFi6vuhlkaioTmXixTB0+tQ2crRme/WWq/N1n/t4HkcP9
# pD3PbB7UYqP44MgA9lRYx1oqTX07UAYYJxL0rZrpIdJbvd4R1p/6OyEHu7ZXq9EX
# F2hjNa2E/2KKbsdr8ttoVELvIRh0WQ0OoYIW/TCCFvkGCisGAQQBgjcDAwExghbp
# MIIW5QYJKoZIhvcNAQcCoIIW1jCCFtICAQMxDzANBglghkgBZQMEAgEFADCCAVEG
# CyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIFuaxc3O9Qdds9+vEDvvDdwp5SCGFSG1gySCAMhwvmgyAgZi1+uY
# PwMYEzIwMjIwODAxMDc1MDEzLjM2NFowBIACAfSggdCkgc0wgcoxCzAJBgNVBAYT
...
# 9w0BCQQxIgQg7NlseHVdX1mr9dNITA+05Urf9JhonM7PSLgq5aHDeiswgfoGCyqG
...
# R46ykrvfMA0GCSqGSIb3DQEBCwUABIICAJK3B4itT30MmE8XuGsZmE1R1gwlkyYY
# 1ndRn+NlClFGLjWrTDC9s2b1EqZ8cqW2x+kNME3dbRFHM+FgayO34+aT59yYAT2g
# X8/CXox4FQv1lQza0g3XelX76BCI/F0sjNbOKVOVcmqL6si9PPZz1fYKCc3I3LwF
# 8xEw0/VB4GvMizXXf7oXf6LxSSPB18QX7L56I9n98qgHqdB+s/ZOC7rVIsZ7GZA2
# MiiJwzkT8U/bThy7F3MdAZGtGybRNwIoxedDJVsWLzEOiPvwry+xk3q1iDrx0IIw
# 6sxEho3XkaGUrA6U8zrbIj8HX+pfu41wKgVDt9y39hQyFPpDFdpIvFsFGgmR795f
# nYoxSjMUZoKY6sTfSn9QyMgPYrHNrzGUMZm8VuLDOxsK4wIiyY/+3LKVNLFn/Nb8
# xS1uIUhdvrEJHCE2poPwY3j4mJlCO/7WeKDs4EK6H2IeGc8HLhL8thAe/wBxU6md
# 0XnBYUvN2hJBKKuCUWmU0ELYRiw2nVCiuXPLJls5buh05rTfp6U55x6s5Fenw0hI
# t92tNKDwBLEyWvrfwi09ekwqEwWbIaghjAdHb5cI6W/ZmbGoSl/SdC5x42vuaksE
# kDvzPIbgTPhMHpgRf+Wuz+nxUmtOyiQGcV/RDCaqwmcsDQx+RPzOWVDlcUta5Pgl
# V/RS4OgtyZAy
