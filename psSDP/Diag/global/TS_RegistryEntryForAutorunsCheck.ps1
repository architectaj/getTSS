#************************************************
# TS_RegistryEntryForAutorunsCheck.ps1
# Version 1.0.1
# Date: 10/25/2012
# Author: v-alyao
# Description:  [Idea ID 5194] [Windows] Unable to install vcredist_x86.exe with message (Required file install.ini not found. Setup will now exit)
# Rule number:  5194
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=5194
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 5194

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_RegistryEntryForAutorunsCheck"
...
Function AppliesToSystem
{
	...
	return ((($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 0)) -or #Windows Server 2008 / Vista
			   (($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 1)) -or #Win 7/Windows Server 2008 R2
			   (($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 2)) -or  #Win 8
			    ($OSVersion.Major -eq 10))
}

Function CheckIniFileMappingReg()
{
	$IniFileMappingPath="HKLM:\Software\Microsoft\Windows NT\CurrentVersion\IniFileMapping"
	if(Test-Path -Path $IniFileMappingPath)
	{
		$DefaultValue = (Get-ItemProperty($IniFileMappingPath)).'(default)'
		if($DefaultValue -eq '@SYS:DoesNotExist')
		{
			$InformationCollected | add-member -membertype noteproperty -name "Registry Value Name" -value ($IniFileMappingPath + '\(default)')
			$InformationCollected | add-member -membertype noteproperty -name "Registry Value Data" -value '@SYS:DoesNotExist'
			return $true
		}
	}
	return $false
...
{
	$RuleApplicable = $true
	$RootCauseDetected = CheckIniFileMappingReg	
}	
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB4P9ya18N9Nc5D
# Dhcnw5D7eDgfIePaUv3ZDhHiSaP9qKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgv1T1n2/D
# zXFaISgaVTpSIa/ECfD9B5FrOTByVvN0zZAwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAFdaPuLEowYTN6Ntb0i3tM9p2Bo7ZnPSEkWZG3cBOyJQtrx79bngU3Kp
# zdBNA74K/t+cnTY1nLhwk0Hy7rT4tPtOCFSEl3yHYlLsWzIKLn+kr2QWTJ9UU4mK
# kc6fRn2EdA2dMxzWYdLvP5JFtLoNa9C9rlPnbyrowyEgT2F5kOL866x72UtRFSLY
# SWCxJYp0kUqQVtCobSoIKzz2M3FcY19e17smSMrjiI+5jm/crpAD6SCzP4OHnb3J
# phxyFFyG2gFYNcNYSY0vT7r5L4sKcmiERC8+AJaPHTUVZX83mam7D6xJSocGoktf
# TUer52bFOmhconEKev2AIOZk/3jGtaOhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgJQ72ij6VUEbge4qW/TjIwoLZyDYhRVRoRm2f2noHSDECBmGCBVHy
# thgTMjAyMTExMTExNjUzMzQuNDI1WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBI/Q4w
# hacn7oPF6egdbBNsW61e7ixR3lLjj6FWntvMnzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAjihvRGywteJ28VGn2UTz4UDvu3HUmFVE4n7K7hjBieDNLLbZ
# 8gCXDe+1rt7OTMQnjwhq3P1eiXw8ejAkWjvhnBgz0cw8S9kEp0u11jVvixCaRgnR
# V4CN6Io5y7bafK/4eVNXL4SXV0+iqixEeXfT13+FSvzvdu+qX+A8m5esezkezxMQ
# l+V5M2ea9ZytPoHsuV6vhpl1ffj8DyGDi8VkR+CZWx45sOOHIlNuDjtzlCC9jt+F
# 9Y5a0J7VJhdE+4aDDfBQ9S+j7O64M/lN/9JB3H1vp964maeWM3G/yRpL3awd5OFV
# fsTnEFlIBhBWbgt1ST61QU+N+uFU83NX0XNuiQ==
