...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSP2P -Status $ScriptVariable.ID_CTSP2PDescription


function RunNetSH ([string]$NetSHCommandToExecute="")
{
	Write-DiagProgress -Activity $ScriptVariable.ID_CTSP2P -Status "netsh $NetSHCommandToExecute"
...
{
	#----------Netsh
	$OutputFile = $ComputerName + "_P2P_netsh_output.TXT"
	$sectionDescription = "P2P"
	RunNetSH -NetSHCommandToExecute "p2p collab contact show contacts"
	RunNetSH -NetSHCommandToExecute "p2p idmgr show groups ALL"
	RunNetSH -NetSHCommandToExecute "p2p idmgr show identities ALL"
	RunNetSH -NetSHCommandToExecute "p2p idmgr show statistics"
	RunNetSH -NetSHCommandToExecute "p2p pnrp cloud show list"
	RunNetSH -NetSHCommandToExecute "p2p pnrp cloud show names"
	# RunNetSH -NetSHCommandToExecute "p2p pnrp cloud show pnrpmode"
	# RunNetSH -NetSHCommandToExecute "p2p pnrp cloud show seed"
	RunNetSH -NetSHCommandToExecute "p2p pnrp cloud show statistics"
	RunNetSH -NetSHCommandToExecute "p2p pnrp peer show machinename"
	RunNetSH -NetSHCommandToExecute "p2p pnrp peer show registration"
	CollectFiles -filesToCollect $OutputFile -fileDescription "P2P netsh output" -SectionDescription $sectionDescription

	#----------Registry
	$OutputFile= $Computername + "_P2P_reg_output.TXT"
	$CurrentVersionKeys =	"HKLM\SYSTEM\CurrentControlSet\services\p2pimsvc",
							"HKLM\SYSTEM\CurrentControlSet\services\p2psvc"
	RegQuery -RegistryKeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "P2P registry output" -SectionDescription $sectionDescription
}

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD/kyDxxDjka063
# AEOmSJpwe6ksH5tcNoeCMJbNkrWPLKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgzEHuflHU
# 5fHeJ2YkwY4eEYG4eZveZNAbS10/3in3BQ4wOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAINIqXAp46fg2ezLw0wmNhn9B3zPnqrM+XdWZrjgVKoh5ib0gDkxxOGu
# FZjOn40vfbJ8X0HjBQSU5DEBPFLMm+byJMhMmB5xs94d/YZet4hbhO5/zob2Rx8R
# iY/B5yCcMOZH77DPtsDauePzuWkUWA7WJrLOoLsE2MACd/R6GPBDPb8oPfn6XshH
# i/fm7pAq33n0tcExrjK+PaFSIq0r+VPO6PmLf1B4l2JHk4aWZYg9Ici+8Mqwso9C
# bZasyySreEtrZWQTRIumH+69jgBktD4i7stVDVpANMI+OBWtDM70RIKTk6sslShI
# Vy7g8l7CQDuw/4Tl1eu7pZtMWpRnzJahghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQg2NNbvNHp9jWvGKSdcyaIMStC7ujYZUnKg0ysAFE2HNUCBmGB2SqX
# JxgTMjAyMTExMTExNjUzMzYuMjcxWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCApVZ0O
# 6he7Kvwkm23gMPLkoCSJMhRSP6Shp4VYsq7SmzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAnJQBtReJz/sQU8qdG2Jm0bV4eGdsc6R9GUvVVyVUQBCxsw2f
# qiBxleHik7FuytR5/4T+nXPMV/65ZmljRjBPs3vAEgcii6KXKAW7FaEC2Up7xqfB
# ygyXDPCQFnPB0C64xVCv5k7vIHGZGoOdvyo0ZdjJHEFavP6K1rQ6F3eIqPlSPDWn
# sdYRwqlYrGIgkHJYIbfaUw/Mgl/6UyLX6J+0z0z1r/37MfIv6cZ1lTh7quPMBsOT
# AocBk1gbYG+A0d/peR143C9TQhHQlEXWMmsBZOFvVG/51eXiaN4ErHlr/71o/q1/
# oVWe0IKzzZC6wdt0d8pZcOBf5jUWxwUA24lvwg==
