#************************************************
# TS_CitrixAppSenseCheck.ps1
# Version 1.0
# Date: 12-21-2011
# Author: v-anecho
# Description: Checking the presence of Citrix AppSense
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Write-DiagProgress -Activity $ScriptStrings.ID_CitrixAppSenseCheck -Status $ScriptStrings.ID_CitrixAppSenseCheckDesc

$RootCauseDetected = $false
$RootCauseName = "RC_CitrixAppSenseCheck"
$InternalURL = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=B;2687234" 
$SolutionDescription = $ScriptStrings.ID_CitrixAppSenseCheckRS

#Rule ID 2016
#-----------
# http://sharepoint/sites/rules/Rule%20Submissions/Windows_sudhan_2011-11-29T15_34_37.xml
#Description
#-----------
# Checking the presence of Citrix AppSense
#
#Related KB
#----------
#
...
#********************
	...
	Function Get-emdriver
	{	
		$services = Get-Service
		$emdriver = $services | Where-Object{($_.Name -eq "emdriver") -and ($_.Status -eq "Running")}
		if($emdriver)
		{
			return $true
		}
	...
	Function Get-RemoveForceLogoffFlag
	{	
		if(Test-Path "HKLM:\SOFTWARE\AppSense\Environment Manager")
		{
			return (Get-ItemProperty -Path "HKLM:\SOFTWARE\AppSense\Environment Manager").RemoveForceLogoffFlag
		}
		else
		{
			return $false
...
#********************
	...
	if ($RDSEnabled)
	{
		$RemoveForceLogoffFlag = Get-RemoveForceLogoffFlag
		$isEmdriver = Get-emdriver
		
		if (($isEmdriver) -and ($RemoveForceLogoffFlag -eq 1))
		{
			$HasIssue = $true		
		}
...
#********************
		...
		if($HasIssue)
		{
			...
			Write-GenericMessage -RootCauseId $RootCauseName -InternalContentURL $InternalURL -Verbosity "Warning" -Visibility 3 -SupportTopicsID 8113 -SolutionTitle $SolutionDescription
		}
		else
		{
			if($isEmdriver)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBUze5jf+AsBhwK
# 1eIdtMALxwXW8BltnDJVnZYZdAxzqqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKVsqFcbqY4Fn/hZ86k3mrco
# 3VP/pTy2kKusfQSVj9k8MEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA