...
if($debug -eq $true){[void]$shell.popup("Run DC_Repadmin.ps1")}
...
if ($ProductType -eq "LanmanNT") {
	Import-LocalizedData -BindingVariable RepadminStrings -FileName DC_Repadmin -UICulture en-us
	Write-DiagProgress -Activity $RepadminStrings.ID_Repadmin -Status $RepadminStrings.ID_RepadminObtaining
	if ($OSVersion.Build -ge 6001)
	{
		$RepadminPath = $Env:windir + "\system32\repadmin.exe"
	}
	else
	{
		$RepadminPath = Join-Path $PWD.Path "repadmin2k3.exe"
		
		if ((Test-Path $RepadminPath) -eq $false)
		{
			"[Error]: Windows Server 2003 repadmin2k3.exe is currently not present on the system. Please add a reference to include it on your diagnostic package" | WriteTo-ErrorDebugReport
		}
		
	}
	if (Test-Path $RepadminPath)
	{
		$SectionDescription = "Repadmin Output"
		$FileDescription = "Repadmin Showrepl"
		$OutputFile = $ComputerName + "_Repadmin-Showrepl.txt"
		$CommandLineToExecute = $Env:windir + "\system32\cmd.exe /c " + $RepadminPath + " /showrepl /verbose > $OutputFile"
		RunCmD -commandToRun $CommandLineToExecute -sectionDescription $SectionDescription -fileDescription $FileDescription -filesToCollect $OutputFile -useSystemDiagnosticsObject
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+sC75rGgrESkv
# 3hiwrHWbTT2Gz7ZGIm/+qT8xqcch4aCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIJpkedU4AExQUw6gkRPYW0q
# kUVmJYalMVKswDxoLM5SMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQBfEyX1AH2MFTUOu9PLqssn3G/xCf3OzjndYsdaX1XbQCeuRJplg2e8
# qIQYSQ4XUabZCwtuQewiliepgMndpiQenyb+2FfJJM/hT9NzoGEhDhb9Tregc4OD
# cJbJ4ANn4CYakrjxFmo58TzZ6oNb2h6eDDuaaI4s/5jTnaLG54EKWuPCke9ImgYT
# HTwCT6LPzPcb3Qc61yCS8Bu+KLHTaoVckme2O87+v9MaRj9gp4adtm2l7rEiHVNM
# AUqdGcQf2zplZ42F9KL9CvzCN5bTPt1AHplFsHf2XZ5QMqbtinjvt1wiXi1ojpHm
# 9CCgP+y1G7JZM9hICxcIU6wDUaMwZEZOoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEILBMH5TwCKO84WItkPMcJYnT/xPMT9hDKIQWALDNG275AgZi3ohP
# 7RMYEzIwMjIwODAxMDc1MDQ0LjAzM1owBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEINEs9igLbl8afMMAE3jM
# ZKntWjTjCVNBs9YqTTlThtJjMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgBlmq/c9o/ismWJa3qhyl0FwSWCEPfEKTQaNy75aJmr2Sw2Hj+C6wey2mUQBw9o
# csvAo1nTkh9eO3zy8zHOL5RadBX7F8BrGGvPKCj81fWd+ZbEZRqBvmVzuw2hrAwI
# JHFm8EQ5NrxjmL1iJPtPp8RUfzAEvaly8hIsPffWB7GGa3LFiEzLhN46lmeSS+uy
# xJF4UBkU5CsrmQuvrQVdVAnNJKEHvSFrDbewrdW8P3GgxZroipdFP23O45/jrs1P
# lKwyUhlMU1b2NM5VKv88jbUWR9XzmWEit5cxJ7Ap7EBYZmmA9b7/XQDt/P0fgbfg
# ywsGB89tfOEOqDMFyCEGg2Wm6o5bnJn9PkwIRO0yBCfZ8IlFOo1s+Y3otzDrXc00
# MnUUnpA/3m1az+wH9/g7J6ySEPf7EEOxnfK2xgp0IwU/GImOHIjg8TtMYJNl08k6
# YCMX/DhjYr43aUOLxoK5avrD37ooBNyA8EAs6htdj2kL+s8f6A8jU9mnwiVvEPpf
# +n43N5ZPRosMQ1DU9pNNS90ObVKXz4vanU3Iy3pkNMS3xYyenbgq8u8eokKOwYAA
# 4ZKZ6hPhVfevvbuM77sAjG6TkaAkx9f8lig7XJd0qESHMOiKm81jn1aLays3PPLg
# 2KTYLDnaQ1MdIWppLGHYUU63YUHbWMoCZTiiQxR2NhzyeQ==
