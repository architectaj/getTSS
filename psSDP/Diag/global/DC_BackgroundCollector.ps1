...
#************************************************
PARAM($process=$null, $filesToCollect=$null, $outputFiles=$null, [switch] $Remote)

Import-LocalizedData -BindingVariable BackgroundLocals -FileName DC_BackgroundCollector

$process.WaitForExit()

Write-DiagProgress -Activity $BackgroundLocals.ID_DPM_DPMDB_COLLECTOR

if ($Remote.IsPresent)
{
	CompressCollectFiles -filesToCollect $filesToCollect -DestinationFileName ($outputFiles + ".zip") -sectionDescription $BackgroundLocals.ID_DPM_DPMDB_REMOTE_SectDesc -fileDescription $BackgroundLocals.ID_DPM_DPMDB_REMOTE_FileDesc
} else {
	CompressCollectFiles -filesToCollect $filesToCollect -DestinationFileName ($outputFiles + ".zip") -sectionDescription $BackgroundLocals.ID_DPM_DPMDB -fileDescription $BackgroundLocals.ID_DPM_DPMDB_FILES
}

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAV/nCbYa8E6l+c
# cWTAv8w2VK2FvsSrYzKf70KhK3+/E6CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg6E12a619
# ErfyLnsWTdke/noWzJ2sp6zZbf4YJ1jaovUwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBABCUNj0KBkngwxBtBi6UtBAbznYtijQ+eF+5CJpKGqB9QDA3o5rdln7h
# q5HXn6caBloZcp4dYkrLON3cPbPQMQawQBUdPa0mexDA813lhhkUpCeSsuMeZiy+
# w/omb2RRutMw8feD8ApdCu5rq/VFU5hNRd/PJF6Sni6EeIjEklSg1XcMX3lA7Ad7
# SG6fW36WQu59cvAf8TOytGQmWRs/Rj3PvthrHN91UJT8Qi+Dp0MIyEOeBLqTIzfT
# tx/O/j3jKPC2ykPMD92txfW2AXhyU0EyOAuBCmSwLJp8Fh/dgYFl7hnZDk/A9eWh
# xFPlDCvZ83Z9DHAAPHf73zkGXK78LpShghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgQFbVisL1+0fCeT3OECVpgEQsvI+lSglkpKtMCxsPw5wCBmGB56/O
# mxgTMjAyMTExMTExNjUzMzYuMTc5WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAU3gyO
# eMSmBshbCr3peviIeWMtu2QmhqzKGtdduiEEQDCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAEhkZ9HmAUKQ5AsYHROVkCZphhSyaq5AZxtIwE5aFHEz5x50x
# prtZLlYT5Sb1mlmDjXtHncYgRpGZ56BFRKdPtaervKpAHOsIIj0+k8hR5D9LeY8n
# zheJALd4zXFGK5ou3v1MXKTTRo2dD4NMXwEtMlm5L50X5NBglLKHwoQhoMhYPA9M
# JmOal/E72w8Kw2y4oBR9gd1AOsTsmux+5ty0juGdQaT2ZqZ0CYMfVveiUTPfBxto
# FUqZr9xc/RJsbiS27DoL+y9mXV7TyCF0PpIHwn08aTyiS7git41RewCBZg5QxcfG
# QHxlxBVJsCa/B1Jau0pml1CObBKs+PIy9SYzEg==
