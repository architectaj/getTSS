#************************************************
# TS_SBSLClearPageFileAtShutdown.ps1
# Version 1.0.1
# Date: 5/21/2012
# Author: v-blchen
# Description:  [Idea ID 3989] [Windows] STACK MATCH - Win2008R2 - Machine hangs after shutdown, caused by ClearPageFileAtShutdown setting
# Rule number:  3989
# Rule URL:  //sharepoint/sites/rules/Rule%20Submissions/Forms/DispForm.aspx?ID=3989
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 3989

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_SBSLClearPageFileAtShutdown"
$PublicContent = ""
$InternalContent = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=B;EN-US;2600881"
$Verbosity = "Warning"
$Visibility = "3"
$SupportTopicsID = "8125"
$InformationCollected = new-object PSObject
$Script:ClearPageFileAtShutdown =0
# ***************************
# Data Gathering
# ***************************
...
# Detection Logic
# **************
#check whether the rule of ClearPageFileAtShutdown is Applicable
function CheckClearPageFileAtShutdownApplicable
{
	if    ((($OSVersion.Major -eq 5) -and ($OSVersion.Minor -eq 1)) -or #XP
		   ...
		   (($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 2)) -or  #Win 8
...
# check whether the ClearPageFileAtShutdownEnable value is set to 1
function CheckIsClearPageFileAtShutdownEnable
{
	$ClearPageFileAtShutdownEnabled = $false
	$Path = 'HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management'
	if(Test-Path -Path $Path)
	{
		$Script:ClearPageFileAtShutdown = (Get-ItemProperty -Path $Path).ClearPageFileAtShutdown
		if(($null -ne $ClearPageFileAtShutdown) -and ($ClearPageFileAtShutdown -eq 1))
		{
			$ClearPageFileAtShutdownEnabled = $true
		}
	}
	return $ClearPageFileAtShutdownEnabled
}


#Check to see if rule is applicable to this computer
if (CheckClearPageFileAtShutdownApplicable)
{
	$RuleApplicable = $true
	...
	if ($RuleApplicable)
	{
		$RootCauseDetected = CheckIsClearPageFileAtShutdownEnable
	}
}	
...
if ($RuleApplicable)
{
	...
	{
		#collect Current value of ClearPageFileAtShutdown 
		add-member -inputobject $InformationCollected -membertype noteproperty -name "Current value of ClearPageFileAtShutdown" -value $Script:ClearPageFileAtShutdown

		# Red/ Yellow Light
		Update-DiagRootCause -id $RootCauseName -Detected $true
		Write-GenericMessage -RootCauseId $RootCauseName -InternalContentURL $InternalContent -InformationCollected $InformationCollected -Verbosity $Verbosity -Visibility $Visibility -SupportTopicsID $SupportTopicsID -SolutionTitle $ScriptStrings.ID_SBSLClearPageFileAtShutdown_SD -MessageVersion 2
	}
	else
	{
		# Green Light
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDKq0igAEuh/frs
# rifvY/xkrRqL1CdZRe4g3trK4iYdEaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEI