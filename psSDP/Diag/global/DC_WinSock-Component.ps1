...
# Description: Collects information about WinSock.
...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSWinSock -Status $ScriptVariable.ID_CTSWinSockDescription
...
{
	Write-DiagProgress -Activity $ScriptVariable.ID_CTSWinSock -Status "netsh $NetSHCommandToExecute"
...
$sectionDescription = "WinSock"

#----------Netsh
$OutputFile = $ComputerName + "_WinSock_netsh.TXT"
"===================================================="	| Out-File -FilePath $OutputFile -append
"WinSock Netsh Output"									| Out-File -FilePath $OutputFile -append
"===================================================="	| Out-File -FilePath $OutputFile -append
"Overview" 												| Out-File -FilePath $OutputFile -append
"----------------------------------------------------"	| Out-File -FilePath $OutputFile -append
"   1. netsh winsock show autotuning"					| Out-File -FilePath $OutputFile -append
"   2. netsh winsock show catalog"						| Out-File -FilePath $OutputFile -append
"===================================================="	| Out-File -FilePath $OutputFile -append
"`n`n`n`n`n"											| Out-File -FilePath $OutputFile -append
RunNetSH "winsock show autotuning"
RunNetSH "winsock show catalog"
CollectFiles -filesToCollect $OutputFile -fileDescription "Winsock netsh output" -SectionDescription $sectionDescription

#----------Registry
$OutputFile= $Computername + "_WinSock_reg_.TXT"
$sectionDescription = "WinSock"
$CurrentVersionKeys =	"HKLM\SYSTEM\CurrentControlSet\services\AFD",
						"HKLM\SYSTEM\CurrentControlSet\services\WinSock", 
						"HKLM\SYSTEM\CurrentControlSet\services\WinSock2"
RegQuery -RegistryKeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "Winsock registry output" -SectionDescription $sectionDescription

#WS2008+
if ($bn -gt 6000)
{
	#----------Winsock EventLogs
	$sectionDescription = "WinSock EventLogs"
	#Winsock Catalog Change
	$EventLogNames = "Microsoft-Windows-Winsock-WS2HELP/Operational"
	$Prefix = ""
	$Suffix = "_evt_"
	...
	$EventLogNames = "Microsoft-Windows-Winsock-AFD/Operational"
	$Prefix = ""
	$Suffix = "_evt_"
	.\TS_GetEvents.ps1 -EventLogNames $EventLogNames -SectionDescription $sectionDescription -Prefix $Prefix -Suffix $Suffix
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBwzyi6JIdAJyZN
# YvU+WTz98Gz0nuxhjDZj9BJvKweqcKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINkYfTQ3rg06/hzSh7tzJAs1
# FBurxjLCiqqgSQyH0QbWMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA