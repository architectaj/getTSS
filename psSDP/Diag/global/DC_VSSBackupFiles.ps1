#Collect files for VSSBackup package
...
$filesDescription = "WSB Log files and UI ETL files"
$DestinationfileName = $computername + "_WSB_ETL.zip"

#CollectFiles -filesToCollect $filesToCollect -fileDescription $filesDescription -sectionDescription "WSB Log files and UI ETL files" -renameOutput $true

CompressCollectFiles -filesToCollect $filesToCollect -fileDescription $filesDescription -sectionDescription "WSB Log files and UI ETL files" -destinationfilename $DestinationfileName -renameOutput $true

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCfpQOvZHVN1B39
# 8zFIBMZeCRAwM69S+SBN8wpZZ2D9EKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgHOgywc/l
# wpaB5y97Vde4LC+hPfPfiwehbaMKgcfQ8/UwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBADgS8i24/20hX/LxHaJozegnzAH6OettnbYsWJU8QFmLAqlmjwmNJ5K2
# qER04piZjB7tafTxSm/0HOTbIb1PeyIIQzMqdtXgqX1X2HKsvb7QzKrNStBlNNIu
# gf+zeUknS1fLjHkDMFCxr+2ujnnJ080XkM6nlAmzPAd5frqSk6a4N3tQFxmqioNw
# Wagv3+kOz9VgklIBSYJFSP/PWqAyl5NYqFRu9sX/EibwSuVgm/xTc5SUilOKcx86
# FawcnZqjQqd2mHbSzLHiWz12YPYbLf6zmSA+gRM/WEtn+5TfYS3BkW3BJ6TWB9je
# 4ncVLHcFOBWNrLuVLvJ/C9+HaRFIB8uhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQg8J79h7GP2Xo4mi4tmO5tvRfvN/7Xk2C9WYbUth/OaJECBmGB81FC
# exgTMjAyMTExMTExNjUzMzQuMjczWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDXdXYo
# kL/XiaWMJmmd6YkUkOTBL+9z2KcrXh8Iye3eOzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEALTdrcxP1p+T3riDVTfQXcizvBiV90UW1SuXLaHjqnIrrprEq
# qswK2OUDYDc9bUI2hP4oxf/y8WfznQW4Y3qcqSYtJ+BK6DNAp4JQD/QeHz3Fh1mT
# Moe9S8+yRBFk9BZGSzAwgDYCeWa6DYDcHSLj0Bqmk6prTJHbpv7f430Y+JCwoFnT
# DpsuiCBxUSEc9yqvIuSwqbvWpvnqTZZZkIKu9Qrlg1bbSOkeYx2tKH+5TkD/iWbF
# kF+wm48AEiDb5DIUg22jd7htboKDwbs4MzpwLT5IhkCfvOTEqpovX+H/tO8juvWs
# hOm80PjSw9PwrQemJppgAVBItOZVfTctd70udQ==
