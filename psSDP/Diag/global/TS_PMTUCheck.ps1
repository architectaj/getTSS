...
# Date: 03-27-2011
# Author: anecho
# Description:  This script checks if the Path Maximum Unit Transmission is disabled on network TCP
#************************************************

Import-LocalizedData -BindingVariable PMTUCheck
Write-DiagProgress -Activity $PMTUCheck.ID_PMTUCheck -Status $PMTUCheck.ID_PMTUCheckDesc

$RootCauseDetected = $false
$RootCauseName = "RC_PMTUCheck"
$InternalContent = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=KB;EN-US;2218209"

#Rule ID 884
#-----------
# http://sharepoint/sites/rules/Rule%20Submissions/Windows%20-%20Identifying%20the%20PMTU%20discovery%20status.xml
#
#Description
#-----------
# If the Path Maximum Unit Transmission is disabled on network TCP will send packets of MTU 576 bytes or smaller.
#	Network comunication may be slower if PMTU is disabled, causing slowness in file copy, data replication etc.
#	It is recommended to enable PMTU Discovery if the path supports an MTU size larger than 576.  
#
#	There are 2 ways to identify if PMTU discovery is disabled.
#		-Dword EnablePMTUDiscovery will be set to 0. This dword is located at HKLM\System\CurrentControlSetting\TcpIp\Parameters . 
#		-All packets in TCP session will be 576 bytes or smaller than 576 bytes.
#
#
...
#********************
	...
	Function Get-TCPIP-RegValue($Name)
	{
		#
		#	.SYNOPSIS
		...
		return (Get-ItemProperty -Path $keyPath).$Name
...
#********************
	...
	#Check if EnablePMTUDiscovery is zero
	
	if ((Get-TCPIP-RegValue -Name "EnablePMTUDiscovery") -eq 0)
	{		
		$HasIssue = $true		
	}
	else
...
if($HasIssue)
{
	...
	Write-GenericMessage -RootCauseId $RootCauseName -InternalContentURL $InternalContent -Verbosity "Error" -Visibility 3
}
else
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCARig0DkneQVGp6
# +RPJjdpVIaxhlTuV+4c7ptFIGB1GDKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgk9NkB6DW
# UwfTp3JcO94iN2LMIXSDS+GQO8PVuEo5UQEwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBALR0TvEDIV3vC2ivfp+ZPPi4zooqgZUMBIiMNKM2+w8jrxjCF+xCP1zm
# EHAT0+RVB1Bv5dJeXqr3at3654Iv7P5kjNFt/qXSd0ZRr3YQ8Doe5K7jw3Z/fCEA
# vVofOO3xW+vHLaAOhKDnZ/RVeHIPiosmzcqWhMRxPAL1MQcwJywtYN3oTqN3ztkW
# XGRQ3oqddrw/JNL5HA8RIe50zrmUpMyqWBO3q/xebhTg7bBaQSXDCz9Zb3xuDpHz
# f46BaoUFCu0ivv1N6/uKALjYKSpa3Q6EFrmtwg7Kp3MBBGcIs8nHA2T2HkncSjwO
# eU045X0Va0iHt+JN7d1FY3wEw97o8dehghL+MIIS+gYKKwYBBAGCNwMDATGCEuow
...
# ZQMEAgEFAAQgdIQKNlmVc8qzJplK9KAFWtPmBVyZYDteUfPb6BbbzDICBmGDCPNZ
# ehgTMjAyMTExMTExNjUzMzIuMTA4WjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMC
...
# 9w0BCQQxIgQgau0diyv+jfSvYsLQmUQOWqZ+BI/CzH0D4K3w2I+4j1IwgfoGCyqG
...
# WRAMxNnzMA0GCSqGSIb3DQEBCwUABIIBADfQHDBfjZ66pmvG6JGZ+8CYJPbER9kW
# /OBaLkIl4il1YX9TCkIeKGSzFJbgzvazec9JNamEji+RMLRlc+5gWrsqsD52UVI9
# qkLHJMlUjJeEEQwt93mvSy2uqATsdZarmnkOVuokWzysbrIgL7WoeKvxcBQCS+zM
# gq1/e0lZUyWtJKwbwJrfDogrSswZwodQJgmRveyLdMEGci+PuabX4tp+nRNyZOPi
# ldhTXJrfP65OyV9/Ce6fUL80PZs68EMLWR5/QoQiReszmHOydnA+zEq7FjJynTFr
# GgHB8v9p5lwZhWBxeVHX5DFDh+JDO6hvln2HYqYBnX0wVMcSpwY149M=
