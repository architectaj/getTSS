...
<# #we#		
				...
				{
					"[ToDo:] Snip-- TroubleshootingVMNames / VMs configured to replicate -- to avoid hang -aka- skipHVreplica " | WriteTo-StdOut
					do
					{
					...
					foreach ($vm in $TroubleshootingVMNames)
					{
						...
						$clusterNodes = @()
						$clusterNodes = (Get-CimInstance -Query "select * from mscluster_nodetoactivegroup" -namespace "root\mscluster" -computername $vmReplication.PrimaryServer -ErrorAction SilentlyContinue).PSComputername
						...
						$clusterNodes = @()
						$clusterNodes = (Get-CimInstance -Query "select * from mscluster_nodetoactivegroup" -namespace "root\mscluster" -computername $vmReplication.ReplicaServer -ErrorAction SilentlyContinue).PSComputername
						if ($clusterNodes.Count -gt 0)
						{
							$arrHostNames += $clusterNodes
						}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCHYhZNjqBcFVvL
# 67zp0vX/KjQi3/8gO+oLQ12nJRHVAKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDV4t94slDHw5YdtTAvABfak
# epM1xFMHY+UXxzwb/V3dMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQA9g2qI23j2tv+gyZtYcsTdG+1QFZjLVbKkhYojDEACQz4uqGt0dY3v
# 6pLPGiSqq8l/+5I47arUG9vhcv8j96Asq3zr9g0ZIEyOm8x9O9NnmiGbowS/l7bH
# JB5ajSB+19NBKexH05qP1zAsLVrPnqnycMcFi1Zkqs2WY4fBGg5Os6SIQwTSV/1x
# K7q0THTG8YPAkoSZeytcip1nM6mXW6Rq+lO165euXsPXIQePAazoaKlymg9I6D8R
# ope046xc03kqi7Papj9tQBQTQ/eqpSVOcrxv5f2uUzZC+15d2oybRQlX511GEM5b
# QKNTHyoTmKhw0ShDznrgrK3BciUXrolFoYIXFjCCFxIGCisGAQQBgjcDAwExghcC
# MIIW/gYJKoZIhvcNAQcCoIIW7zCCFusCAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIB2h3PqoJaRTHv0xV8MooSL57wrsYUDdUsWaipbjx3rZAgZi3ohP
# 5UwYEzIwMjIwODAxMDc0MDQyLjk4MVowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# CQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEINTr+N/lX2IxWmrVpErY
# JpK73RC7gn9ukzMdBWYSTgthMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg
...
# AgCQQtIefrYwcfZLFnfLgYugr/kD+fw6nqSn1k9orutcQsRmKtD1fCw5LzvRf54i
# 30NhMJOCtArW7n2ZBYunmNYIg/s2fuMF2QV+3BSavTGKuOaQx8lMR9QZAavEsdwv
# i7u1TwUZecLc2dGXV5SdZ95cW3lf8xx94kr7cv6rChW/+RlsQuB2AY6xdEMCnlbY
# qXic5CVQP5NAFR1ht3yVIW5UcH4tr80E+iDrtCgkTyUU8/Vdtf4ct5QLY3BjKV7P
# +o5HA4AWUuXol+2N8lvQh9YJCZ5pWQyjHkE+NY8Ae/2op1aUxEn7i7Ttr0clsuqu
# 1ArRhPU0MalR6MIiLi4amlo6dFJz1iy4H9DQg3zNHPoFrv4Ilgp6upHB/IQ7OwY9
# 9I9WPigNw4U5UOZeQsQQVkeBRN9y6R7UrhJc2I1WcroNXFAW259mIDPbasCebJNs
# IYSem0QMKvnQlRPf1SX45rVaXXntp+t7iW+MjkQj57WypjgJgrlWYsnU9g6GtTCG
# +cvhi+4cjxU+MKOdVc6kUClrjG2UNrLt68cydCzX/Gk8sQYDjY9Zfgu0HNoE9Pd4
# rjUol/CCthb2/zLm7n4x0poQGtjbUm3yuQbM+aHenyRLpLUFDrBHTP9ALYvYzQfX
# kBTJecJ04lF8jQIL1BjKhvGgYag+cO+IPDTCUGuK7JoDYg==
