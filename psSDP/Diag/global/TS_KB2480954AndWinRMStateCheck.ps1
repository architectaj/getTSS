#************************************************
# TS_KB2480954AndWinRMStateCheck.ps1
# Version 1.0.1
# Date: 7/16/2013
# Author: v-kaw
# Description:  Check if hotfix 2480954 installed
# Rule number:  
# Rule URL:  
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_KB2480954AndWinRMStateCheck"
...
{
	#windows vista and Win server 2008 
	return ($OSVersion.Build -eq 6002)
}
...
Function CheckKB2480954AndWinRMServiceState
{
	#CHECK BINARY VERSION
	$WSManHTTPConfigBinary = Join-Path $Env:windir "System32\WSManHTTPConfig.exe"
	if(Test-Path $WSManHTTPConfigBinary)
	{
		if( -not(CheckMinimalFileVersion $WSManHTTPConfigBinary 6 0 6002 22544))
		{
			$WinRMService = Get-CimInstance -Class Win32_Service | Where-Object {$_.Name -eq "WinRM"}
			if($null -ne $WinRMService)
			{
				#Check service state
				if(($WinRMService.StartMode -eq "Auto") -and ($WinRMService.State -eq "Stopped") -and ($WinRMService.ExitCode -ne 0))
				{
					$WSManHTTPConfigCurrentVersion = Get-FileVersionString $WSManHTTPConfigBinary
					add-member -inputobject $InformationCollected -membertype noteproperty -name "WSManHTTPConfig.exe current version" -value $WSManHTTPConfigCurrentVersion
					add-member -inputobject $InformationCollected -membertype noteproperty -name "WSManHTTPConfig.exe required version" -value "6.0.6002.22544"
					add-member -inputobject $InformationCollected -membertype noteproperty -name "WinRM Service StartMode" -value $WinRMService.StartMode
					add-member -inputobject $InformationCollected -membertype noteproperty -name "WinRM Service State" -value $WinRMService.State
					add-member -inputobject $InformationCollected -membertype noteproperty -name "WinRM Service Exit Code" -value $WinRMService.ExitCode
					return $true
				}
			}
		}
...
if (AppliesToSystem)
{
	...
	if (CheckKB2480954AndWinRMServiceState)
	{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAZs+DN/30vJc9r
# q9DgwBMONsucCXU8JvCg3pKC8Q3Ts6CCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEiepfN+0fSwKdH9J4HkGco4
# T92Q688q+0xzGI2YkE6rMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA