...
# Rule number:  2882
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=2882
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 2882

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_IntersiteMessagingStateCheck"
$PublicContent = "http://technet.microsoft.com/en-us/library/cc755994(v=WS.10).aspx#w2k3tr_repto_how_imft"
$InternalContent = ""
$Verbosity = "Warning"
$Visibility = "4"
$SupportTopicsID = "8038"
$Title = $ScriptStrings.ID_IntersiteMessagingStateCheck_ST
...
Function AppliesToSystem
{
	...
	return (
	        (
	         ...
	         (($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 1)) -or   # Windows 2008 R2,
			 (($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 2)) -or   # Windows Server 2012
			  ($OSVersion.Major -eq 10)
		    ) -and (IsDomainController) )                                  # Domain Controller
}
...
{
    if(CheckIsmServState)
	{
	    Add-member -InputObject $InformationCollected -membertype noteproperty -name "Service Name" -value $Service.Name
		Add-member -InputObject $InformationCollected -membertype noteproperty -name "Current State" -value $Service.State
		Add-member -InputObject $InformationCollected -membertype noteproperty -name "Startup Type" -value $Service.StartMode
	    return $true
	}
}
...
# Detection Logic
# **************
Function CheckIsmServState()
{
    $Script:Service = Get-CimInstance -Class Win32_service  -Namespace "root\CIMV2" -Filter "Name='IsmServ'"
    if($Service.State -eq 'Stopped') #Check if the 'Intersite Messaging' (IsmServ) is stopped
	{
	    return $true
	}
	return $false
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAX8qDgNhaGEGsw
# pu+kTlXnJkKwnk7pBXfkxxFr0RUZ1qCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgrBz3Js3r
# Xgk4aqsr7AWBKuXS21UEwNOi5eh4fJ9PRXcwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBABVeEz74XKNShx7YIRo/9zF1yiCj7mr2cYR36+wBOtLk1Wy9b1ikYTij
# TqQSFAun1NKbjoeFfkUKQlDgcZLUIapTID6i2Qjq/OYJvNliVfiJ5p2Mum2KPp8g
# KbB3E6Xk6otoEpSD/J+hJWEwf4w0VoMZyddIpBm4oVQxe+AJBpU9ZpMBZLNz5PFl
# 9Ahd0fIvqbh94lnES1ljr6mMEF2Qjua/RJvGp4/dzP5GFcEI1xlef3UdKZq4u7vR
# /vM6K6gb7BSg/oVYoXPzIaY4XxVvyh/rbfuX1aQOjJDDtnLwnNboqoULPWTWOw1x
# 5AX3v7QFdxzeLDxWgky/3Pvublxl5aahghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgLWR9wLYEj3SMNSY6GkwlJO5Z/SJji7qvxj+IQPuOJA4CBmGB56/O
# gxgTMjAyMTExMTExNjUzMzQuMDg4WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCD46J33
# brci2lNmI7qJrsRQLGl1zOgolYWUbORlUyPlcjCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAh4HWYx23Cq6mwGZBUleKvPItJ7G89n+ertbBthNAA7oBSxy8
# clNFC3+nnm/ezzAlZdg7vJeILVCn4O5jucpbi0XbkUMIOMHbxkqZfhaATneTtZLk
# 36q6E8r6vUJwzJ9CFwQSGvdxQEBsy9D8IP9piMspYtecoBA6sVBK2+81bSvHmmdV
# kteW18ze8tp565nYlShiWOtF82S96RyEvuWh+WlUeTyCKzCPZWqmpv5GC3l0Y9wO
# RNPbDU0z5wigPcZjolI1OrIXHIw+DV2Lz83zoIUSWRX+jtpakdu4rAUkYsg2xJ78
# QX2Oc3Mdny8y7Mri64HHEgTxgKmNWUBs+6GUsg==
