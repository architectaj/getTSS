#************************************************
# TS_XTENonPagedPoolCheck.ps1
# Version 1.0.1
# Date: 6/8/2012
# Author: v-maam
# Description:  [Idea ID 2357] [Windows] the usage of NPP is very large for XTE.exe
# Rule number:  2357
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=2357
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 2357

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_XTENonPagedPoolCheck"
$PublicContent = "http://support.microsoft.com/kb/936655"
$InternalContent = ""
$Verbosity = "Error"
$Visibility = "4"
$SupportTopicsID = "8113"
$Title = $ScriptStrings.ID_XTENonPagedPoolCheck_ST
...
Function AppliesToSystem
{
	...
	{
		$Script:XTEProcess = Get-Process | Where-Object {$_.Name -eq "xte"} | Select-Object -First 1
		if($null -ne $Script:XTEProcess)	#Xte process is running
		{
			return $true
		}
		else
...
{	
	$RuleApplicable = $true
	$AfdfilePath = "$Env:windir\system32\drivers\Afd.sys"
	$PoolNonpagedInfo = New-Object System.Diagnostics.PerformanceCounter("Process", "Pool Nonpaged Bytes", "Xte")
	$PoolNonpageMemory = $PoolNonpagedInfo.NextValue()
	
	if((-not(CheckMinimalFileVersion $AfdfilePath 5 2 3790 4072 )) -and ($PoolNonpageMemory -gt 200MB))
	{
		$RootCauseDetected = $true
		$currentVersion = Get-FileVersionString($AfdfilePath)
		$requiredVersion = "5.2.3790.4072"
		$InformationCollected | add-member -membertype noteproperty -name "XTE.exe Process Path" -value $Script:XTEProcess.Path
		$InformationCollected | add-member -membertype noteproperty -name "Current Pool NonPaged usage" -value (FormatBytes -bytes $PoolNonpageMemory -precision 1)
		$InformationCollected | add-member -membertype noteproperty -name "AFD.sys Current version" -value $currentVersion
		$InformationCollected | add-member -membertype noteproperty -name "AFD.sys Required version" -value $requiredVersion
	}
}	
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBN1sw1ZI9LTHWH
# ctltvwvQ6zKIsp/Y/wQtVgJeAz9jYqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPvlN3iWmeDh8jJkiTyr7KWH
# IA0q/kvD+zhK4eYIjpqXMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA