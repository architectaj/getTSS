...
# Rule number:  3253
# Rule URL:  http://sharepoint/sites/rules/Rule Submissions/Forms/DispForm.aspx?ID=3253
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 3253

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_WindowsSearchLenovoRapidBootCheck"
$PublicContent = ""
$InternalContent = "https://vkbexternal.partners.extranet.microsoft.com/VKBWebService/ViewContent.aspx?scid=B;EN-US;2721389"
$Verbosity = "Warning"
$Visibility = "3"
$SupportTopicsID = "8033"
$Title = $ScriptStrings.ID_WindowsSearchLenovoRapidBootCheck_ST
...
Function AppliesToSystem
{
	...
	if((($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 0)) -or #Win Vista/Server 2008
		(($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 1))) #Win 7/Server 2008 R2
	{
		$Script:HyperW7Svc64 = Get-Process|Where-Object  {$_.ProcessName -eq "HyperW7Svc64"}|Select-Object -First 1
		return ($null -ne $Script:HyperW7Svc64)
	}
	return $false
}

# Check if HyperW7Svc64.exe is one of the running process
# If so, check the state of the Windows Search Service (wsearch). If it stopped, fire the rule
Function CheckSearchService()
{
	$windowsSearchService=Get-CimInstance -Class Win32_Service -Filter "name='wsearch'"
	if(($null -ne $windowsSearchService) -and ($windowsSearchService.State -eq 'Stopped'))
	{
		$InformationCollected | add-member -membertype noteproperty -name "HyperW7Svc64 Path" -value $Script:HyperW7Svc64.Path
		$InformationCollected | add-member -membertype noteproperty -name "HyperW7Svc64 Version" -value $Script:HyperW7Svc64.FileVersion
		$InformationCollected | add-member -membertype noteproperty -name "Windows Search Service Current State" -value $windowsSearchService.State
		$InformationCollected | add-member -membertype noteproperty -name "Winddows Search Service Startup Type" -value $windowsSearchService.StartMode
		return $true
	}
	return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCtQjs8PB88vL1X
# 5rsaUvo0qe38v7o32bZpQPzYwt6bcKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDuSdpIApZkgEogXsIfoKHgq
# gRu6nurWYVdoirVf/nrIMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCA