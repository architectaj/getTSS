...
# Version 1.0.09.16.14: SChannel information is useful when troubleshooting SSL/TLS/WebClient issues. Adding SChannel registry key. [suggested by EdB]
# Date: 2014
# Author: Boyd Benson (bbenson@microsoft.com)
# Description: Collects information about SChannel
# Called from: Networking Diags
#*******************************************************

Import-LocalizedData -BindingVariable ScriptVariable
Write-DiagProgress -Activity $ScriptVariable.ID_CTSSChannel -Status $ScriptVariable.ID_CTSSChannelDescription

#----------Registry
$sectionDescription = "SChannel"
$outputFile = $Computername + "_SChannel_reg_.TXT"
$CurrentVersionKeys = "HKLM\SYSTEM\CurrentControlSet\Control\SecurityProviders\Schannel"
RegQuery -RegistryKeys $CurrentVersionKeys -Recursive $true -OutputFile $outputFile -fileDescription "SChannel Registry Keys" -SectionDescription $sectionDescription
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDgfj2BTVojBsh7
# fZEzLSPnVZnJ8oylew7tLAWmO/CJ+aCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgfktD4hMr
# GgEtFAll4VlezpXoS/KAX9qgjfoMAw72ZykwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAGxXipuiAL6fTvwmNd1maXnZjvEL6sKpNc545RYLeDUaQk1jLlsg5nl9
# JH8782W73eH3vCdU9K6H0YWCcnbHqXkUbWOCZvzj3DTymeenvbToW8R7MBeuOi4X
# d3IPTmz6dKfcQd6SqFU0iCAPhESauyXlxcOnTehUh5gC1yRBS6lAzg7h86ssu0QJ
# AAseGV5ONDFDryYqG9uv0b/a80DOtFGREYkL6ngifoYsTfJiCNKjysC3PzFzuTeN
# +CGrJfMKxoqv4G3K5SrnywGKDUDJvNe6C/dpIYqmWM9C3jnoyl03Ln4O+/oHyCdl
# cHJfQv8KUYaEDYd3JbZl1iEOPmk14BuhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQggf2ViDr/bMJuhfbOU3t8wVK+IUg+2R/RiWxbeZn3PykCBmGBshkU
# pRgTMjAyMTExMTExNjUzMzQuMzMyWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCBggkLC
# QOAHNj5RBgazghl7RAOas0Glmx3G2fcdRTn4pjCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAAMFwkHJnknPCB7Qob7rGYvzCBefH4bb8ix+MxtnAEX5Hi/j/
# 5BQQ3yU5iMLwCYvbZnCDswEyO7Bzrs2WgeQcZv++WaAKdDQ+hVhD2Qq1tm1Zhs+S
# uS9yIp8w0mdcXZCtuzE24T2zPxgnzoTZ5EIUCP113nUqOHY38XgZmAJ6tdC416UC
# TAWT/H4d381+15bxVUNnhap7v5x5tdVjnu2sXJB/+hZzY8JMcHQzsX/BPkjg9vcS
# Cgf5y3b9Yga+TGI1w0k296047tU+oROzlPH/Vkok4gCEBnrTZO3n0/63wRFzHNT2
# KA6gHc+Y/izprQ5EpRrdPeJMHvoFxYla65QGiw==
