...
# Rule number:  2695
# Rule URL:  //sharepoint/sites/rules/Rule%20Submissions/Forms/DispForm.aspx?ID=2695
#************************************************

Import-LocalizedData -BindingVariable ScriptStrings
Display-DefaultActivity -Rule -RuleNumber 2695

$RuleApplicable = $false
$RootCauseDetected = $false
$RootCauseName = "RC_TelnetSystemAccount"
$PublicContent = "http://support.microsoft.com/kb/2671722"
$InternalContent = ""
$Verbosity = "Warning"
$Visibility = "4"
$SupportTopicsID = ""
$InformationCollected = new-object PSObject
$Script:TelNetSer = $null
...
# Detection Logic
# **************
# check whether the Telnet Service is runing and osversion is available for rule

function CheckTelServiceApplicable
{
	if((($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 0)) -or # Server 2008 / Vista
			   (($OSVersion.Major -eq 6) -and ($OSVersion.Minor -eq 1))) # Win 7/R2
			   {
			   	 $Script:TelNetSer = Get-CimInstance -Class Win32_Service -Filter "Name='tlntsvr'"
				if(($null -ne $Script:TelNetSer) -and($Script:TelNetSer.Started -eq $true))
				{
					return $true
				}
			   }
...
#Check Whether the Telnet service's account is something different than LocalService account.

function CheckTelNetServiceIsLocalAccount
{
	if($Script:TelNetSer.StartName -ne "LocalSystem")
	{
		return $false
	}
	else
...
if (CheckTelServiceApplicable)
{
	...
	if ($RuleApplicable)
	{
		$RootCauseDetected = CheckTelNetServiceIsLocalAccount
	}
}	
...
if ($RuleApplicable)
{
	if ($RootCauseDetected)
	{
		...
		Write-GenericMessage -RootCauseId $RootCauseName -PublicContentURL $PublicContent -InformationCollected $InformationCollected -Verbosity $Verbosity -Visibility $Visibility -SupportTopicsID $SupportTopicsID -SolutionTitle $ScriptStrings.ID_TelnetSystemAccount_SD
	}
	else
	{
		# Green Light
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCvVN5eWVlK5MtF
# CCW2QSwcvzr+VS3pMmjqk7X6FSOtp6CCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF0jGAGMVgubUJSO9NABh31m
# 9B3an9J1sCeXfRTufadZMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZn