#************************************************
# DC_SNMP-Component.ps1
# Version 1.0
# Date: 2009
# Author: Boyd Benson (bbenson@microsoft.com)
# Description: Collects information about SNMP.
...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSSNMP -Status $ScriptVariable.ID_CTSSNMPDescription

#----------Check if SNMP is installed, and then run the script
$SvcKey = "HKLM:\SYSTEM\CurrentControlSet\services\SNMP"
if (Test-Path $SvcKey) 
{
	#----------Registry
	$OutputFile= $Computername + "_SNMP_reg_output.TXT"
	$sectionDescription = "SNMP"

	$CurrentVersionKeys =	"HKLM\SYSTEM\CurrentControlSet\services\SNMP",
							"HKLM\SYSTEM\CurrentControlSet\services\SNMPTRAP", 
							"HKLM\SYSTEM\CurrentControlSet\Control\SNMP"
	RegQuery -Registrykeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "SNMP registry output" -SectionDescription $sectionDescription
}

# SIG # Begin signature block
# MIIjiAYJKoZIhvcNAQcCoIIjeTCCI3UCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD1ncYILnkPqZEG
# hhHB/AaiTVOKVJOnF2ZKzYdimeLEAKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg09UoM7GS
# 0twPL0E1PxJcoHhYKVeWtUc5qVGb79XsquIwOAYKKwYBBAGCNwIBDDEqMCigCIAG
# AFQAUwBToRyAGmh0dHBzOi8vd3d3Lm1pY3Jvc29mdC5jb20gMA0GCSqGSIb3DQEB
# AQUABIIBAAdtxfEVouxRzMSlL3E2AQhZbHEY0FASgL6TUd/oZi3awE6SJj40IyOI
# ZxWeD7AQeZT/h8QmpW8SBfiUIrvJ27gLILxTnmRGcCx5XC6oSamMg69npiaFsLdH
# wKYwBkMGV/s10r385ea0zvBKa/jif/Z8+jIaZXrKeTnoxNLRoptYMvYwOrQm+WiN
# LbszBk7pJZagWYCwB4GQjyAx86xLDQBxVGcRfrVCRcK+Hb2VgojhzoufQy+gVvE8
# iwBsFcZEL9y044WScemmf3EnxqqGOGGH3AmOG1bO3Z7z0WKl1nSDARPSlXulgdo4
# jS3ZZTJVgGSJTZq7V4KkLhiO7aji84uhghLxMIIS7QYKKwYBBAGCNwMDATGCEt0w
...
# ZQMEAgEFAAQgW4vUrOzKJOB/dfsC5KgVQvAfXDB9cqnmvgItGwe7eQ0CBmGCBVHy
# sBgTMjAyMTExMTExNjUzMzQuMjE5WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMC
...
# GgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAhpDiB
# q9BaMzPcf/tbxUl5RIJVICTxBRRwfzeH78m0YzCB+gYLKoZIhvcNAQkQAi8xgeow
...
# hvcNAQELBQAEggEAcHR85NlPdLnSiDexxBQIpwnG+TUI4bDZ5+negjsbQfyQRuBx
# G7Hn3idOs+EoO741dtYU+0GF4N6RqOVd4Tvpm7bLnESIZtiCWPKOrqx+T1/lz3fl
# ZZ83HXa6Q8Payiu4cufmwWwbl/ivQvTxeB8Cfx3XjqWW+1qAp911HANfPmSJ0YF+
# Ogf329tM8Vnqn3oMORNdZlI0Lw6xXK7JCbok4r6QwPqn3vUWJPf+r+3FQu+Op7pw
# jN82IbfAnDT93SIt5YiQjBlOqm2S+aWwWmZknkcaAOMUNZy0I0eFHmn+w/PZgYm1
# JHeZ9Y6XYjolfYFtfr69ojvESJtkjZWk98ng2Q==
